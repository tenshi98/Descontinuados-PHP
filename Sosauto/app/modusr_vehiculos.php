...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 if ( ! empty($_GET['id']) ) { ?>
<a class="title_icn" href="<?php echo $location.'&view='.$_GET['id']; ?>"><img src="img/icon_volver.png" /></a>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
}elseif ( ! empty($_GET['delete']) ) {?>
<a class="title_icn" href="<?php echo $location.'&view='.$_GET['delete']; ?>"><img src="img/icon_volver.png" /></a>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
}elseif ( ! empty($_GET['new']) ) { ?>
<a class="title_icn" href="<?php echo $location; ?>"><img src="img/icon_volver.png" /></a>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
}elseif ( ! empty($_GET['imagen']) ) { ?>
<a class="title_icn" href="<?php echo $location.'&view='.$_GET['imagen']; ?>"><img src="img/icon_volver.png" /></a>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
}elseif ( ! empty($_GET['view']) ) {?>
<a class="title_icn" href="<?php echo $location; ?>"><img src="img/icon_volver.png" /></a>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
} else  {?>
<a class="title_icn" href="principal_datos.php<?php echo $w; ?>"><img src="img/icon_volver.png" /></a>
<?php }?>       
	<!-- InstanceEndEditable --> 
    </div>
