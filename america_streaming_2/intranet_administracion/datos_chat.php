...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/chats_listado.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/chats_listado_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/chats_listado.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/chats_listado.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/chats_listado_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/chats_listado.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/chats_listado.php';
}
