...
//Variable temporal para trabajar
$Tipo = 2;
$nombre_usuario = 'bla';
$url_imagen = 'http://lh4.ggpht.com/-SwsRNhEBmdM/U3cTkIKU_6I/AAAAAAAANh0/cqx4OagcPAA/s0/8ACVgddF.png';
?>
<!DOCTYPE html>
<html lang="en">
...
document.getElementById('trans2').style.display = 'none';
                ...
                <div class="span3_ex fleft">
               <!--     <div id="chat_vis" style="display:none">-->
                    <div id="chat_vis" >
                    <iframe style="width:100%; height:100%;" frameborder="0" noresize scrolling="No" src="videochat_chat.php?r=<?php echo $_GET['r'];?>&room=<?php echo $_GET['room'];?>&user=<?php echo $Tipo; ?>&nombre_usuario=<?php echo $nombre_usuario; ?>&url='<?php echo $url_imagen; ?>'&name='<?php echo $_GET['name'];?>'"></iframe>
					</div>
                </div>
