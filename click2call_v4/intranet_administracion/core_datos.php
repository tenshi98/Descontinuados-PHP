...
if ( !empty($_POST['edit_datos']) )  {
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/core_datos_2.php';
...
$query = "SELECT email_principal, Nombre, Nombre_slogan, Nombre_sist, Nombre_sist_slogan, Rut, Direccion, Fono, Fono_anexo, Fono_password, Estado_chat, Ciudad, Comuna, idTheme2
FROM `core_datos`
WHERE id_Datos = '1'";
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Fono - Anexo</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Fono - Anexo" class="form-control" value="<?php echo $rowdata['Fono_anexo']; ?>" name="Fono_anexo" >
				</div>
			</div>
            
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Fono - Password</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Fono - Password" class="form-control" value="<?php echo $rowdata['Fono_password']; ?>" name="Fono_password" >
				</div>
			</div>
...
core_datos.Fono, 
core_datos.Fono_anexo,
core_datos.Fono_password, 
core_datos.Estado_chat,
core_datos.Ciudad,  
core_datos.Comuna,  
core_theme_colors.Nombre AS tema
FROM `core_datos`
LEFT JOIN `core_theme_colors` ON   core_theme_colors.idTheme   = core_datos.idTheme2
WHERE id_Datos = '1'";
$resultado = mysql_query ($query, $dbConn);
$rowdata = mysql_fetch_assoc ($resultado);	
?>
...
<div class="col-lg-5 fcenter">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Fono - Anexo : </strong><?php echo $rowdata['Fono_anexo']; ?></p>
            <p class="text-muted"><strong>Fono - Password : </strong><?php echo $rowdata['Fono_password']; ?></p>
