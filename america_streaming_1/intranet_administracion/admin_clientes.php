...
$query = "SELECT Nombres, Apellidos, Sexo, Fono1, Rut, fNacimiento, email
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Apellidos" class="form-control" value="<?php if(isset($Apellidos)) {echo $Apellidos;} else {echo $rowdata['Apellidos'];}?>"  name="Apellidos" required>
				</div>
			</div>
...
<div class="col-lg-6">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Nombre : </strong><?php echo $rowdata['Nombres'].' '.$rowdata['Apellidos']; ?></p>
...
if (!$num_pag){
	...
	$z="WHERE clientes_listado.usuario !=''";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z.=" AND clientes_listado.usuario LIKE '%{$_GET['search']}%'";	
}
	$z.=" AND clientes_listado.Tipo = 1";
...
<label class="control-label col-lg-4">Buscar Cliente</label>
    <div class="col-lg-5">
		<div class="input-group bootstrap-timepicker">
			...
			<input class="form-control timepicker-default" type="text" name="search" value="<?php if (isset($_GET['search'])) { echo $_GET['search'];}?>" placeholder="Nombre usuario">
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Cliente</h5>
		</header>
