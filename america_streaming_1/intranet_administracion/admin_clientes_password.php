...
$original = "admin_clientes_password.php";
$location = $original;
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Modificacion de Password</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Modificacion de Password
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la contraseña de <?php echo $rowdata['Nombres'].' '.$rowdata['Apellidos'] ?></h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
        
			<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Nueva Clave</label>
				<div class="col-lg-8">
					<input type="password" id="text2" placeholder="Nueva Clave" class="form-control"   name="password" required>
				</div>
			</div>
                      
			<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Repetir Nueva Clave</label>
				<div class="col-lg-8">
					<input type="password" id="text2" placeholder="Repetir Nueva Clave" class="form-control"  name="repassword" required>
				</div>
			</div>
...
<label class="control-label col-lg-4">Buscar Vecino</label>
    <div class="col-lg-5">
		<div class="input-group bootstrap-timepicker">
			...
			<input class="form-control timepicker-default" type="text" name="search" value="<?php if (isset($_GET['search'])) { echo $_GET['search'];}?>" placeholder="Nombre del usuario">
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $usuarios['usuario']; ?></td>
			<td class=" "><?php echo $usuarios['Nombres'].' '.$usuarios['Apellidos']; ?></td>
            <td class=" "><?php echo $usuarios['Ultimo_acceso']; ?></td>
			<td class=" "><?php echo $usuarios['fcreacion']; ?></td>
			<td class=" "><?php echo $usuarios['estado']; ?></td>
			<td class=" ">	
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$usuarios['idCliente']; ?>" title="Cambiar Clave" class="icon-editar info-tooltip"></a><?php } ?>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
