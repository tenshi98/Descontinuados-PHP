...
$original = "admin_clientes_tipo_clientes.php";
$location = $original;
...
<div id="txf_03" class="alert_sucess">  
	Tipo Cliente Creado correctamente
...
<div id="txf_03" class="alert_sucess">  
	Tipo Cliente Modificado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Tipo Cliente borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de Tipo de cliente</h5>
		</header>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Tipo de cliente</a><?php } ?>
</div>
