...
<div class="col-lg-8">
    ...
    <?php foreach ($arrColores as $colores) { ?>
    	<tr class="odd">
            ...
            <td class=" "><?php if($rowdata['form_color']==$colores['Codigo']){echo 'Activo';}else{echo 'Inactivo';}; ?></td>
            <td class=" "><?php echo $colores['Codigo']; ?></td>
            <td class=" "><div class="preview" style=" background-color:#<?php echo $colores['CSS']; ?>;  "></div></td>
			<td class=" ">  
	<a href="<?php echo $location.'?table=form_color&val='.$colores['Codigo'].'&return1=mod'; ?>" title="Activar color" class="icon-aprobar info-tooltip"></a>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_7.php" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div>
