	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			<div class="form-group">
                ...
                <option value="<?php echo $marca['idMarca']; ?>" <?php if(isset($idMarca)) {if($idMarca==$marca['idMarca']){ echo 'selected="selected"';}} else {if($rowdata['idMarca']==$marca['idMarca']){echo 'selected="selected"';}}?>  ><?php echo $marca['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
