...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
    	<tr class="table_title">
            <th colspan="5">Listado de tipos de borde</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrBorder as $border) { ?>
            	<a href="<?php echo $location.'?table=usr_img_border&val='.$border['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_img_border']==$border['Codigo']){ echo 'minimal_selected';}?>"><?php echo $border['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrBorder_radius as $radius) { ?>
            	<a href="<?php echo $location.'?table=usr_img_border_radius&val='.$radius['Codigo'].'&return1=mod'; ?>" >
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrSombras as $sombras) { ?>
            	<a href="<?php echo $location.'?table=usr_img_shadow&val='.$sombras['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_img_shadow']==$sombras['Codigo']){ echo 'minimal_selected';}?>"><?php echo $sombras['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
         ...
         <tr class="table_title">
            <th colspan="5">Listado de Tamaño contenedores</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrAncho as $content) { ?>
            	<a href="<?php echo $location.'?table=usr_img_width&val='.$content['Codigo'].'&return1=mod'; ?>" >
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrSize as $size) { ?>
            	<a href="<?php echo $location.'?table=usr_name_lettersize&val='.$size['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_lettersize']==$size['Codigo']){ echo 'minimal_selected';}?>"><?php echo $size['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrColoresTexto as $textcolor) { ?>
            	<a href="<?php echo $location.'?table=usr_name_lettercolor&val='.$textcolor['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_lettercolor']==$textcolor['Codigo']){ echo 'minimal_selected';}?>"><?php echo $textcolor['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrSize as $size) { ?>
            	<a href="<?php echo $location.'?table=usr_name_pat_lettersize&val='.$size['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_pat_lettersize']==$size['Codigo']){ echo 'minimal_selected';}?>"><?php echo $size['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrColoresTexto as $textcolor) { ?>
            	<a href="<?php echo $location.'?table=usr_name_pat_lettercolor&val='.$textcolor['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_pat_lettercolor']==$textcolor['Codigo']){ echo 'minimal_selected';}?>"><?php echo $textcolor['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrSize as $size) { ?>
            	<a href="<?php echo $location.'?table=usr_name_pat_lettersize_2&val='.$size['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_pat_lettersize_2']==$size['Codigo']){ echo 'minimal_selected';}?>"><?php echo $size['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrColoresTexto as $textcolor) { ?>
            	<a href="<?php echo $location.'?table=usr_name_pat_lettercolor_2&val='.$textcolor['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['usr_name_pat_lettercolor_2']==$textcolor['Codigo']){ echo 'minimal_selected';}?>"><?php echo $textcolor['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_3.php" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div>
