...
<div id="txf_03" class="alert_sucess">  
	Lista modificada correctamente
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="table_title">
            <th colspan="5">Listado de Sombras</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrSombras as $sombras) { ?>
            	<a href="<?php echo $location.'?table=list_shadow&val='.$sombras['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_shadow']==$sombras['Codigo']){ echo 'minimal_selected';}?>"><?php echo $sombras['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
    	<tr class="table_title">
            <th colspan="5">Listado de tipos de borde tabla</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrBorder as $border) { ?>
            	<a href="<?php echo $location.'?table=list_color_border&val='.$border['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_color_border']==$border['Codigo']){ echo 'minimal_selected';}?>"><?php echo $border['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        <tr class="table_title">
            <th colspan="5">Listado de separador Tablas</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrSeparator as $separator) { ?>
            	<a href="<?php echo $location.'?table=list_sep&val='.$separator['Codigo'].'&return1=mod'; ?>" >
    	...
    	<tr class="table_title">
            <th colspan="5">Tamaño del listado</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrAncho as $content) { ?>
            	<a href="<?php echo $location.'?table=list_width&val='.$content['Codigo'].'&return1=mod'; ?>" >
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=list_alin&val=fleft&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_alin']=='fleft'){ echo 'minimal_selected';}?>">Izquierda</button>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fright&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_alin']=='fright'){ echo 'minimal_selected';}?>">Derecha</button>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fcenter&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_alin']=='fcenter'){ echo 'minimal_selected';}?>">Centro</button>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fnone&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_alin']=='fnone'){ echo 'minimal_selected';}?>">Ninguna</button>
                </a> 
            </td>
        </tr>
        <tr class="table_title">
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrDeg as $degradado) { ?>
            	<a href="<?php echo $location.'?table=list_deg&val='.$degradado['Codigo'].'&return1=mod'; ?>" >
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrBorder_radius as $radius) { ?>
            	<a href="<?php echo $location.'?table=list_border&val='.$radius['Codigo'].'&return1=mod'; ?>" >
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrSize as $size) { ?>
            	<a href="<?php echo $location.'?table=list_tittle_size&val='.$size['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_tittle_size']==$size['Codigo']){ echo 'minimal_selected';}?>"><?php echo $size['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
            ...
            <?php foreach ($arrColoresTexto as $textcolor) { ?>
            	<a href="<?php echo $location.'?table=list_tittle_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_tittle_color']==$textcolor['Codigo']){ echo 'minimal_selected';}?>"><?php echo $textcolor['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrSize as $size) { ?>
            	<a href="<?php echo $location.'?table=list_text_size&val='.$size['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_text_size']==$size['Codigo']){ echo 'minimal_selected';}?>"><?php echo $size['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
        ...
        <tr class="odd">
        	<td colspan="5">
            <?php foreach ($arrColoresTexto as $textcolor) { ?>
            	<a href="<?php echo $location.'?table=list_text_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" >
                	<button class="minimal <?php if($rowdata['list_text_color']==$textcolor['Codigo']){ echo 'minimal_selected';}?>"><?php echo $textcolor['Nombre']; ?></button>
                </a>
            <?php } ?> 
            </td>
        </tr>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_4.php" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div>
