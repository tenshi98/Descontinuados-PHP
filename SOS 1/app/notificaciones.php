...
<tr height="10%">
    <td class="textbox">
    <h1 class="<?php echo $config_app['noti_ul_color_new'].' '.$config_app['noti_ul_size_new'] ?>">Robo de Vehiculo</h1>    
...
$query = "SELECT idNotificacion FROM `clientes_notificaciones`";
