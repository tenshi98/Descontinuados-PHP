...
list($idTipoAlerta, $cercanos, $contactar, $desplegar, $idCliente, $lat, $lon, $gsm, $client, $idVehiculo) =   split("3xyzxyz3", $_GET['mensaje'], 10);
...
$a .= ",'".$gsm."'" ;
$a .= ",'".$desplegar."'" ;
$query  = "INSERT INTO `robos_listado` (idCliente, idVehiculo, Fecha, Hora, Longitud, Latitud, Gsm, desplegar) VALUES ({$a} )";
