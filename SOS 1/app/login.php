...
<?php if ( $config_app['comport_register']=='1' ) {?> 
  <a class="<?php echo $config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_ancho'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_float'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'] ?> btn_link" href="<?php echo $location.'&newuser=true' ?>">Crear Usuario</a>
<?php } ?> 
 
<?php if ( $config_app['comport_recover']=='1' ) {?>
  <a class="<?php echo $config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_ancho'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_float'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'] ?> btn_link" href="<?php echo $location.'&recover=true' ?>">Recuperar contraseña</a>
<?php }?>
