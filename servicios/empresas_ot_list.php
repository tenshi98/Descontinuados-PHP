...
<form  method="post">
	<tr>
        ...
        <td height="300"><textarea name="Texto"><?php echo $rowpunto['Texto'] ?></textarea></td>
	</tr>
    <tr>
		<td></td>
 ...
 <?php foreach ($arrBodega as $bodega) { ?>
  ...
  <td><?php echo $bodega['nombre_articulo']; ?></td>
   ...
   <td>	   
    ...
    <a href="<?php echo $location; ?>?new_4=<?php echo $_GET['new_4']; ?>&emp=<?php echo $_GET['emp']; ?>&del=<?php echo $bodega['idBodega'] ?>"><input type="image" src="img/icn_logout_2.png" title="Borrar"></a>
...
<form  method="post">
	<tr>
    	<td width="120"><label>Comentario</label></td>
        <td height="300"><textarea name="Texto"></textarea></td>
	</tr>
    <tr>
		<td></td>
...
<table class="tablesorter" cellspacing="0"> 
 ...
 <?php foreach ($arrResponsables as $responsable) { ?>
  <tr> 
   ...
   <td>
    <a href="<?php echo $location; ?>?new_2=<?php echo $_GET['new_2']; ?>&emp=<?php echo $_GET['emp']; ?>&del_1=true&del=<?php echo $responsable['idResp']; ?>"><input type="image" src="img/icn_trash.png" title="Borrar"></a>	  
 </td> 
 </tr> 
 <?php } ?>	 
 </tbody> 
...
<table class="tablesorter" cellspacing="0"> 
  ...
  <tr>
   ...
   <td><div class="fleft"><?php echo $responsable['nombre_resp']; ?></div>
       <div class="fright"> 
            ...
            <a href="<?php echo $location; ?>?del_2=<?php echo $_GET['new']?>&emp=<?php echo $_GET['emp']?>&del=<?php echo $responsable['idResp']?>"><input type="image" src="img/icn_trash.png" title="Borrar"></a>
       </div>
   </td>
 </tr> 
 <?php } ?> 
 ...
 <td><?php echo $bodega['nombre_articulo']; ?></td> 
   <td><div class="fleft"><?php echo number_format($cantidad3=($bodega['Cantidad']*'-1'),3,',','.'); ?> <?php echo $bodega['nombre_medida']; ?></div>
       <div class="fright"><a href="<?php echo $location; ?>?view=<?php echo $_GET['view']; ?>&solicitud=<?php echo $_GET['solicitud']; ?>&del_2=<?php echo $bodega['idBodega']; ?>"><input type="image" src="img/icn_logout_2.png" title="Borrar"></a> </div>
   </td> 
 </tr> 
 <?php } ?> 
...
<?php //se verifica que los datos basicos esten vacios para evitar ver esta parte 
if (!empty($rowpunto['nombre_trabajo'])) {?>
<form  method="post">
<?php if ($rowpunto['unidad']=='mes'){?>

<?php } elseif ($rowpunto['unidad']=='Gl'){?>

<?php } else {?>
	  <tr>
        <td><label>Consumo de <?php echo $rowpunto['unidad']; ?></label></td>
        <td>
            <div class="fleft"><input name="cantidad" type="text" required="" /><?php echo $errors[2]; ?></div>
  		</td>
      </tr>
<?php } ?>      
       <tr>
