...
$location = "zint_embalaje.php";
//formulario para crear nivel
if ( !empty($_POST['submit']) ) {
	//agrego una nueva locacion
	$location .= "?view=".$_GET['new'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/zint_embalaje.php';//creacion de variables
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/zint_embalaje_1.php';//revision si estan vacias
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/zint_embalaje.php';//se crean los datos
}
...
if ( !empty($_POST['submit_edit']) ) {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/zint_embalaje.php';//creacion de variables
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/zint_embalaje_1.php';//revision si estan vacias
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/zint_embalaje.php';//se crean los datos
}
/**********************************************************************************************************************************/
...
if ( !empty($_GET['del']) )     {
	...
	$location .= "?view=".$_GET['emp'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/zint_embalaje.php';}
?>
...
<div class="title"><p>Tipos de embalaje</p></div>
	<div class="content">          
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 if ( ! empty($_GET['id']) ) {  
...
$query = "SELECT Nombre
FROM `zint_embalaje`
WHERE idEmbalaje = {$_GET['id']}";
$resultado = mysql_query ($query, $dbConn);
$rowembalaje = mysql_fetch_assoc ($resultado);
 ?>         
<div>  
<div class="fleft"><h1>Editar Tipo de Embalaje</h1></div>
...
<form  method="post">
	<tr>
        ...
        <td><input type="text" name="Nombre"  placeholder="Tipo de Embalaje" value="<?php echo $rowembalaje['Nombre']; ?>" required=""/><?php echo $errors[1] ?></td>
    </tr>
    <tr>
    	<input name="idEmbalaje"  type="hidden" value="<?php echo $_GET['id'] ?>" />
...
<div>  
<div class="fleft"><h1>Crear Nuevo Tipo de Embalaje</h1></div>
...
<form  method="post">
	<tr>
    	<td><label>Nombre</label></td>
        <td><input type="text" name="Nombre"  placeholder="Tipo de Embalaje"  required=""/><?php echo $errors[1] ?></td>
    </tr>
    <tr>
...
?>
<div>  
<div class="fleft"><h1>Listado de Tipos de Embalaje</h1></div>
...
<?php foreach ($arrEmbalaje as $embalaje) { ?>  
  <tr> 
   ...
   <td>
	<a href="<?php echo $location; ?>?id=<?php echo $embalaje['idEmbalaje']; ?>&emp=<?php echo $_GET['view']; ?>"><input type="image" src="img/icn_edit.png" title="Editar"></a>
    <?php $ubicacion=$location.'?del='.$embalaje['idEmbalaje'].'&emp='.$_GET['view'];?>
