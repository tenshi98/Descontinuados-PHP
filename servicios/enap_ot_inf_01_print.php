...
<table class="tablesorter" cellspacing="0"> 
 <thead> 
  <tr> 
   <th colspan="7">III.- INFORME GENERAL</th>
  </tr> 
 </thead>
 <tbody> 
...
foreach($row_tarea as $tipo=>$productos){ ?>
  <tr style="background-color: #EEE;">
   ...
   if ($productos[0]['uml_job']=='mes'){?>
   	<td colspan="5"><?php echo $productos[0]['cat'].' - '.$productos[0]['subcat'].' - '.$tipo ?></td>
    <td width="130">
   ...
   <?php //excepcion de la unidad de medida
    ...
    <td colspan="2"><?php echo $productos[0]['cat'].' - '.$productos[0]['subcat'].' - '.$tipo ?></td>
