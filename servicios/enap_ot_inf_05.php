...
<div class="title"><p>Estado de Pago - Resumen</p></div>
<div class="content">          
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<div class="fright">    
    <a target="_blank" href="<?php echo 'enap_ot_inf_05_print.php?show='.$_GET['show'].'&f_desde='.$_GET['f_desde'].'&f_hasta='.$_GET['f_hasta'].'&periodos='.$_GET['periodos']?>" ><input name="" type="button" value="Version Imprimible &raquo;" /></a>
</div>
<div class="clear"></div></div>
...
foreach($row_tarea as $tipo=>$productos){ ?>
 ...
 if ($subcat_anterior!=$productos[0]['subcat']) {
   ...
   if ($productos[0]['uml_job']=='mes'){?>
   	<td colspan="8">
	<a target="_blank" href="<?php echo $location.'?show='.$_GET['show'].'&f_desde='.$_GET['f_desde'].'&f_hasta='.$_GET['f_hasta'].'&periodos='.$_GET['periodos'].'&trabajos='.$productos[0]['id_job']; ?>" ><?php echo $tipo ?></a>	
	</td>
    <td>
	<?php echo $productos[0]['uml_job'];
...
<div>
<div class="fright">    
<a target="_blank" href="<?php echo 'enap_ot_inf_05_export.php?show='.$_GET['show'].'&f_desde='.$_GET['f_desde'].'&f_hasta='.$_GET['f_hasta'].'&periodos='.$_GET['periodos']?>" ><input name="" type="button" value="Exportar &raquo;" /></a>
</div>
<div class="clear"></div></div>	
