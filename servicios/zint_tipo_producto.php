...
$location = "zint_tipo_producto.php";
//formulario para crear nivel
if ( !empty($_POST['submit']) ) {
	//agrego una nueva locacion
	$location .= "?view=".$_GET['new'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/zint_tipo_producto.php';//creacion de variables
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/zint_tipo_producto_1.php';//revision si estan vacias
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/zint_tipo_producto.php';//se crean los datos
}
...
if ( !empty($_POST['submit_edit']) ) {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/zint_tipo_producto.php';//creacion de variables
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/zint_tipo_producto_1.php';//revision si estan vacias
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/zint_tipo_producto.php';//se crean los datos
}
/**********************************************************************************************************************************/
...
if ( !empty($_GET['del']) )     {
	...
	$location .= "?view=".$_GET['emp'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/zint_tipo_producto.php';}
?>
...
<div class="title"><p>Tipo Producto</p></div>
	<div class="content">          
<?php ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////  
 if ( ! empty($_GET['id']) ) {  
...
FROM `zint_tipo_prod`
WHERE idTipo_prod = {$_GET['id']}";
$resultado = mysql_query ($query, $dbConn);
$rowtipo = mysql_fetch_assoc ($resultado);
 ?>         
<div>  
<div class="fleft"><h1>Editar Tipo de Producto</h1></div>
...
<form  method="post">
	<tr>
        ...
        <td><input type="text" name="Tipo_producto"  placeholder="Tipo de producto"value="<?php echo $rowtipo['Tipo_producto']; ?>"  required=""/><?php echo $errors[1] ?></td>
    </tr>
    <tr>
    	<input name="idTipo_prod"  type="hidden" value="<?php echo $_GET['id'] ?>" />
...
<div>  
<div class="fleft"><h1>Crear Tipo de Producto</h1></div>
...
<form  method="post">
	<tr>
    	<td><label>Nombre</label></td>
        <td><input type="text" name="Tipo_producto"  placeholder="Tipo de producto"  required=""/><?php echo $errors[1] ?></td>
    </tr>
    <tr>
...
?>
<div>  
<div class="fleft"><h1>Listado de Tipos de productos</h1></div>
...
<?php foreach ($arrTipo as $tipo) { ?>  
  <tr> 
   ...
   <td>
	<a href="<?php echo $location; ?>?id=<?php echo $tipo['idTipo_prod']; ?>&emp=<?php echo $_GET['view']; ?>"><input type="image" src="img/icn_edit.png" title="Editar"></a>
    <?php $ubicacion=$location.'?del='.$tipo['idTipo_prod'].'&emp='.$_GET['view'];?>
