      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_sup">
        ...
        <tr>
          <td colspan="3" align="center" valign="middle"><table id="table1" border="0" height="163" width="834">
            <tbody>
              <tr>
                <td width="343" align="center" ><img src="images/quien3.png" height="260" border="0"/></td>
                <td width="481" align="center">
				<form name="form1" method="post" action="nombre.php" onsubmit="return validacalle()">
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="25" colspan="4" class="Arial4">Ingrese Los siguientes Datos.<br>
					  <span class="Arial2">(Puede ingresar todos o bien alguno de ellos,<br> entre mas informaci&oacute;n, mas acotada ser&aacute; la respuesta.)</span>
					  </td>
                      </tr>
                    <tr>
                      <td>&nbsp;</td>
                    ...
                    <tr>
                      <td><span class="Arial2">Primer Nombre</span></td>
                      <td>&nbsp;</td>
                      <td height="25" colspan="2"><input name="nombre1" type="text" class="campo_rut" id="nombre1" size="50" maxlength="20" value="" onkeypress="return isAlpha2(event);" placeholder="Ej: marcelo" style="width:220px !important;"/></td>
                    </tr>
					<tr><td>&nbsp;</td><td>&nbsp;</td><td valign="top"><span class="Arial2" id="ayudaRut"><br /></span></td>
                    </tr>
                    <tr>
                      <td><span class="Arial2">Segundo Nombre</span></td>
                      <td>&nbsp;</td>
                      <td height="25" colspan="2"><input name="nombre2" type="text" class="campo_rut" id="nombre2" size="50" maxlength="20" value="" onkeypress="return isAlpha2(event);" placeholder="Ej: ivan" style="width:220px !important;"/></td>
                    </tr>
					<tr><td>&nbsp;</td><td>&nbsp;</td><td valign="top"><span class="Arial2" id="ayudaRut"><br /></span></td>
                    </tr>
                    <tr>
                      <td><span class="Arial2">Primer Apellido</span></td>
                      <td>&nbsp;</td>
                      <td height="25" colspan="2"><input name="apellido1" type="text" class="campo_rut" id="apellido1" size="50" maxlength="20" value="" onkeypress="return isAlpha2(event);" placeholder="Ej: lopez" style="width:220px !important;"/></td>
                    </tr>
					<tr><td>&nbsp;</td><td>&nbsp;</td><td valign="top"><span class="Arial2" id="ayudaRut"><br /></span></td>
                    </tr>
                    <tr>
                      <td><span class="Arial2">Segundo Apellido</span></td>
                      <td>&nbsp;</td>
                      <td height="25" colspan="2"><input name="apellido2" type="text" class="campo_rut" id="apellido2" size="50" maxlength="20" value="" onkeypress="return isAlpha2(event);" placeholder="Ej: betancourt" style="width:220px !important;"/></td>
                    </tr>
					<tr><td>&nbsp;</td><td>&nbsp;</td><td valign="top"><span class="Arial2" id="ayudaRut"><br /></span></td>
                    </tr>
                    <tr>
