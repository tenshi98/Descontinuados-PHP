...
<body >
<?
	  $result = "SELECT * FROM anotaciones WHERE fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'";
    ...
    <td valign="middle" class="Arial1">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_sup">
        <tr>
          ...
          <td width="67%" align="center" valign="middle">Observaciones por D&iacute;a (<?=$_POST["fecha_va"]?> / <?=$numeroRegistros?>)</td>
...
<table width="960" border="0" cellpadding="0" cellspacing="0" class="tabla_sup">
     <tr>
       <td>	
	   <?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='General'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
...
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='General' order by fecha_creacion asc ";
...
onclick="window.open('mostrardatos.php?r=<?=$rut?>&donde=1', 'popup', 'width=1000,height=700'); return false;" /></td>
<td>
<?	if ($miarea==0 or $nombre_area=="General") {	?>
<input type="submit" class="rojo_sombra_act" value="&laquo; Act WF" onclick="javascript:window.location.href='http://<?=$g_nombreurl?>/workflow.php?r=<?=$rut?>&donde=1&fecha_va=<?=$_POST["fecha_va"]?>';" />
<?}else{?>
<input type="submit" class="rojo_sombra" value="&laquo; Ver WF" onclick="window.open('pop_wf.php?r=<?=$rut?>&donde=1', 'popup', 'width=1000,height=700'); return false;" />
<?}?>
...
?>
	...
	<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='Social'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='Social' order by fecha_creacion asc ";
...
<tr>
<td><?=$nombre?></td><td><?=$rut?></td><td><?=$fecha_hora?></td><td><?=$observacion?></td><td><input type="submit" class="rojo_sombra" value="&laquo; Ver Ficha"
onclick="window.open('mostrardatos.php?r=<?=$rut?>&donde=1', 'popup', 'width=1000,height=700'); return false;" /></td><td>
...
<? }?>
	...
	<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='PatCom'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='PatCom' order by fecha_creacion asc ";
...
<? }?>
	...
	<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='PerCirc'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='PerCirc' order by fecha_creacion asc ";
...
onclick="window.open('mostrardatos.php?r=<?=$rut?>&donde=1', 'popup', 'width=1000,height=700'); return false;" /></td>
<td>
<?	if ($miarea==0 or $nombre_area=="PermCirc") {	?>
<input type="submit" class="rojo_sombra_act" value="&laquo; Act WF" onclick="javascript:window.location.href='http://<?=$g_nombreurl?>/workflow.php?r=<?=$rut?>&donde=1&fecha_va=<?=$_POST["fecha_va"]?>';" />
<?}else{?>
<input type="submit" class="rojo_sombra" value="&laquo; Ver WF" onclick="window.open('pop_wf.php?r=<?=$rut?>&donde=1', 'popup', 'width=1000,height=700'); return false;" />
<?}?>
...
<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='LicCond'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='LicCond' order by fecha_creacion asc ";
...
<? }?>
	...
	<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='Aseo'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
...
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='Aseo' order by fecha_creacion asc ";
...
<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='CertObras'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='CertObras' order by fecha_creacion asc ";
...
<?}
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='Inspeccion'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='Inspeccion' order by fecha_creacion asc ";
...
<? }?>
	...
	<?}
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='PermProv'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='PermProv' order by fecha_creacion asc ";
...
<? }
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99' and area='Tesoreria'";
	  $res=mysql_query($result,$conexio); 
	  $numeroRegistros=mysql_num_rows($res); 
	  if ($numeroRegistros>0) { ?>	
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width=100>Ir al WF</th></tr></thead>
<?
	  $result = "SELECT * FROM anotaciones WHERE vigente=1 and fecha_creacion>'".$_POST["fecha_va"]." 00:00:00' and fecha_creacion<'".$_POST["fecha_va"]." 99:99:99'  and area='Tesoreria' order by fecha_creacion asc ";
