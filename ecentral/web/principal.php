...
$query = "SELECT Rut, Nombres, ApellidoPat, ApellidoMat, email, Fono1, Fono2, idCiudad, idComuna
...
<?php } ?>
  ...
  <tr>
    ...
    <input type="hidden" name="Nombres"        value="<?php echo $rowUser['Nombres']; ?>" />
    <input type="hidden" name="ApellidoPat"    value="<?php echo $rowUser['ApellidoPat']; ?>" />
    <input type="hidden" name="ApellidoMat"    value="<?php echo $rowUser['ApellidoMat']; ?>" />
    ...
    <input type="hidden" name="Estado"         value="7" />
  	<input type="hidden" name="Fcreacion"      value="<?php date_default_timezone_set('UTC');echo date("Y-m-d");?>" />
    </td>   
