...
$original = "mnt_social_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_social_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_social_categorias_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_social_categorias.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_social_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_social_categorias_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_social_categorias.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_social_categorias.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion de Categoria Social</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion de Categoria Social
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="id_socialcat">
...
//Creo la variable con la ubicacion
	$z="WHERE id_socialcat>'0' ";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z .="AND Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT id_socialcat FROM `mnt_social_categorias` ".$z."";
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCatpem as $catpem) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $catpem['id_socialcat']; ?></td>
			<td class=" "><?php echo $catpem['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$catpem['id_socialcat']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$catpem['id_socialcat'];?>
