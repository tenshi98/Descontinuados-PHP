...
//Se validan si existe el usuario o el email asociado de este en la base de datos
	...
	if(isset($descripcion)){
		$sql_usuario = mysql_query("SELECT descripcion FROM mnt_oirs_antecedentes WHERE descripcion='".$descripcion."'"); 
	...
	<div id="txf_01" class="alert_error">  
	  	El Antecedente ya existe, ingrese otro
...
//Validaciones de ingreso de datos obligatorios
	...
	<div id="txf_02" class="alert_error">  
	  	No ha ingresado la descripcion del antecedente
