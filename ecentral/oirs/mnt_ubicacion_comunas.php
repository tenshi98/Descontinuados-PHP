...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_ubicacion_comunas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_ubicacion_comunas_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_ubicacion_comunas.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_ubicacion_comunas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_ubicacion_comunas_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_ubicacion_comunas.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_ubicacion_comunas.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion de Comunas</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion de Comunas
...
<div id="txf_03" class="alert_sucess">  
	Comuna Modificada correctamente
	<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idComuna">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Comuna</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrComunas as $comunas) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $comunas['idComuna']; ?></td>
			<td class=" "><?php echo $comunas['nombre_ciudad']; ?></td>
            <td class=" "><?php echo $comunas['nombre_comuna']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$comunas['idComuna']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$comunas['idComuna'];?>
