...
$original = "admin_administradores.php";
$location = $original;
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Supervisor creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Supervisor editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Supervisor borrado correctamente';}
...
<div class="icons"><i class="fa fa-edit"></i></div>
		<h5>Modificacion datos del Supervisor</h5>	
		</header>	
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Supervisor</a><?php } ?>
</div>
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Supervisores</h5>	
	</header>
