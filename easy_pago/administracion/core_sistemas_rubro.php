...
<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Rubro</a>
</div>
	...
	<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
		...
		<?php foreach ($arrRubro as $tipo) { ?>
			<tr class="odd">
				...
				<td>
					<a href="<?php echo $location.'&id='.$tipo['idRubro']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a>
					<?php $ubicacion=$location.'&del='.$tipo['idRubro'];?>
