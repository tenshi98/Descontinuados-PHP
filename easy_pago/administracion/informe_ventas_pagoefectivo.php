...
$original = "informe_ventas_pagoefectivo.php";
$location = $original;
...
$query = "SELECT idVentas FROM `clientes_pago_efectivo` ";
...
$arrVentas = array();
$query = "SELECT idCliente, Monto, Fecha, Fono, Cip, Estado
...
<div class="col-lg-12">
	<div class="box">	
		<header>		
			<div class="icons"><i class="fa fa-table"></i></div><h5>Ventas de Pago Efectivo</h5>	
		</header>
