...
$original = "admin_administradores_activation.php";
$location = $original;
...
$z="WHERE usuarios_listado.tipo='Supervisor'";
...
<label class="control-label col-lg-4">Buscar Supervisor</label>
