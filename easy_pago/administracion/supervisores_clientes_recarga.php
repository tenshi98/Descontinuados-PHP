...
$original = "supervisores_clientes_recarga.php";
$location = $original;
...
$query = "SELECT Nombre , Saldo, idUsuario
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Recarga Saldo Almacen <?php echo $rowdata['Nombre']; ?></h5>
		</header>
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			<div class="form-group">
            	...
            	<input type="hidden" name="idUsuario" value="<?php echo $rowdata['idUsuario']; ?>" >
