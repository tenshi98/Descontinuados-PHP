...
$query = "SELECT Nombre, Fono, email, Rut, fNacimiento, Ciudad, Comuna, Direccion, Direccion_img, idSistema, Comision, ComisionAdmin, idCreador
...
<div class="icons"><i class="fa fa-edit"></i></div>
		...
		<form class="form-horizontal" method="post">		
			...
			if(isset($ComisionAdmin)) {  $x11 = $ComisionAdmin;  }else{$x11 = $rowdata['ComisionAdmin'];}
			if(isset($idCreador)) {      $x12 = $idCreador;      }else{$x12 = $rowdata['idCreador'];}
			...
			echo form_values('Comision Administrador','ComisionAdmin', $x11, 1);
			echo form_select('Administrador Encargado','idCreador', $x12, 2, 'idUsuario', 'Nombre', 'usuarios_listado', 0, $dbConn);
			?>
 ...
 <div class="icons"><i class="fa fa-edit"></i></div>		
	...
	<div id="div-1" class="body">	
		<form class="form-horizontal" method="post">
			...
			if(isset($Comision)) {       $x13 = $Comision;       }else{$x13 = '';}
			if(isset($ComisionAdmin)) {  $x14 = $ComisionAdmin;  }else{$x14 = '';}
			if(isset($idCreador)) {      $x15 = $idCreador;      }else{$x15 = '';}
			...
			echo form_values('Comision','Comision', $x13, 1);
			echo form_values('Comision Administrador','ComisionAdmin', $x14, 1);
			echo form_select('Administrador Encargado','idCreador', $x15, 2, 'idUsuario', 'Nombre', 'usuarios_listado', 0, $dbConn);
			?>
