...
$original = "informe_ventas_cellpower.php";
$location = $original;
...
$query = "SELECT idVentas FROM `clientes_cell_power` ";
...
$arrVentas = array();
$query = "SELECT puntodeventa, Monto, Fecha, idPin, Mensaje
FROM `clientes_cell_power`
ORDER BY Fecha DESC
...
<div class="col-lg-12">
	<div class="box">	
		<header>		
			<div class="icons"><i class="fa fa-table"></i></div><h5>Ventas de Cellpower</h5>	
		</header>
		...
		<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
			...
			<?php foreach ($arrVentas as $ventas) { ?>
				<tr class="odd">		
					<td><?php echo $ventas['puntodeventa']; ?></td>		
					<td><?php echo $ventas['Monto']; ?></td>
					<td><?php echo $ventas['Fecha']; ?></td>		
					<td><?php echo $ventas['idPin']; ?></td>
					<td><?php echo $ventas['Mensaje']; ?></td>			
				</tr>
			<?php } ?>                    
			</tbody>
		</table>
