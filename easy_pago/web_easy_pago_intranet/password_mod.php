...
if ( !empty($_POST['edit_clave']) )  { 
	...
	$form_obligatorios = 'idCliente,oldpassword,password,repassword';
	$form_trabajo= 'update';
					...
					<div class="widget widget-table action-table">
						...
						<div class="widget-content">
							<form method="post" class="form-horizontal" style="margin:2%;" name="form1">
                                ...
                                echo '<div class="alert alert-danger">
                                        <button type="button" class="close" data-dismiss="alert">×</button>
                                        <strong>¡Atencion!</strong> Al modificar esta contraseña tambien modificaras la contraseña de acceso a la app EasyPago.
                                       </div>';
