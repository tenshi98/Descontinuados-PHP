        ...
        <ul class="menu">
        	...
        	<li class="maintab active" id="maintab1" data-submenu="1">
                <a href="<?php echo $pre_uri; ?>GenerarCip.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Generar Cip</span>
                </a>
            </li>
                      
            <li class="maintab active" id="maintab1" data-submenu="1">
                <a href="<?php echo $pre_uri; ?>NotificarCip.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Notificación Cip</span>
                </a>
            </li>
            
            <li class="maintab  has_submenu" id="maintab9" data-submenu="9">
                <a href="<?php echo $pre_uri; ?>ConsultarCip.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Consultar Cip</span>
                </a>
            </li>
            
            <li class="maintab  has_submenu" id="maintab9" data-submenu="9">
                <a href="<?php echo $pre_uri; ?>ConsultaMasiva.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Consultar Todos los Cip</span>
                </a>
            </li>
            
            <li class="maintab  has_submenu" id="maintab9" data-submenu="9">
                <a href="<?php echo $pre_uri; ?>EliminarCip.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>EliminarCip</span>
                </a>
            </li>
            
            <li class="maintab  has_submenu" id="maintab9" data-submenu="9">
                <a href="<?php echo $pre_uri; ?>ActualizarCip.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Actualizar Cip</span>
                </a>
            </li>
            
            <li class="maintab  has_submenu" id="maintab9" data-submenu="9">
                <a href="../tools/configurador.php" class="title">
                    <i class="icon-AdminCatalog"></i><span>Configurador</span>
                </a>
            </li>
