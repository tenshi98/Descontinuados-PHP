...
$location2 = "mensajes.php?id=".$_GET['id']."&latitud=".$_GET['latitud']."&longitud=".$_GET['longitud']."&imei=".$_GET['imei'];
...
<tr><td><label>Ingrese el codigo recibido en tu Correo Electr&oacute;nico, revisa tambien tu bandeja de correo no deseado (SPAM).</label></td></tr>
