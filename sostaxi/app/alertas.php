...
//echo "lon  ".$_GET["longitud"]."  lat  ".$_GET["latitud"]."  imei     ".$_GET["imei"]."  gm     ".$_GET["id"]."   MSQG   ".$_GET["msg"];



list($usuario, $mensaje) =   split("-->", $_GET["msg"], 2);
$pos = strpos('alerta de Seguridad', $mensaje);
...
$fecha=$diadis."/".$mesdis."/".$Anio."  ".$hora_muestra;
		...
		$sql0 = "select id,id_alerta from mensajes where mensaje='".$_GET["msg"]."' and grupo='".$login."' order by id desc  LIMIT 0, 1";
