...
<table class="table_msg">
  ...
  <tr>
	...
	<p><strong>Comuna : </strong>&nbsp;<?php echo $rowusr['comuna_linea']; ?></p>
	<p><strong>Nro. Linea : </strong>&nbsp;<?php echo $rowusr['linea']; ?></p>
    </td>
  </tr>
    <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
    <h1>Mi ubicacion actual</h1>
    <p><strong>Tu radio de alertas Cercanas es de  </strong><?php echo $rowusr['radio'] ?>  Kilometros</p>
