...
$sql ="SELECT NOMBRE,DOMICILIO,Comuna,fono_celular,domicilio_2,comuna_2,tipo_domicilio2,correo,rut_compara FROM padron_electoral_CL WHERE rut_compara='" . $uno.$dos . "'";
...
<?}
	...
	&imei=<?=$_GET["imei"]?> &id=<?=$_GET["id"]?>">
		...
		<input type="hidden" name="ciudad_ejecutiv" value="">
  ...
  <tr>
	...
	<form name="form1" method="post" onsubmit="return validaRut()" >
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="25" colspan="4" class="Arial4">Ingrese el n&uacute;mero de su C&eacute;dula de Identidad</td>
                      </tr>
