...
if ($resultado) {
	...
	foreach ($arrNoticias as $noti) {
		echo '<li>';
			echo noti_title($noti['Titulo'],Fecha_completa($noti['Fecha']),$config_app);
			echo noti_text('p',cortar($noti['Resumen'], 150),$config_app);
			echo link_btn('enlace','list_paginas.php'.$w.'&view_noti='.$noti['idPagListado'].$xyz,'Ver','fright',$config_app);
