...
WHERE idRecorrido={$_GET['idRecorrido']} AND idRuta={$_GET['idRuta']} AND idDisponibilidad=1
ORDER BY Orden ASC";
...
foreach ( $arrPosiciones as $pos ) { ?>
	['<?php echo $ordenx; ?>', <?php echo $pos['Latitud']; ?>, <?php echo $pos['Longitud']; ?>, '<?php echo $pos['PPU']; ?>'], 					
<?php 
$ordenx++;
} ?>
];
