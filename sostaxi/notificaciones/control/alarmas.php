...
<body onload="setTimeout('refrescar()', 5000);MM_preloadImages('../images/logo_footer_up2.png');">
<div id="nonFooter">
...
<table width="98%" align="center">  
 ...
 <tr class="arial_tit_gris">
        ...
        <td width="29%" align="left" height="47">Mensaje del llamado</td>
...
?>
 ...
 <tr>
				...
				<a href="http://<?=$nombreurl?>/vigilancia/alarmdetalle.php?lon=<?=$lon?>&lat=<?=$lat?>" target=_self >
