...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Nombre)){
				$sql_usuario = mysql_query("SELECT Nombre FROM preguntas_categorias WHERE Nombre='".$Nombre."' AND idTipoCliente='".$idTipoCliente."' "); 
				$n1 = mysql_num_rows($sql_usuario);
			} else {$n1=0;}
			if($n1 > 0) {$error['Nombre'] = 'error/El nombre de la categoria ya existe';}
