...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Respuesta)){
				$sql_usuario = mysql_query("SELECT Respuesta FROM preguntas_respuestas WHERE Respuesta='".$Respuesta."' AND idPregunta='".$idPregunta."' "); 
				$n1 = mysql_num_rows($sql_usuario);
			} else {$n1=0;}
			if($n1 > 0) {$error['Respuesta'] = 'error/La respuesta ya esta en uso';}
