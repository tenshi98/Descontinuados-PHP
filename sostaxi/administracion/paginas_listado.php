...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'idTipoCliente,idPagGrupo,idPagCat,Titulo,Fecha,Texto';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/paginas_listado.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idPagListado,idTipoCliente,idPagGrupo,idPagCat,Titulo,Fecha,Texto';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/paginas_listado.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Pagina Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Pagina Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Pagina borrada correctamente';}
...
$query = "SELECT  idPagGrupo, idPagCat, Titulo, Fecha, Texto, idTipoCliente
...
<div class="col-lg-10 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">  
			...
			if(isset($idPagGrupo)) {     $x2  = $idPagGrupo;     }else{$x2  = $rowdata['idPagGrupo'];}
			if(isset($idPagCat)) {       $x3  = $idPagCat;       }else{$x3  = $rowdata['idPagCat'];}
			...
			echo form_select_depend1('Grupo','idPagGrupo', $x2, 1, 'idPagGrupo', 'Nombre', 'paginas_grupos', $zz,
									'Categoria','idPagCat', $x3, 1, 'idPagCat', 'idPagGrupo', 'Nombre', 'paginas_categorias', $zz, 
									 $dbConn);
			
			echo form_input('text', 'Titulo', 'Titulo', $x4, 2);
			echo form_date('Fecha de Publicacion','Fecha', $x5, 1);
			echo form_ckeditor('Pagina','Texto', $x6, 2);
			?>

			<div class="form-group">
            	<input type="hidden" name="idPagListado" value="<?php echo $_GET['id']; ?>" >
 ...
 <div class="col-lg-10 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			if(isset($idPagGrupo)) {     $x2  = $idPagGrupo;     }else{$x2  = '';}
			if(isset($idPagCat)) {       $x3  = $idPagCat;       }else{$x3  = '';}
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE paginas_listado.idTipoCliente>=0";	
}else{
	$z="WHERE paginas_listado.idTipoCliente={$arrUsuario['idTipoCliente']}";	
}
...
LEFT JOIN `clientes_tipos`        ON clientes_tipos.idTipoCliente    = paginas_listado.idTipoCliente
".$z."
