...
$original = "comportamiento_principal2.php";
$location = $original;
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$form_obligatorios = 'id_Detalle,Nombre';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/detalle_general.php';
}
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Comportamiento creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Comportamiento editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Comportamiento borrado correctamente';}
