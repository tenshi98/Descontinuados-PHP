...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'Nombre,email_principal,RazonSocial,Rut,Direccion,Fono,Ciudad,Comuna';
	$form_trabajo= 'insert';
...
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idTipoCliente,Nombre,email_principal,RazonSocial,Rut,Direccion,Fono,Ciudad,Comuna';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/clientes_tipos.php';
}
//se borra un dato
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post">
				...
				<div class="form-group">
					<input type="hidden" name="idTipoCliente" value="<?php echo $_GET['id']; ?>"  >
