...
$original = "transantiago_control_entrada.php";
$location = $original;
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	$form_obligatorios = '';
	$form_trabajo= 'update_disp';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/clientes_listado.php';
	$form_obligatorios = 'idCliente,Fecha,Hora,idRecorrido,idRuta,idConductor,idDisponibilidad';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/transantiago_historico.php';
}
?>
<!doctype html>
...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Entrada editada correctamente';}
//Manejador de errores
if(isset($error)&&$error!=''){echo errors_list($error);};?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 if ( ! empty($_GET['id']) ) { 
// Se traen los datos del bus
$query = "SELECT  idConductor, idRecorrido, idRuta
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				if(isset($Hora)) {    $x1  = $Hora;    }else{$x1  = '';}

				//se dibujan los inputs
				echo form_time('Hora Entrada','Hora', $x1, 2);	
				?>
                 
				<div class="form-group">
					<input type="hidden" name="idCliente"         value="<?php echo $_GET['id'] ?>" >
					<input type="hidden" name="Fecha"             value="<?php echo fecha_actual() ?>" >
					<input type="hidden" name="idRecorrido"       value="<?php echo $rowdata['idRecorrido'] ?>" >
					<input type="hidden" name="idRuta"            value="<?php echo $rowdata['idRuta'] ?>" >
					<input type="hidden" name="idConductor"       value="<?php echo $rowdata['idConductor'] ?>" >
