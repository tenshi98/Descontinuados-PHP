...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'Nombre,Apellido_Paterno,Apellido_Materno,Fono1,email,Rut,fNacimiento,Direccion';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/transantiago_conductores.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idConductor,Nombre,Apellido_Paterno,Apellido_Materno,Fono1,email,Rut,fNacimiento,Direccion';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/transantiago_conductores.php';
}
//se borra un dato
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			echo form_input('text', 'Telefono Fijo', 'Fono1', $x5, 2);
...
if (isset($_GET['search']) && $_GET['search'] != ''){       $z .= " AND transantiago_conductores.Rut LIKE '%{$_GET['search']}%'"; }
if(isset($_GET['Nombre']) && $_GET['Nombre'] != '')  {      $z .= " AND transantiago_conductores.Nombre LIKE '%{$_GET['Nombre']}%' " ; }
if(isset($_GET['Sexo']) && $_GET['Sexo'] != '')  {          $z .= " AND transantiago_conductores.Sexo = '".$_GET['Sexo']."'" ; }
if(isset($_GET['idCiudad']) && $_GET['idCiudad'] != '')  {  $z .= " AND transantiago_conductores.idCiudad = '".$_GET['idCiudad']."'" ; }
if(isset($_GET['idComuna']) && $_GET['idComuna'] != '')  {  $z .= " AND transantiago_conductores.idComuna = '".$_GET['idComuna']."'" ; }
