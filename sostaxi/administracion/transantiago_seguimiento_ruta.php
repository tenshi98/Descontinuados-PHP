...
$original = "transantiago_seguimiento_ruta.php";
$location = $original;
			...
			<td>
				...
				var color;
					...
					switch(rutax) {
						...
						case 1:
							$('#consulta2').load('transantiago_seguimiento_ruta_rutas.php?idRecorrido=<?php echo $_GET['view'];?>');
						break;
				...
				function myTimer2() {
					...
					switch(mapax) {
						//Ejecutar formulario con el recorrido y la ruta
						case 1:
							$('#consulta').load('transantiago_seguimiento_ruta_ubicaciones.php?idRecorrido=<?php echo $_GET['view'];?>');
						break;
