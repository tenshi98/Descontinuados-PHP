...
$original = "transantiago_puntos_retorno.php";
$location = $original;
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Punto de Retorno creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Punto de Retorno editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Punto de Retorno borrado correctamente';}
...
$z="WHERE transantiago_rutas_multi.idTipo = 4";		
