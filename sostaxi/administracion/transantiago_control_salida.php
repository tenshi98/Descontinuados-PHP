...
$original = "transantiago_control_salida.php";
$location = $original;
...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Salida editada correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				echo form_time('Hora Salida','Hora', $x1, 2);	
				?>
				...
				<div class="form-group">
					...
					<input type="hidden" name="idDisponibilidad"  value="1" >
