...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'Nombre,idMarca';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/buses_modelos.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idModelo,Nombre,idMarca';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/buses_modelos.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Modelo creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Modelo editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Modelo borrado correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post">
				...
				if(isset($idMarca)) {    $x1  = $idMarca;   }else{$x1  = $rowdata['idMarca'];}
				if(isset($Nombre)) {     $x2  = $Nombre;    }else{$x2  = $rowdata['Nombre'];}
				
				//se dibujan los inputs
				echo form_select('Marcas','idMarca', $x1, 2, 'idMarca', 'Nombre', 'buses_marcas', 0, $dbConn);
				echo form_input('text', 'Nombre', 'Nombre', $x2, 2);
				?>

				<div class="form-group">
					<input type="hidden" name="idModelo" value="<?php echo $_GET['id']; ?>" >
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post">
				...
				<?php 
				//Se verifican si existen los datos
				if(isset($idMarca)) {    $x1  = $idMarca;   }else{$x1  = '';}
...
//Creo la variable con la ubicacion
	$z="WHERE buses_modelos.idModelo!=0";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z .=" AND buses_modelos.Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idModelo FROM `buses_modelos` ".$z."";
...
$arrModelos = array();
$query = "SELECT 
buses_modelos.idModelo,
buses_modelos.Nombre AS nombre_modelo,
buses_marcas.Nombre AS nombre_marca
FROM `buses_modelos`
INNER JOIN `buses_marcas`       ON buses_marcas.idMarca         = buses_modelos.idMarca
".$z."
	...
	<div class="box">
		...
		<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
		 ...
		 <?php foreach ($arrModelos as $grupos) { ?>
				<tr class="odd">
					<td><?php echo $grupos['nombre_marca']; ?></td>
					<td><?php echo $grupos['nombre_modelo']; ?></td>
					<td>
