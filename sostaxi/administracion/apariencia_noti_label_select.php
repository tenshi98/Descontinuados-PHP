...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Color de pestaña seleccionada creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color de pestaña seleccionada editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Color de pestaña seleccionada borrado correctamente';}
