...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Ancho de la imagen creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Ancho de la imagen editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Ancho de la imagen borrado correctamente';}
