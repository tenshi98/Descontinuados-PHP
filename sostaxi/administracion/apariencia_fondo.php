...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Color Fondo creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color Fondo editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Color Fondo borrado correctamente';}
