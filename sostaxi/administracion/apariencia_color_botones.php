...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Color del boton creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color del boton editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Color del boton borrado correctamente';}
