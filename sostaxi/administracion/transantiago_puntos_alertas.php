...
$original = "transantiago_puntos_alertas.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'idEstado,idRecorrido,idRuta,idCatimg,idListimg,Nombre';
...
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$location.='&id='.$_GET['id'];
	$form_obligatorios = 'idRutaAlt,idEstado,idRecorrido,idRuta,idCatimg,idListimg,Nombre';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/transantiago_rutas_multi.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Punto de Alerta creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Punto de Alerta editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Punto de Alerta borrado correctamente';}
...
transantiago_rutas_multi.idCatimg,
transantiago_rutas_multi.idListimg,
...
<div class="col-lg-4 fleft">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Punto de Retorno</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				if(isset($idCatimg)) {      $x7  = $idCatimg;      }else{$x7  = $rowdata['idCatimg'];}
				if(isset($idListimg)) {     $x8  = $idListimg;     }else{$x8  = $rowdata['idListimg'];}
				if(isset($Nombre)) {        $x9  = $Nombre;        }else{$x9  = $rowdata['Nombre'];}
				...
				echo form_date('Fecha','Fecha', $x4, 2);	
				echo form_time('Hora Inicio','HoraInicio', $x5, 2);	
				echo form_time('Hora Termino','HoraTermino', $x6, 2);	
				echo form_select_depend1('Categoria','idCatimg', $x7, 2, 'idCatimg', 'Nombre', 'mnt_imagenes_categorias', 0,
										'Imagen','idListimg', $x8, 2, 'idListimg', 'idCatimg', 'Nombre', 'mnt_imagenes_listado', 0, 
										$dbConn);
				echo form_textarea('Descripcion', 'Nombre', $x9, 2); 
				?>
			...
			<script>
				...
				function initialize() {
					...
					marker = new google.maps.Marker({
						...
						position: myLatlng,
						map: map,
						icon: 'upload/<?php echo $rowdata['file']?>',
						title: "Tu Ubicacion"
					});
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Punto de Retorno</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
				...
				if(isset($idCatimg)) {      $x6  = $idCatimg;      }else{$x6  = '';}
				if(isset($idListimg)) {     $x7  = $idListimg;     }else{$x7  = '';}
				...
				echo form_select_depend1('Categoria','idCatimg', $x6, 2, 'idCatimg', 'Nombre', 'mnt_imagenes_categorias', 0,
										'Imagen','idListimg', $x7, 2, 'idListimg', 'idCatimg', 'Nombre', 'mnt_imagenes_listado', 0, 
										$dbConn);				
				echo form_textarea('Descripcion', 'Nombre', $x8, 2); 
				?>
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form name="form1" class="form-horizontal" action="<?php echo $location; ?>" >
				...
				echo form_date('Fecha','Fecha', $x6, 1);	
...
$z="WHERE transantiago_rutas_multi.idTipo = 6";		
