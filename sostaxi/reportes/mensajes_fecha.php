...
$sql="SELECT * FROM mensajes where substr(fecha_hora,1,10)='". $_POST["fecha"] ."' and estado=0 ";
...
?>
          ...
          <tr>
			...
			<table width="942" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <th class="top_tabla_red" scope="col">Mensaje</th>
                <th class="top_tabla_red" scope="col">Grupo</th>
                <th class="top_tabla_red" scope="col">Fecha/Hora</th>
                <th class="top_tabla_red" scope="col">Link</th>
				<th class="top_tabla_red" scope="col">Visitas</th>
								<th class="top_tabla_red" scope="col">Detalle</th>
              </tr>
<?$contador=0;
$contador_gral=0;

$sql2="SELECT * FROM mensajes where substr(fecha_hora,1,10)='". $_POST["fecha"] ."' and estado=0 ORDER BY id DESC LIMIT ".$limitInf.",".$tamPag; 
...
?>  
  <!-- tabla de resultados --> 
              ...
              <tr>
                <td class="celda_reporte"><?=$mensaje?></td>
                <td class="celda_reporte"><?=$grupo?></td>
                <td class="celda_reporte"><?=$fecha_hora?></td>
                <td class="celda_reporte">
				<input type=image src="http://<?=$nombreurl?>/images/ver5.png" 
onclick="window.open('<?=$link?>', 'Link', 'width=1050,height=700,scrollbars=1'); return false;" />
				
				
				</td>
                <td class="celda_reporte"><?=$visitas?> Visitas</td>
				<td class="celda_reporte">
				<input type=image src="http://<?=$nombreurl?>/images/informado.png" 
onclick="window.open('http://<?=$nombreurl?>/reportes/detalle_mensaje.php?id_mensaje=<?=$registro["id"]?>', 'detalle', 'width=1050,height=700,scrollbars=1'); return false;" />
