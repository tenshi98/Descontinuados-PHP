...
<title>.:: <?=$pagina?> ::.</title>
<link href="http://<?=$nombreurl?>/css/style.css" rel="stylesheet" type="text/css">
<link href="http://<?=$nombreurl?>/css/mediaquerie.css" rel="stylesheet" type="text/css">
<link href="http://<?=$nombreurl?>/css/normalize.css" rel="stylesheet" type="text/css">
<link href="http://<?=$nombreurl?>/css/style_barra.css" rel="stylesheet" type="text/css">
<link href="http://<?=$nombreurl?>/css/nph.css" rel="stylesheet" type="text/css">
<?php if(isset($_COOKIE['sess_demo'])){ ?>
<link href="http://<?=$nombreurl?>/css/smq1ndp.css" rel="stylesheet" type="text/css">
<?}?>
<script type="text/javascript" src="http://<?=$nombreurl?>/js/modernizr-1.7.min.js"></script>
<meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
...
<script type="text/javascript" src="http://<?=$nombreurl?>//scripts/peruid.pid-2.0.js"></script>
