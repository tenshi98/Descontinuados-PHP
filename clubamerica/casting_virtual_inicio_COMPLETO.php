                                                    ...
                                                    <div class="datos_bloq2">
                                                    	<div class="span12">
                                                        		<div class="b_cont_datos">
                                                                    ...
                                                                    <h4><?
												$sql_direcc = "SELECT Nombre FROM ubicacion_provincia Where idProvincia=".$row_usuario["idProvincia"]; 
												$result_direcc =mysql_query($sql_direcc,$dbCasting);
												while ($registro_direcc= mysql_fetch_array($result_direcc))  {   
												echo $registro_direcc['Nombre'];
												}?></h4>
                                                                </div>
																                                                        		<div class="b_cont_datos">
                                                                    <h4><strong>Distrito</strong></h4>
                                                                    <h4><?
												$sql_direcc = "SELECT Nombre FROM ubicacion_distrito Where idDistrito=".$row_usuario["idDistrito"]; 
												$result_direcc =mysql_query($sql_direcc,$dbCasting);
												while ($registro_direcc= mysql_fetch_array($result_direcc))  {   
												echo $registro_direcc['Nombre'];
												}?></h4>
                                                    	...
                                                    	<div class="span12">
                                                        		<div class="b_cont_datos">
                                                                    ...
                                                                    <h4><?
												$sql_direcc = "SELECT Nombre FROM ubicacion_departamento Where idDepartamento=".$row_usuario["idDepartamento"]; 
												$result_direcc =mysql_query($sql_direcc,$dbCasting);
												while ($registro_direcc= mysql_fetch_array($result_direcc))  {   
												echo $registro_direcc['Nombre'];
												}?></h4>
                                                    ...
                                                    <div class="cont_btn"><a href="perfil.php" rel="shadowbox;width=900;height=550">EDITAR PERFIL</a></div>
                                            </div>
                                     </div>
