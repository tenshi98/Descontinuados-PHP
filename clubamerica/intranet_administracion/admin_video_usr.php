...
//Variable con la ubicacion
	$z="WHERE user_listado.id!=0";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z.=" AND user_listado.email LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT id FROM `user_listado` ".$z."";
...
$arrUsers = array();
$query = "SELECT id, Nombre, email, nick, rol 
FROM `user_listado`
".$z."
ORDER BY rol DESC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			<td class=" "><a name="<?php echo $usuarios['email'] ?>"></a> <?php echo $usuarios['email']; ?></td>
			<td class=" "><?php echo $usuarios['Nombre']; ?></td>
            <td class=" "><?php echo $usuarios['nick']; ?></td>
            ...
            //Verifico si existe la variable de busqueda y pagina
           	$w='&anclaje='.$usuarios['email'];	
			?>      				
            <ul class="interruptor">   
               <?php if ( $usuarios['rol']=='2' ) {?>   
                <li class="primer_int"><a href="<?php echo $location.'&id='.$usuarios['id'].'&estado=1'.$w ; ?>">OFF</a></li>
                <li class="ultimo_int on"><a href="#">ON</a></li>
               <?php } else {?>
                <li class="primer_int on"><a href="#">OFF</a></li>
                <li class="ultimo_int"><a href="<?php echo $location.'&id='.$usuarios['id'].'&estado=2'.$w ; ?>">ON</a></li>
               <?php }?>    
            </ul>
