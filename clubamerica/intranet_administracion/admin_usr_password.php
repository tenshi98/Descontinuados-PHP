...
if ( !empty($_POST['submit_pass']) )  { 
	...
	require_once '../AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_5.php';
	require_once '../AR2D2CFFDJFDJX1/xrxs_trans/usuarios_listado_update.php';
}
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nueva Clave" class="form-control"   name="password" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Repetir Nueva Clave" class="form-control"  name="repassword" required>
				</div>
			</div>
