...
<table class="tb_map">
  ...
  <tr height="10%">
    <td width="50%">
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'].' '.$config_app['btn_cancelar_border'] ?> btn_link" href="<?php echo $location.'&view='.$_GET['view'].'&view_noti='.$_GET['view_noti']; ?>" >Cancelar</a>
    </td>
    <td>
    <?php 
...
<?php  if($row_data['idVehiculo']!=0&&$row_data['idVehiculo']!=''){?> 
  <tr height="10%">
    <td>
    	<a class="<?php echo $config_app['btn_otros_color_fondo'].' '.$config_app['btn_otros_ancho'].' '.$config_app['btn_otros_radio'].' '.$config_app['btn_otros_float'].' '.$config_app['btn_otros_color_texto'].' '.$config_app['btn_otros_sombra'].' '.$config_app['btn_otros_border'] ?> btn_link" href="<?php echo $location.'&view='.$_GET['view'].'&vista=true&idAlerta='.$row_data['idAlerta'].'&idAsaltado='.$row_data['idCliente'].'&view_noti='.$_GET['view_noti']; ?>" >Lo vi</a>
    </td>
  </tr>
<?php } ?> 
  <tr height="10%">
...
<section class="tabs <?php echo $config_app['noti_width'].' '.$config_app['noti_border'].' '.$config_app['noti_shadow'].' '.$config_app['noti_aling'].' '.$config_app['noti_color'].' '.$config_app['noti_tab_hover'].' '.$config_app['noti_tab_check'].' '.$config_app['noti_tab_label'].' '.$config_app['noti_tab_label_select'] ?>">
        ...
        */?>
        ...
        <div class="content <?php echo $config_app['noti_separator'] ?>">
          ...
          <div class="content-2">
          	<h1 class="<?php echo $config_app['noti_tittle_color'].' '.$config_app['noti_tittle_size'] ?>">Mis Alertas</h1>
          	<ul id="resultados_2"></ul>
            <div class="animation_image_2" style="display:none" align="center"><img src="img/ajax-loader.gif"></div>
          </div>
		  <div class="content-3">
          	<h1 class="<?php echo $config_app['noti_tittle_color'].' '.$config_app['noti_tittle_size'] ?>">Mis Robos</h1>
          	<ul id="resultados_3"></ul>
            <div class="animation_image_3" style="display:none" align="center"><img src="img/ajax-loader.gif"></div>
          </div>
          <div class="content-4">
          	<h1 class="<?php echo $config_app['noti_tittle_color'].' '.$config_app['noti_tittle_size'] ?>">Mis Solicitudes de taxi</h1>
