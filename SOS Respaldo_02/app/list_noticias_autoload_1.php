...
WHERE idNotCat={$_GET['filtercat']}  AND idTipoCliente='{$_GET['app_conf']}'
...
if ($resultado) {
	...
	echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' '.$config_app['btn_enlace_border'].' btn_link fright" href="list_noticias.php'.$w.'&view_noti='.$noti['idNotListado'].$xyz.'">Ver</a>';  
