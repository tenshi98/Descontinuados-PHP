...
jQuery(function($) {
	...
	var optMarker = {
		...
		icon: 'map_img/icon/punto_a_min.png',
		title: 'Origen',
		visible: false
	}
	...
	optMarker.el = $('#end2');
	optMarker.icon = 'map_img/icon/punto_b_min.png';
...
var buscarRuta = function(e) {
	...
	if (inputstart != '' && inputend != '') {
		$('#resumen').html('<div class="loadingRoutes"><span>Cargando rutas</span> <span class="loader"><img src="map_img/ajax-loader.gif" alt="Cargando..." /></span></div>');
		$.calcRoute();
		$('#suggestCont').show();
		if (!visited) {
			mostrarNotificacion();
