...
$original = "apariencia_borderradius.php";
$location = $original;
...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/app_ajustes_tipo.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/app_ajustes_tipo_1.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/app_ajustes_tipo.php';
}
...
//Llamamos a las partes del formulario
require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/app_ajustes_tipo.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/app_ajustes_tipo_2.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/app_ajustes_tipo.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
//Se consiguen las variables de busqueda y paginacion
...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/app_ajustes_tipo.php';
}
...
<div id="txf_03" class="alert_sucess">  Borde redondeado Creado correctamente
...
<div id="txf_03" class="alert_sucess">  Borde redondeado Modificado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  Borde redondeado borrado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<div class="col-lg-6 fcenter">
	<div class="box dark">	
		<header>		
			...
			<h5>Modificacion datos del borde redondeado</h5>	
		</header>	
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" name="form1">		
				...
				<div class="col-lg-8">				
				<input type="text" id="text2" placeholder="Codigo" class="form-control" value="<?php if(isset($Codigo)) {echo $Codigo;} else {echo $rowdata['Codigo'];}?>"  name="Codigo" required>			
				</div>		
				</div>

				<div class="form-group">
				<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idApp">			
...
<div class="col-lg-6 fcenter">
	<div class="box dark">	
		<header>		
			<div class="icons"><i class="fa fa-edit"></i></div>		
			<h5>Crear Nuevo borde redondeado</h5>	
		</header>	
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" name="form1">		
				<div class="form-group">			
				...
				<div class="form-group">
					<input type="hidden" name="idGrupo" value="26" >			
...
if (isset($_GET['search'])){$z.=" AND Nombre LIKE '%{$_GET['search']}%'";	
}
$z.=" AND idGrupo=26";
...
<label class="control-label col-lg-4">Buscar Borde</label>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Borde</a><?php }?>
</div>
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Bordes redondeados</h5>	
	</header>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrBorde as $bordes) { ?>
    	<tr class="odd">		
			<td class=" sorting_1"><?php echo $bordes['Nombre']; ?></td>
            <td class=" sorting_1"><?php echo $bordes['Codigo']; ?></td>
            <td class=" sorting_1"><div class="preview <?php echo $bordes['Codigo']; ?>"></div></td>		
			<td class=" ">  
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$bordes['idApp']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$bordes['idApp'];?>			
