...
$original = "apariencia_border.php";
$location = $original;
...
<div id="txf_03" class="alert_sucess">  Borde Creado correctamente
...
<div id="txf_03" class="alert_sucess">  Borde Modificado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  Borde borrado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<div class="col-lg-6 fcenter">
	<div class="box dark">	
		<header>		
			...
			<h5>Modificacion datos del Borde</h5>	
		</header>	
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" name="form1">		
				...
				<div class="form-group">
					<input type="hidden" name="idGrupo" value="25" >			
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Bordes</h5>	
	</header>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrBorde as $borde) { ?>
    	<tr class="odd">		
			<td class=" "><?php echo $borde['Nombre']; ?></td>
            <td class=" "><?php echo $borde['Codigo']; ?></td>
            <td class=" "><div class="preview <?php echo $borde['Codigo']; ?>"></div></td>		
			<td class=" ">  
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$borde['idApp']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$borde['idApp'];?>			
