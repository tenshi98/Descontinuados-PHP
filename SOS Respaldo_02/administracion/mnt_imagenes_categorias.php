...
$original = "mnt_imagenes_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_imagenes_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_imagenes_categorias_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_imagenes_categorias.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_imagenes_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_imagenes_categorias_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_imagenes_categorias.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_imagenes_categorias.php';
}
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idCatimg">
...
$query = "SELECT idCatimg FROM `mnt_imagenes_categorias` ".$z."";
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCiudad as $ciudad) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$ciudad['idCatimg']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$ciudad['idCatimg'];?>
