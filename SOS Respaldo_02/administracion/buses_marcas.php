...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_marcas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_marcas_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/buses_marcas.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_marcas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_marcas_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/buses_marcas.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/buses_marcas.php';
}
...
$query = "SELECT idMarca FROM `buses_marcas` ".$z."";
