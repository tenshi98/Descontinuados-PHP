...
$original = "buses_transmision.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_transmision.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_transmision_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/buses_transmision.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_transmision.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_transmision_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/buses_transmision.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/buses_transmision.php';
}
...
$query = "SELECT idTransmision FROM `buses_transmision` ".$z."";
