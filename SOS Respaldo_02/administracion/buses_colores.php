...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_colores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_colores_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/buses_colores.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/buses_colores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/buses_colores_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/buses_colores.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/buses_colores.php';
}
...
$query = "SELECT idColorV FROM `buses_colores` ".$z."";
