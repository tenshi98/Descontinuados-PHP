...
$original = "taxistas_tipo_pago.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_tipo_pago.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_tipo_pago_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/taxista_tipo_pago.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_tipo_pago.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_tipo_pago_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/taxista_tipo_pago.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/taxista_tipo_pago.php';
}
...
<div id="txf_03" class="alert_sucess">  
	Tipo de Pago Modificado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Tipo de Pago borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion del Tipo de pago</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idTipoPago">
...
$query = "SELECT idTipoPago FROM `taxista_tipo_pago` ".$z."";
...
<label class="control-label col-lg-4">Buscar Tipo de Pago</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Tipo de Pago</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrTipos as $tipos) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $tipos['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$tipos['idTipoPago']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$tipos['idTipoPago'];?>
