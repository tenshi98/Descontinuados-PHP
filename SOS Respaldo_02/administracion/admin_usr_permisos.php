...
<div id="txf_03" class="alert_sucess">  Permiso Creado correctamente
...
<div id="txf_03" class="alert_sucess">  Permiso Modificado correctamente
<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  Permiso borrado correctamente
<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
if($arrUsuario['tipo']=='SuperAdmin'){$z=" AND core_permisos.idAdmpm>0";	
}else{$z=" AND core_permisos.visualizacion={$arrUsuario['idTipoCliente']} OR core_permisos.visualizacion=9998 ";	
}
...
WHERE core_permisos.mode='".neomode."' ".$z."
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
   ...
   <td>
   <?php
   if($permiso['visualizacion']==9999){   echo 'Solo Superadministradores';
   }elseif($permiso['visualizacion']==9998){   echo 'Todos';
   }else{   echo $permiso['ver'];
   } ?>
   </td>
...
//Se crea la variable con la ubicacion$z="WHERE usuarios_listado.tipo!='SuperAdmin'";
//Verifico el tipo de usuario que esta ingresando
