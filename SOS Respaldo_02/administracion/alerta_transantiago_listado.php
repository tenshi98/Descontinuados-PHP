...
<div id="txf_03" class="alert_sucess">  Alerta silenciada correctamente
...
<script type="text/javascript">
      function initialize() {
		  ...
		  var marker = new google.maps.Marker({		  
			  ...
			  icon: 'img_upload/<?php echo $rowdata['imagen_alerta']; ?>'	  
		  });	  	  	 	  		
      }  
</script>
...
<h2 class="text-primary">Datos del Conductor</h2>
            ...
            <p class="text-muted"><strong>Fono 2 : </strong><?php echo $rowdata['Cond_Fono2']; ?></p>
						...
						<p class="tbl_text">Fecha : <?php echo $rowdata['Fecha']?><br/>
						Hora : <?php echo $rowdata['Hora']?><br/>
						Tipo de alerta : <?php echo $rowdata['tipo_alerta']?></p> 
					</td>
					<td class=" ">
...
<div id="consulta" ></div>
<script type="text/javascript">function actualiza(){	
...
window.onload=function(){	setInterval( "actualiza()", 10000 ); //multiplicas la cantidad de segundos por mil	
};
</script>
