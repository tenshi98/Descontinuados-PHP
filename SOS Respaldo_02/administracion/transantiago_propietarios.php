...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/transantiago_propietarios.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/transantiago_propietarios_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/transantiago_propietarios.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/transantiago_propietarios.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/transantiago_propietarios_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/transantiago_propietarios.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se agregan ubicaciones
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/transantiago_propietarios.php';
}
...
if (isset($_GET['search']) && $_GET['search'] != ''){
	$z .=" AND transantiago_propietarios.Rut LIKE '%{$_GET['search']}%'";
	$x .= "&search=".$_GET['search'] ; 	
}
if(isset($_GET['Nombre']) && $_GET['Nombre'] != '')  { 
	$z .= " AND transantiago_propietarios.Nombre LIKE '%{$_GET['Nombre']}%' " ;
...
if(isset($_GET['Sexo']) && $_GET['Sexo'] != '')  { 
	$z .= " AND transantiago_propietarios.Sexo = '".$_GET['Sexo']."'" ;
	$x .= "&Sexo=".$_GET['Sexo'] ; 
}
if(isset($_GET['idCiudad']) && $_GET['idCiudad'] != '')  { 
	$z .= " AND transantiago_propietarios.idCiudad = '".$_GET['idCiudad']."'" ;
	$x .= "&idCiudad=".$_GET['idCiudad'] ; 
}
if(isset($_GET['idComuna']) && $_GET['idComuna'] != '')  { 
	$z .= " AND transantiago_propietarios.idComuna = '".$_GET['idComuna']."'" ;
	$x .= "&idComuna=".$_GET['idComuna'] ; 
}
if(isset($_GET['Empresa']) && $_GET['Empresa'] != '')  { 
	$z .= " AND transantiago_propietarios.NombreEmpresa LIKE '%{$_GET['Empresa']}%' " ;
