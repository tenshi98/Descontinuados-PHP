...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/clientes_tipos_3.php';
...
<div id="txf_03" class="alert_sucess">  Los datos de la empresa han sido modificados con exito
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post">		
				...
				<div class="form-group">
					<input type="hidden" value="<?php echo $arrUsuario['idTipoCliente'] ?>" name="idTipoCliente">			
