...
$original = "apariencia_sizetext.php";
$location = $original;
...
<div id="txf_03" class="alert_sucess">  Tamaño de texto Creado correctamente
...
<div id="txf_03" class="alert_sucess">  Tamaño de texto Modificado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  Tamaño de texto borrado correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<div class="col-lg-6 fcenter">
	<div class="box dark">	
		<header>		
			...
			<h5>Modificacion datos del Tamaño de texto</h5>	
		</header>	
...
<div class="col-lg-6 fcenter">
	<div class="box dark">	
		<header>		
			<div class="icons"><i class="fa fa-edit"></i></div>		
			<h5>Crear Nuevo Tamaño de texto</h5>	
		</header>	
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" name="form1">		
				<div class="form-group">			
				...
				<div class="form-group">
					<input type="hidden" name="idGrupo" value="30" >			
...
<label class="control-label col-lg-4">Buscar Tamaño de texto</label>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Tamaño</a><?php }?>
</div>
...
<div class="box">	
<header>		
<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Tamaño de texto</h5>	
</header>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">		
			<td class=" "><?php echo $size['Nombre']; ?></td>
			<td class=" "><?php echo $size['Codigo']; ?></td>
			<td class=" "><div class="preview"><p class="<?php echo $size['Codigo']; ?>">Texto</p></div></td>		
			<td class=" ">  
			<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$size['idApp']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
			<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$size['idApp'];?>			
