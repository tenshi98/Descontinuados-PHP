...
function cambia_ciudad(){
	...
	document.form1.idComuna.options[0].selected = true
			...
			<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Nombre Empresa</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre de la Empresa" class="form-control"  name="Empresa"  >
				</div>
			</div>
...
if(isset($_GET['Empresa']) && $_GET['Empresa'] != '')  { 
	$z .= " AND taxista_propietarios.NombreEmpresa LIKE '%{$_GET['Empresa']}%' " ;
	$x .= "&Empresa=".$_GET['Empresa'] ; 
}
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_tax_propietario.php?view='.$usuarios['idPropietario']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php }?>   
