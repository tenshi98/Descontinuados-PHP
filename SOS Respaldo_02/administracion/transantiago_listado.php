...
$original = "transantiago_listado.php";
$location = $original;
...
$query = "SELECT idPropietario, idRecorrido, idConductor, PPU, idMarca, idModelo, idTransmision, fTransferencia, idColorV_1, idColorV_2, fFabricacion, N_Motor, N_Chasis, Obs, idTipoCliente
		...
		<form class="form-horizontal" method="post" name="form1">
        	...
        	<div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="<?php echo $conductor['idConductor']; ?>" <?php if(isset($idConductor)&&$idConductor==$conductor['idConductor']) {echo 'selected="selected"';}elseif($conductor['idConductor']==$rowdata['idConductor']){echo 'selected="selected"';} ?>><?php echo $conductor['Nombre'].' '.$conductor['Apellido_Paterno'].' '.$conductor['Apellido_Materno']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="<?php echo $propietario['idPropietario']; ?>" <?php if(isset($idPropietario)&&$idPropietario==$propietario['idPropietario']) {echo 'selected="selected"';}elseif($propietario['idPropietario']==$rowdata['idPropietario']){echo 'selected="selected"';} ?>><?php echo $propietario['Nombre'].' '.$propietario['Apellido_Paterno'].' '.$propietario['Apellido_Materno']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    <select name="idRecorrido" class="form-control"  required>
                    <option value="" selected="selected">Seleccione un Recorrido</option>
                    <?php foreach ($arrRecorrido as $recorrido) { ?>
                    <option value="<?php echo $recorrido['idRecorrido']; ?>" <?php if(isset($idRecorrido)&&$idRecorrido==$recorrido['idRecorrido']) {echo 'selected="selected"';}elseif($recorrido['idRecorrido']==$rowdata['idRecorrido']){echo 'selected="selected"';} ?>><?php echo $recorrido['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
...
$x = $original; 
$x .='?pagina='.$_GET['pagina'];
if(isset($_GET['search']) && $_GET['search'] != ''){                  $x .= "&search=".$_GET['search'] ;  }
if(isset($_GET['PPU']) && $_GET['PPU'] != ''){                        $x .= "&PPU=".$_GET['PPU'] ;  }
if(isset($_GET['N_Motor']) && $_GET['N_Motor'] != '')  {              $x .= "&N_Motor=".$_GET['N_Motor'] ; }
if(isset($_GET['N_Chasis']) && $_GET['N_Chasis'] != '')  {            $x .= "&N_Chasis=".$_GET['N_Chasis'] ; }
if(isset($_GET['idConductor']) && $_GET['idConductor'] != '')  {      $x .= "&idConductor=".$_GET['idConductor'] ; }
if(isset($_GET['idPropietario']) && $_GET['idPropietario'] != '')  {  $x .= "&idPropietario=".$_GET['idPropietario'] ; }
if(isset($_GET['idRecorrido']) && $_GET['idRecorrido'] != '')  {      $x .= "&idRecorrido=".$_GET['idRecorrido'] ; }
...
?>
				<a href="<?php echo $x; ?>" class="btn btn-danger fright margin_width" data-original-title="" title="">Cancelar y Volver</a>
			</div>
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
            ...
            <div class="form-group">			
					...
					<div class="col-lg-8">				
						<input type="text" placeholder="Nombre de Usuario" class="form-control"  name="usuario" <?php if(isset($usuario)) {echo 'value="'.$usuario.'"';}?> required>			
					</div>		
				</div>
				...
				<div class="form-group">			
					...
					<div class="col-lg-8">				
						<input type="password" placeholder="Password" class="form-control"  name="password" <?php if(isset($password)) {echo 'value="'.$password.'"';}?> required>			
					</div>		
				</div>
				...
				<div class="form-group">			
					...
					<div class="col-lg-8">				
						<input type="password" placeholder="Repetir Password" class="form-control"  name="repassword" <?php if(isset($repassword)) {echo 'value="'.$repassword.'"';}?> required>			
					</div>		
				</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="" selected="selected">Seleccione un Conductor</option>
                    <?php foreach ($arrConductor as $conductor) { ?>
                    <option value="<?php echo $conductor['idConductor']; ?>" <?php if(isset($idConductor)&&$idConductor==$conductor['idConductor']) {echo 'selected="selected"';} ?>><?php echo $conductor['Nombre'].' '.$conductor['Apellido_Paterno'].' '.$conductor['Apellido_Materno']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="" selected="selected">Seleccione un Propietario</option>
                    <?php foreach ($arrPropietario as $propietario) { ?>
                    <option value="<?php echo $propietario['idPropietario']; ?>" <?php if(isset($idPropietario)&&$idPropietario==$propietario['idPropietario']) {echo 'selected="selected"';} ?>><?php echo $propietario['Nombre'].' '.$propietario['Apellido_Paterno'].' '.$propietario['Apellido_Materno']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="" selected="selected">Seleccione un Recorrido</option>
                    <?php foreach ($arrRecorrido as $recorrido) { ?>
                    <option value="<?php echo $recorrido['idRecorrido']; ?>" <?php if(isset($idRecorrido)&&$idRecorrido==$recorrido['idRecorrido']) {echo 'selected="selected"';} ?>><?php echo $recorrido['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Bus</a><?php }?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $usuarios['PPU'].' '.$usuarios['Nombre_marca'].' '.$usuarios['Nombre_modelo']; ?></td>
            <td class=" "><?php echo $usuarios['recorrido']; ?></td>
            <td class=" "><?php echo $usuarios['Nombre_prop'].' '.$usuarios['Apellido_prop']; ?></td>
            <td class=" "><?php echo $usuarios['Nombre_cond'].' '.$usuarios['Apellido_cond']; ?></td>
			<td class=" "><?php echo $usuarios['sistema']; ?></td>
            <td class=" "><?php echo $usuarios['estado']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=1){?><a href="<?php echo 'view_tran_taxista.php?view='.$usuarios['idCliente']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php }?>   
