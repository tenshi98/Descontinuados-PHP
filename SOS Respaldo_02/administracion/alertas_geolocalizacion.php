...
require_once '../AA2D2CFFDJFDJX1/xrxs_trans/alertas_geolocalizacion.php';		
}
...
if(isset($_GET['rango_a']) && $_GET['rango_a'] != ''&&isset($_GET['rango_b']) && $_GET['rango_b'] != ''){ $z .= " AND alertas_listado.Fecha BETWEEN '{$_GET['rango_a']}' AND '{$_GET['rango_b']}'" ;          
}
...
mysql_free_result($resultado);
// Se trae un listado de todas los tipos de alertas
$arrTipoAlerta = array();
