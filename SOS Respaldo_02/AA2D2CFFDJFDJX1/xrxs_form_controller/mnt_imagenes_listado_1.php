...
//Se validan si existe el usuario o el email asociado de este en la base de datos
	...
	if(isset($Nombre)){
		$sql_grupo = mysql_query("SELECT Nombre FROM mnt_imagenes_listado WHERE Nombre='".$Nombre."' AND idCatimg='".$idCatimg."' "); 
		$n_grupo = mysql_num_rows($sql_grupo);
	} else {$n_grupo=0;}
	
	// Valido si el usuario existe
	if($n_grupo > 0) $errors[1]  = '
