...
$original = "alertas_generadas.php";
$location = $original.$w;
?>
...
<h2>Listado de alertas generadas</h2>
...
<tbody>
	...
	<tr>
        <td><?php echo $alertas['tipo_alerta'] ?></td>
        <td><?php echo Fecha_completa($alertas['Fecha']) ?></td>
        <td>
            <a href="<?php echo $location.'&view='.$alertas['idAlerta']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a>   		
        </td>
    </tr>
	<?php }?>
</tbody>
