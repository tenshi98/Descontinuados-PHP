...
("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junioe", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre");
...
"- Mantenga presionado el bot\xf3n del mouse para una selecci\xf3n m\xe1s r\xe1pida.";
...
Calendar._TT["PREV_YEAR"] = "A\xf1o Prev.(Presione para Menu)";
Calendar._TT["PREV_MONTH"] = "Mes Prev. (Presione para Menu)";
Calendar._TT["GO_TODAY"] = "Ir a Hoy";
Calendar._TT["NEXT_MONTH"] = "Mes Sig. (Presione para Menu)";
Calendar._TT["NEXT_YEAR"] = "A\xf1o Sig. (Presione para Menu)";
Calendar._TT["SEL_DATE"] = "Elija Fecha";
Calendar._TT["DRAG_TO_MOVE"] = "Drag para Moverlo";
Calendar._TT["PART_TODAY"] = " (Hoy)";

// the following is to inform that "%s" is to be the first day of week
// %s will be replaced with the day name.
Calendar._TT["DAY_FIRST"] = "Despliege %s primero";
...
Calendar._TT["TIME_PART"] = "(Shift-)Click o Drag para Cambiar valor";
