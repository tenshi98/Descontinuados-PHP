            ...
            <tr>
              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_margin">
                <tr>
                  ...
                  <td width="269" align="center" valign="middle" class="tabla_cont_social"><input name="calle" type="text" class="campo_txt" id="calle" size="80" maxlength="100" onkeypress="return isAlpha2(event);"value=""  placeholder="Ej: Tannembaum" style="width:320px !important;"/></td>
...
<?
      ...
      $result = mssql_query("SELECT Cont_Propietario, Cont_Direccion, Cont_Rut FROM AsContribuyente WITH (NOLOCK) WHERE Cont_Direccion like '%".$_POST["calle"]."%".$_POST["numero"]."%' order by Cont_Direccion asc", $lnk_aseo) or die("MS-Query Error en la consulta a la BD");
	while($row = mssql_fetch_array($result)) {
		$Rut=$row["Cont_Rut"];
