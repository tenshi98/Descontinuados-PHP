                ...
                <tr>
                  <td ><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_cont">
                    <tr class="tabla_margin">
                      ...
                      <td width="89%"><input name="textfield10" type="text" disabled="disabled" class="campo_txt" id="textfield9" value="<?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["RUT"]; ?>" /></td>
                    </tr>
                  </table></td>
                  </tr>
                ...
                <tr>
                  <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_cont">
                    <tr class="tabla_margin">
                      ...
                      <td width="716" ><input name="textfield9" type="text" disabled="disabled" class="campo_txt" id="textfield7" value="<?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["NOMBRE"] ?>" /></td>
                    </tr>
                  </table></td>
                </tr>
              </table></td></tr>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_cont">
                      <tr class="tabla_margin">
                        ...
                        <td width="468" ><input name="textfield11" type="text" disabled="disabled" class="campo_txt" id="textfield10" value="<?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["DIRECCION"] ?>" /></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_cont">
                      <tr class="tabla_margin">
                        ...
                        <td width="89%" ><input name="textfield12" type="text" disabled="disabled" class="campo_txt" id="textfield11" value="<?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["FONO1"] ?>" /></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_cont">
                      <tr class="tabla_margin">
                        ...
                        <td width="89%" ><input name="textfield13" type="text" disabled="disabled" class="campo_txt" id="textfield12" value="<?php echo $$result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["FONO2"].'  '.$fono_celular ?> " /></td>
                      </tr>
                    </table></td>
                  </tr>
                </table></td>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0' class='bordered' >
    ...
    <tbody>
<?php if($result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table1"][$i]["ANIOCAP"]!=''){?>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0' class='bordered' >
    ...
    <tbody>
<?php if($result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table1"][$i]["ROL"]!=''){?>
		<?php for($i=0;$i<=$haypatcom-1;$i++){ ?>
        <tr>
