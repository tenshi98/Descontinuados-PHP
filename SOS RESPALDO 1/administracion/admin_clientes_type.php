...
$original = "admin_clientes_type.php";
$location = $original;
...
$query = "SELECT  idTipoCliente, Nombre, Apellido_Paterno, Apellido_Materno
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion Tipo de usuario de <?php echo $rowdata['Nombre'].' '.$rowdata['Apellido_Paterno'].' '.$rowdata['Apellido_Materno']; ?></h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
        
        	<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Tipo Cliente</label>
				<div class="col-lg-8">
...
".$z."
ORDER BY clientes_listado.Apellido_Paterno ASC, clientes_listado.Apellido_Materno ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrClientes as $clientes) { ?>
    	<tr class="odd">
			<td class=" sorting_1"><?php echo $clientes['usuario']; ?></td>
			<td class=" "><?php echo $clientes['Nombre'].' '.$clientes['Apellido_Paterno'].' '.$clientes['Apellido_Materno']; ?></td>
			<td class=" "><?php echo $clientes['tipo']; ?></td>
			<td class=" "><?php echo $clientes['estado']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$clientes['idCliente']; ?>" title="Editar Tipo de Usuario" class="icon-editar info-tooltip"></a><?php } ?>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
