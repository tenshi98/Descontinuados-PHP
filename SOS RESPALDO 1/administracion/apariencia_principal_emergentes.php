	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=msg_error_color_text&val='.$textcolor['Codigo'].'&return1=error&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=msg_error_color_body&val='.$colores['Codigo'].'&return1=error&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=msg_alert_color_text&val='.$textcolor['Codigo'].'&return1=alert&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
                <a href="<?php echo $location.'?table=msg_alert_color_body&val='.$colores['Codigo'].'&return1=alert&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=msg_success_color_text&val='.$textcolor['Codigo'].'&return1=success&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
                <a href="<?php echo $location.'?table=msg_success_color_body&val='.$colores['Codigo'].'&return1=success&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=msg_info_color_text&val='.$textcolor['Codigo'].'&return1=info&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
                <a href="<?php echo $location.'?table=msg_info_color_body&val='.$colores['Codigo'].'&return1=info&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
