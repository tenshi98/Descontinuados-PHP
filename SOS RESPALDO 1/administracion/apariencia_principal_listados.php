...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=list_alin&val=fleft&return1=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['list_alin']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fright&return1=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['list_alin']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fcenter&return1=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['list_alin']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=list_alin&val=fnone&return1=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=list_tittle_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=list_tittle_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=list_text_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=list_text_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
