...
<div id="txf_03" class="alert_sucess">  
	Titulos modificados correctamente
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=title1_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=title1_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=title2_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=title2_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=title3_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=title3_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=title4_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=title4_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=title5_size&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=title5_color&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_6.php" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div>
