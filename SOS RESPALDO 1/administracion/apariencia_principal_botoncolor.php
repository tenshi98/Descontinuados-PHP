...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=btn_enlace_float&val=fleft&return1=enlace&return2=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['btn_enlace_float']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_enlace_float&val=fright&return1=enlace&return2=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['btn_enlace_float']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_enlace_float&val=fcenter&return1=enlace&return2=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['btn_enlace_float']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_enlace_float&val=fnone&return1=enlace&return2=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=btn_enlace_color_texto&val='.$textcolor['Codigo'].'&return1=enlace&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=btn_enlace_sombra&val='.$sombras['Codigo'].'&return1=enlace&return2=mod'; ?>" title="<?php echo $sombras['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=btn_enlace_color_fondo&val='.$colores['Codigo'].'&return1=enlace&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
        	<td colspan="5">
                <a href="<?php echo $location.'?table=btn_aceptar_float&val=fleft&return1=aceptar&return2=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['btn_aceptar_float']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_aceptar_float&val=fright&return1=aceptar&return2=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['btn_aceptar_float']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_aceptar_float&val=fcenter&return1=aceptar&return2=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['btn_aceptar_float']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_aceptar_float&val=fnone&return1=aceptar&return2=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
             <a href="<?php echo $location.'?table=btn_aceptar_color_texto&val='.$textcolor['Codigo'].'&return1=aceptar&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSombras as $sombras) { ?>     
                <a href="<?php echo $location.'?table=btn_aceptar_sombra&val='.$sombras['Codigo'].'&return1=aceptar&return2=mod'; ?>" title="<?php echo $sombras['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
                <a href="<?php echo $location.'?table=btn_aceptar_color_fondo&val='.$colores['Codigo'].'&return1=aceptar&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=btn_cancelar_float&val=fleft&return1=cancelar&return2=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['btn_cancelar_float']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_cancelar_float&val=fright&return1=cancelar&return2=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['btn_cancelar_float']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_cancelar_float&val=fcenter&return1=cancelar&return2=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['btn_cancelar_float']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_cancelar_float&val=fnone&return1=cancelar&return2=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
          <a href="<?php echo $location.'?table=btn_cancelar_color_texto&val='.$textcolor['Codigo'].'&return1=cancelar&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSombras as $sombras) { ?>     
                <a href="<?php echo $location.'?table=btn_cancelar_sombra&val='.$sombras['Codigo'].'&return1=cancelar&return2=mod'; ?>" title="<?php echo $sombras['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
              <a href="<?php echo $location.'?table=btn_cancelar_color_fondo&val='.$colores['Codigo'].'&return1=cancelar&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=btn_otros_float&val=fleft&return1=otros&return2=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['btn_otros_float']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_otros_float&val=fright&return1=otros&return2=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['btn_otros_float']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_otros_float&val=fcenter&return1=otros&return2=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['btn_otros_float']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=btn_otros_float&val=fnone&return1=otros&return2=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=btn_otros_color_texto&val='.$textcolor['Codigo'].'&return1=otros&return2=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSombras as $sombras) { ?>     
                <a href="<?php echo $location.'?table=btn_otros_sombra&val='.$sombras['Codigo'].'&return1=otros&return2=mod'; ?>" title="<?php echo $sombras['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresFondo as $colores) { ?>     
                <a href="<?php echo $location.'?table=btn_otros_color_fondo&val='.$colores['Codigo'].'&return1=otros&return2=mod'; ?>" title="<?php echo $colores['Nombre']; ?>">
