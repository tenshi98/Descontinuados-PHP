...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_marcas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_marcas_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/vehiculos_marcas.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_marcas.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_marcas_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/vehiculos_marcas.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/vehiculos_marcas.php';
}
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la Marca</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idMarca">
...
$query = "SELECT idMarca FROM `vehiculos_marcas` ".$z."";
...
<label class="control-label col-lg-4">Buscar Marca</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Marca</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Marcas</h5>
		</header>
    ...
    <?php foreach ($arrGrupos as $grupos) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $grupos['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$grupos['idMarca']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$grupos['idMarca'];?>
