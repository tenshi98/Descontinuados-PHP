...
<a class="<?php echo $rowdata['btn_enlace_color_fondo'].' '.$rowdata['btn_enlace_ancho'].' '.$rowdata['btn_enlace_radio'].' '.$rowdata['btn_enlace_float'].' '.$rowdata['btn_enlace_color_texto'].' '.$rowdata['btn_enlace_sombra'] ?> btn_link" href="#">Enlace</a>
...
<a class="<?php echo $rowdata['btn_otros_color_fondo'].' '.$rowdata['btn_otros_ancho'].' '.$rowdata['btn_otros_radio'].' '.$rowdata['btn_otros_float'].' '.$rowdata['btn_otros_color_texto'].' '.$rowdata['btn_otros_sombra'] ?> btn_link" href="#">Otros</a>
