	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=noti_shadow&val='.$sombras['Codigo'].'&return1=mod'; ?>" title="<?php echo $sombras['Nombre']; ?>">
        ...
        <tr class="odd">
        	<td colspan="5">
            	<a href="<?php echo $location.'?table=noti_aling&val=fleft&return1=mod'; ?>"title="Izquierda" >
                	<div class="box_preview <?php if($rowdata['noti_aling']=='fleft'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-left"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=noti_aling&val=fright&return1=mod'; ?>" title="Derecha">
                	<div class="box_preview <?php if($rowdata['noti_aling']=='fright'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-right"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=noti_aling&val=fcenter&return1=mod'; ?>" title="Centro">
                	<div class="box_preview <?php if($rowdata['noti_aling']=='fcenter'){echo ' box_preview_active';} ?>">
                    	<i class="fa fa-align-center"></i>
                    </div>
                </a>
                <a href="<?php echo $location.'?table=noti_aling&val=fnone&return1=mod'; ?>" title="Ninguna">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=noti_color&val='.$interno['Codigo'].'&return1=mod'; ?>" title="<?php echo $interno['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=noti_tab_color&val='.$tabcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $tabcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=noti_tab_check&val='.$tabchecked['Codigo'].'&return1=mod'; ?>" title="<?php echo $tabchecked['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                ...
                <a href="<?php echo $location.'?table=noti_tab_hover&val='.$tabhover['Codigo'].'&return1=mod'; ?>" title="<?php echo $tabhover['Nombre']; ?>">
       ...
       <tr class="table_title">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=noti_ul_size_new&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=noti_ul_color_new&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=noti_ul_size_tittle&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=noti_ul_color_tittle&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=noti_ul_size_text&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=noti_ul_color_text&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
