 			...
 			<div class="form-group">
				...
				<div class="col-lg-8">
					<select class="form-control" name="grid_color" required>
                            ...
                            <option value="<?php echo $colorboton['Codigo'] ?>" <?php if(isset($grid_color)&&$grid_color==$colorboton['Codigo']) {echo 'selected="selected"';}elseif($colorboton['Codigo']==$row_data['grid_color']){echo 'selected="selected"';}?>><?php echo $colorboton['Nombre'] ?></option>
                            <?php } ?>       
					</select>
				</div>
			</div>
...
<?php }?>
			...
			<div class="form-group">
				...
				$location = $original;
				?>
				<a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'] ?>" class="btn btn-danger fright margin_width" data-original-title="" title="">Cancelar y Volver</a>
			</div>
 			...
 			<div class="form-group">
				...
				<div class="col-lg-8">
					<select class="form-control" name="grid_color" required>
                            <option value="">Seleccione un color</option>
                            <?php foreach ($arrColorBoton as $colorboton) { ?>
                            <option value="<?php echo $colorboton['Codigo'] ?>" <?php if(isset($grid_color)&&$grid_color==$colorboton['Codigo']) {echo 'selected="selected"';}?>><?php echo $colorboton['Nombre'] ?></option>
                            <?php } ?>       
					</select>
				</div>
			</div>
...
<a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'] ?>&newtbgrid=true" class="btn btn-default fright margin_width" >Crear Nuevo elemento</a>
</div>
...
<div class="col-lg-8">
	...
	foreach ($arrElementos as $elementos) { ?>
    	<tr class="odd">
			...
			<td class=" ">
            	<?php if($grill!=1){?> 
				<a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'].'&up_elemento='.$elementos['idElementos'].'&orden='.$elementos['Orden']; ?>" title="Subir un nivel" class="icon-up info-tooltip"></a>
            <?php } else {?>
            	<a href="#" title="Subir un nivel" class="icon-up info-tooltip"></a>
            <?php } ?> 
            <?php if($elementos['Orden']!=$row_data['Orden']){?>     
                <a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'].'&down_elemento='.$elementos['idElementos'].'&orden='.$elementos['Orden']; ?>" title="Bajar un nivel" class="icon-down info-tooltip"></a>
            <?php } else {?>
				<a href="#" title="Bajar un nivel" class="icon-down info-tooltip"></a>
			<?php } ?>
            
            
                <a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'].'&edittbgrid='.$elementos['idElementos']; ?>" title="Editar informacion" class="icon-editar info-tooltip"></a>
                <?php $ubicacion=$location.'?view='.$_GET['view'].'&viewgrilla='.$_GET['viewgrilla'].'&tipo='.$_GET['tipo'].'&del_elem='.$elementos['idElementos'];?>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_8.php?viewgrilla=<?php echo $_GET['viewgrilla'] ?>" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div> 
...
<a href="apariencia_principal_areas.php?view=<?php echo $_GET['view'] ?>" class="btn btn-danger fright margin_width" data-original-title="" title="">Volver</a>
<div class="clearfix"></div>
</div> 
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
				...
				//Verifico si existe la variable de busqueda y pagina 
				$location = $original;?>
				<a href="<?php echo $location.'?view='.$_GET['view']; ?>" class="btn btn-danger fright margin_width" data-original-title="" title="">Cancelar y Volver</a>
			</div>
...
?>
<div class="form-group" style="margin-top:15px;">
<a href="<?php echo $location; ?>?view=<?php echo $_GET['view'] ?>&new_grilla=true" class="btn btn-default fright margin_width" >Crear Nueva Grilla</a>
</div>
<div class="clearfix"></div>
<div class="col-lg-8">
	<div class="box">
	...
	foreach ($arrGrilla as $grilla) { ?>
    	<tr class="odd">
			...
			<td class=" ">
            	<a href="<?php echo $location.'?view='.$_GET['view'].'&viewgrilla='.$grilla['idArea'].'&tipo='.$grilla['Tipo']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a> 
            <?php if($grill!=1){?> 
				<a href="<?php echo $location.'?view='.$_GET['view'].'&up_grilla='.$grilla['idArea'].'&orden='.$grilla['Orden']; ?>" title="Subir un nivel" class="icon-up info-tooltip"></a>
            <?php } else {?>
            	<a href="#" title="Subir un nivel" class="icon-up info-tooltip"></a>
            <?php } ?> 
            <?php if($grilla['Orden']!=$row_data['Orden']){?>     
                <a href="<?php echo $location.'?view='.$_GET['view'].'&down_grilla='.$grilla['idArea'].'&orden='.$grilla['Orden']; ?>" title="Bajar un nivel" class="icon-down info-tooltip"></a>
            <?php } else {?>
				<a href="#" title="Bajar un nivel" class="icon-down info-tooltip"></a>
			<?php } ?>    
                <a href="<?php echo $location.'?view='.$_GET['view'].'&edit_grilla='.$grilla['idArea']; ?>" title="Editar informacion" class="icon-editar info-tooltip"></a>
                <?php $ubicacion=$location.'?view='.$_GET['view'].'&del_grilla='.$grilla['idArea'];?>
				<a onclick="msg('<?php echo $ubicacion ?>')" title="Borrar Informacion" class="icon-borrar info-tooltip"></a>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
         <iframe class="frame_border" scrolling="auto" src="app_demo/preview_8.php?view=<?php echo $_GET['view'] ?>" frameborder="0" height="480" width="320"></iframe>   
        </div>
	</div>
</div>
<div class="clearfix"></div>
<div class="col-lg-12 fcenter" style="margin-bottom:30px">
<a href="apariencia_principal_areas.php" class="btn btn-danger fright margin_width" data-original-title="" title="">Volver</a>
<div class="clearfix"></div>
</div>
...
<div class="form-group" style="margin-top:15px;">
<a href="<?php echo $location; ?>?new=true" class="btn btn-default fright margin_width" >Crear Nueva Pagina</a>
</div>
<div class="clearfix"></div>                       
