...
$original = "vehiculos_colores.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_colores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_colores_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/vehiculos_colores.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_colores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_colores_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/vehiculos_colores.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/vehiculos_colores.php';
}
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idColorV">
...
$query = "SELECT idColorV FROM `vehiculos_colores` ".$z."";
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrColores as $colores) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$colores['idColorV']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$colores['idColorV'];?>
