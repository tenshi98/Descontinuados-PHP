...
$original = "vehiculos_transmision.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_transmision.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_transmision_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/vehiculos_transmision.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/vehiculos_transmision.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/vehiculos_transmision_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/vehiculos_transmision.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/vehiculos_transmision.php';
}
...
<div id="txf_03" class="alert_sucess">  
	Tipo de Transmision Creada correctamente
...
<div id="txf_03" class="alert_sucess">  
	Tipo de Transmision Modificada correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Tipo de Transmision borrada correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion del Tipo de Transmision</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idTransmision">
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Tipo de Transmision</h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
        	<div class="form-group">
...
$query = "SELECT idTransmision FROM `vehiculos_transmision` ".$z."";
...
<label class="control-label col-lg-4">Buscar Tipo de Transmision</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Tipo de Transmision</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Tipos de Transmision</h5>
		</header>
    ...
    <?php foreach ($arrTransmision as $transmision) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $transmision['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$transmision['idTransmision']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$transmision['idTransmision'];?>
