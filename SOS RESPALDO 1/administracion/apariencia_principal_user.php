...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
    	<tr class="table_title">
            <th colspan="5">Tipos de borde</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
        ...
        <tr class="table_title">
            <th colspan="5">Tipos de Sombras</th>
        </tr>
        <tr class="odd">
        	<td colspan="5">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=usr_name_lettersize&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
              ...
              <a href="<?php echo $location.'?table=usr_name_lettercolor&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=usr_name_pat_lettersize&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=usr_name_pat_lettercolor&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrSize as $size) { ?>     
              <a href="<?php echo $location.'?table=usr_name_pat_lettersize_2&val='.$size['Codigo'].'&return1=mod'; ?>" title="<?php echo $size['Nombre']; ?>">
        ...
        <tr class="odd">
            <td colspan="5">
                <?php foreach ($arrColoresTexto as $textcolor) { ?>     
              <a href="<?php echo $location.'?table=usr_name_pat_lettercolor_2&val='.$textcolor['Codigo'].'&return1=mod'; ?>" title="<?php echo $textcolor['Nombre']; ?>">
