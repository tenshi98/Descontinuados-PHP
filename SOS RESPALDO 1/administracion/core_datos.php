	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				...
				<?php if(isset($idTheme)) {if($idTheme==$theme['idTheme']){ echo 'selected="selected"';}} elseif($rowdata['idTheme']==$theme['idTheme']){echo 'selected="selected"';}?>><?php echo $theme['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
