...
<table class="tb_map">
  ...
  <tr height="10%">
    <td width="50%">
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'] ?> btn_link" href="<?php echo $location.'&view='.$_GET['view']; ?>" >Cancelar</a>
    </td>
    <td>
    <?php 
...
<?php echo $row_data['nombre_cliente'].' '.$row_data['apellido_cliente'].' vio tu vehiculo el '.Fecha_completa_alt($row_data['fecha_vista']).' a las '.$row_data['hora_vista'] ?>
  ...
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'] ?> btn_link" href="<?php echo $location.$w.'&view_robo='.$_GET['view_robo']; ?>" >Cancelar</a>
    </td>
  </tr>
</table>
</section> 
...
<?php }?>
  ...
  $nn=0;
	  foreach ($arrVistas as $vistas) { 
		 ...
		 echo '<br />' ;
		 echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' btn_link fright btn_car" href="'.$location.$w.'&view_robo='.$_GET['view_robo'].'&view_robo_details='.$vistas['idVista'].'">Ver Detalles</a>';
  ...
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'] ?> btn_link" href="<?php echo $location; ?>" >Volver</a>
    </td>
  </tr>
</table>   
</section> 
...
<?php  if($row_data['idVehiculo']!=0&&$row_data['idVehiculo']!=''){?> 
  <tr height="10%">
    <td>
    	<a class="<?php echo $config_app['btn_otros_color_fondo'].' '.$config_app['btn_otros_ancho'].' '.$config_app['btn_otros_radio'].' '.$config_app['btn_otros_float'].' '.$config_app['btn_otros_color_texto'].' '.$config_app['btn_otros_sombra'] ?> btn_link" href="<?php echo $location.'&view='.$_GET['view'].'&vista=true&idAlerta='.$row_data['idAlerta'].'&idAsaltado='.$row_data['idCliente']; ?>" >Lo vi</a>
    </td>
  </tr>
<?php } ?> 
  <tr height="10%">
...
<section class="tabs <?php echo $config_app['noti_width'].' '.$config_app['noti_border'].' '.$config_app['noti_shadow'].' '.$config_app['noti_aling'].' '.$config_app['noti_color'].' '.$config_app['noti_tab_hover'].' '.$config_app['noti_tab_check'] ?>">
