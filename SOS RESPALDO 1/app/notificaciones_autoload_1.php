...
if ($resultado) {
	...
	echo '<a class="'.$config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'].' btn_link fright" href="notificaciones.php'.$w.'&del_noti='.$noti['idNotificacion'].'">Borrar</a>';
	
	echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' btn_link fright" href="notificaciones.php'.$w.'&view_noti='.$noti['idNotificacion'].'">Ver</a>';  
