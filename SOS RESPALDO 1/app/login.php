...
<div class="form <?php echo $config_app['form_color'] ?>"> 
 <form method="post">
  ...
  <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'] ?> btn_link" href="<?php echo $location.'&return_to1='.$root_to ?>">Cancelar</a>
...
<?php if ( $config_app['comport_register']=='1' ) {?> 
  <a class="<?php echo $config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_ancho'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_float'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'] ?> btn_link" href="<?php echo $location.'&newuser=true&return_to1='.$root_to ?>">Crear Usuario</a>
<?php } ?> 
 
<?php if ( $config_app['comport_recover']=='1' ) {?>
  <a class="<?php echo $config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_ancho'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_float'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'] ?> btn_link" href="<?php echo $location.'&recover=true&return_to1='.$root_to ?>">Recuperar contraseña</a>
<?php }?>
 
 <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'] ?> btn_link" href="<?php echo $root_to.$w.$move_to ?>">Cancelar</a> 
