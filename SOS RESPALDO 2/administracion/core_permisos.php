	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
					<select class="form-control" tabindex="15" name="visualizacion">
                            <option value="" selected="selected">Seleccione quien ve la transaccion</option>
                            <option value="SuperAdmin" <?php if(isset($visualizacion)&&$visualizacion=='SuperAdmin') {echo 'selected="selected"';}elseif($rowdata['visualizacion']=='SuperAdmin'){echo 'selected="selected"';}?>>Solo Super Administradores</option>
                            <option value="Todos" <?php if(isset($visualizacion)&&$visualizacion=='Todos') {echo 'selected="selected"';}elseif($rowdata['visualizacion']=='Todos'){echo 'selected="selected"';}?> >Todos los tipos de usuario</option>
					</select>
				</div>
			</div>
            ...
            <div class="form-group">
             ...
             <div class="form-group" >
				...
				<div class="col-lg-8">
					<select class="form-control" tabindex="15" name="visualizacion">
                            <option value="" selected="selected">Seleccione quien ve la transaccion</option>
                            <option value="SuperAdmin" <?php if(isset($visualizacion)&&$visualizacion=='SuperAdmin') {echo 'selected="selected"';}?>>Solo Super Administradores</option>
                            <option value="Todos" <?php if(isset($visualizacion)&&$visualizacion=='Todos') {echo 'selected="selected"';}?> >Todos los tipos de usuario</option>
					</select>
				</div>
			</div>
...
echo '<tr class="odd" ><td colspan="5"  style="background-color:#DDD">'.$categoria.'</td></tr>';
  ...
  <tr class="odd"> 
   ...
   <td><?php echo $subcategorias['visualizacion']; ?></td>
