...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
    	...
    	<tr class="odd">
			<td class=" ">Enlace</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&enlace=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Aceptar</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&aceptar=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Cancelar</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&cancelar=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Otros</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&otros=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
