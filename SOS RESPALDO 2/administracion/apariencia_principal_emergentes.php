...
<div class="col-lg-8">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
    	...
    	<tr class="odd">
			...
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&error=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Mensajes de alerta</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&alert=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Mensajes de exito</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&success=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
        <tr class="odd">
			<td class=" ">Mensajes de informacion</td>
			<td class=" "><a href="<?php echo $location.'?app_conf='.$_GET['app_conf'].'&info=true' ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a></td>
		</tr>
