...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_fonos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_fonos_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_fonos.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_fonos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_fonos_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_fonos.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_fonos.php';
}
...
$query = "SELECT idFono FROM `mnt_fonos` ".$z."";
...
$arrFonos = array();
$query = "SELECT idFono,Nombre, Fono
FROM `mnt_fonos`
".$z."
ORDER BY Nombre ASC
...
<label class="control-label col-lg-4">Buscar Contacto</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Contacto</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrFonos as $fonos) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $fonos['idFono']; ?></td>
			<td class=" "><?php echo $fonos['Nombre']; ?></td>
            <td class=" "><?php echo $fonos['Fono']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$fonos['idFono']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$fonos['idFono'];?>
