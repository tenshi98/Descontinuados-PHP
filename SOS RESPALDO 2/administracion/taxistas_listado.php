...
$query = "SELECT   email, Nombre, Apellido_Paterno, Apellido_Materno, Sexo , Rut, fNacimiento, Direccion, Fono1, Fono2, idCiudad, idComuna
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Tipo Cliente : </strong><?php echo $rowdata['tipo']; ?></p>
