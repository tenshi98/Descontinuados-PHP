...
$query = "SELECT Nombre, imgLogo, email_principal, RazonSocial, Rut, Direccion, Fono, Ciudad, Comuna
FROM `clientes_tipos`
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Logo</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre del Logo de la empresa" class="form-control" value="<?php if(isset($imgLogo)) {echo $imgLogo;} else {echo $rowdata['imgLogo'];}?>"  name="imgLogo" required >
				</div>
			</div>
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Logo</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre del Logo de la empresa" class="form-control"  name="imgLogo" <?php if(isset($imgLogo)) {echo 'value="'.$imgLogo.'"';}?> required>
				</div>
			</div>
