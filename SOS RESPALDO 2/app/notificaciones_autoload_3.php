...
echo '<table>';
  echo '<tr height="32px">';
    echo '<td width="70%"></td>'; 
    echo '<td width="30%">';
    echo '<a class="'.$config_app['noti_btn_acept_bgcolor'].' '.$config_app['noti_btn_acept_textcolor'].' '.$config_app['noti_btn_acept_textsize'].' btn_link"  href="notificaciones.php'.$w.'&view_robo='.$noti['idRobo'].'">';
