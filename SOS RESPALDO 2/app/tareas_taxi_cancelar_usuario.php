...
/**********************************************************************************************************************************/
$query  = "UPDATE `solicitud_taxi_listado` SET Estado='42' WHERE idSolicitud = '{$_GET['idSolicitud']}'";
...
// Se arma el mensaje
$msj =  $row_datos['Nombre'].' '. $row_datos['Apellido_Paterno'].' ha cancelado la solicitud';
