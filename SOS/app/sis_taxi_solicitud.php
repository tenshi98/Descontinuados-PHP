...
<table class="tb_map">
  <tr height="10%">
    <td colspan="2">
    <h1 class="<?php echo $config_app['title1_size'].' '.$config_app['title1_color'] ?>" style="margin-top:10px;">Trabajo Finalizado</h1>
    </td>
  </tr>	
  <tr height="80%">
    <td colspan="2">
    <div class="alert fcenter <?php echo $config_app['msg_info_color_body'].' '.$config_app['msg_info_color_text'].' '.$config_app['msg_info_width'].' '.$config_app['msg_info_border'].' '.$config_app['msg_info_border_color'] ?>">
    <i class="fa fa-info"></i>
    <p class="long_txt">A Continuación puede Calificar al Taxista y/o solo Finalizar.</p>
    </div>
...
<table class="tb_map">
  <tr height="10%">
    ...
    <h1 class="<?php echo $config_app['title2_size'].' '.$config_app['title2_color'] ?>" style="margin-top:10px;">Conductor : <?php echo $row_datos['Nombre'].' '.$row_datos['Apellido_Paterno'] ?></h1>
    </td>
  </tr>	
...
<table class="tb_map">
  ...
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'].' '.$config_app['btn_cancelar_border'] ?> btn_link" href="<?php echo $location.'&cancelcarrera='.$_GET['idSolicitud'].'&idTipoAlerta='.$_GET['idTipoAlerta']; ?>" >Cancelar Carrera</a>
    </td>
   </tr> 
</table>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<table class="tb_map">	
  <tr height="30%">
    ...
    <div class="alert fcenter <?php echo $config_app['msg_info_color_body'].' '.$config_app['msg_info_color_text'].' '.$config_app['msg_info_width'].' '.$config_app['msg_info_border'].' '.$config_app['msg_info_border_color'] ?>">
    <i class="fa fa-info"></i>
    <p class="long_txt">Buscando Taxistas Disponibles.</p>
    </div>
    </td>
  </tr>
