...
<table class="tb_map">
  <tr height="10%">
    <td colspan="2">
    <h1 class="<?php echo $config_app['title1_size'].' '.$config_app['title1_color'] ?>" style="margin-top:10px;">Pasajero Ausente</h1>
    <h1 class="<?php echo $config_app['title3_size'].' '.$config_app['title3_color'] ?>" >A continuación puede calificar al pasajero.</h1>
    </td>
  </tr>	
  <tr height="80%">
    <td colspan="2">
...
<table class="tb_map">
  <tr height="10%">
    <td colspan="2">
    <h1 class="<?php echo $config_app['title1_size'].' '.$config_app['title1_color'] ?>" style="margin-top:10px;">Carrera Finalizada</h1>
    <h1 class="<?php echo $config_app['title3_size'].' '.$config_app['title3_color'] ?>" >A continuación puede calificar al cliente si lo desea.</h1>
    </td>
  </tr>	
  <tr height="80%">
    <td colspan="2">
...
<table class="tb_map">
  <tr height="10%">
    ...
    <h1 class="<?php echo $config_app['title2_size'].' '.$config_app['title2_color'] ?>" style="margin-top:10px;">Pasajero : <?php echo $row_datos['Nombre'].' '.$row_datos['Apellido_Paterno'] ?></h1>
    </td>
  </tr>	
  ...
  <tr height="20%">
   ...
   <tr height="60%">
    <td colspan="2">
	<h1 class="<?php echo $config_app['title2_size'].' '.$config_app['title2_color'] ?>" style="margin-top:10px;">Tiempo de Viaje</h1>
    </td>
  </tr>	 
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_aceptar_color_fondo'].' '.$config_app['btn_aceptar_ancho'].' '.$config_app['btn_aceptar_radio'].' '.$config_app['btn_aceptar_float'].' '.$config_app['btn_aceptar_color_texto'].' '.$config_app['btn_aceptar_sombra'].' '.$config_app['btn_aceptar_border']  ?> btn_link" href="<?php echo $location.'&termviaje=true&idSolicitud='.$_GET['idSolicitud']; ?>" >Pasajero en Destino</a> 
    </td>
  </tr>
</table>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<table class="tb_map">
  <tr height="10%">
    <td colspan="2">
    <h1 class="<?php echo $config_app['title1_size'].' '.$config_app['title1_color'] ?>" style="margin-top:10px;">En Ruta</h1>
    <h1 class="<?php echo $config_app['title3_size'].' '.$config_app['title3_color'] ?>" >Recogiendo a <?php echo $row_datos['Nombre'].' '.$row_datos['Apellido_Paterno']; ?></h1>
    </td>
  </tr>	
  ...
  <tr height="10%">
   ...
   <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'].' '.$config_app['btn_cancelar_border'] ?> btn_link" href="<?php echo $location.'&pasajeroinex='.$_GET['idSolicitud']; ?>" >Pasajero Ausente</a>
    </td>
   </tr>
    
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_aceptar_color_fondo'].' '.$config_app['btn_aceptar_ancho'].' '.$config_app['btn_aceptar_radio'].' '.$config_app['btn_aceptar_float'].' '.$config_app['btn_aceptar_color_texto'].' '.$config_app['btn_aceptar_sombra'].' '.$config_app['btn_aceptar_border']  ?> btn_link" href="<?php echo $location.'&pasajero=true&idSolicitud='.$_GET['idSolicitud']; ?>" >Confirmar Pasajero Abordo</a> 
    </td>
  </tr>
</table>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<table class="tb_map">
  ...
  <tr height="80%">
    ...
    <h2>Para Recoger al Pasajero</h2>
      <div class="input"><label id="icon" for="name"><i class="fa fa-anchor"></i></label>      
        <select name="minutos">
...
<script type="text/javascript">
      function initialize() {
		  ...
		  marker.setIcon('img/map_pass.png');	
      }  
</script>
...
<table class="tb_map">
  <tr height="10%">
    <td colspan="2"><img src="img/logo_taxi.png" width="100%"  /></td>
  </tr>	
  <tr height="70%">
    <td colspan="2">
     ...
     <table class="tb_user">
        <tr>
            <td> 
                <div class="cover"> 
				<img src="<?php if($arrCliente['Url_imagen']!=''){ echo $arrCliente['Url_imagen'];}else{echo 'img/avatar.jpg';} ?>" class="<?php echo $config_app['usr_img_border'].' '.$config_app['usr_img_border_radius'].' '.$config_app['usr_img_shadow'].' '.$config_app['usr_img_width'] ?>" /> 
