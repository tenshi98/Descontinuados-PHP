...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Ancho creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Ancho editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Ancho borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrAncho as $ancho) { ?>
    	<tr class="odd">		
			<td><?php echo $ancho['Nombre']; ?></td>
            <td><?php echo $ancho['Codigo']; ?></td>		
			<td>  
