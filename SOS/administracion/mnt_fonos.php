...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = '';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/mnt_fonos.php';
}
...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Contacto editado correctamente';}
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" name="idFono" value="<?php echo $_GET['id']; ?>" >
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrFonos as $fonos) { ?>
    	<tr class="odd">
			<td><?php echo $fonos['idFono']; ?></td>
			<td><?php echo $fonos['Nombre']; ?></td>
