...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/app_tipo_boton.php';
}
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Tipo Boton creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Tipo Boton editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Tipo Boton borrado correctamente';}
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post">
				...
				if(isset($Archivo)) {   $x2  = $Archivo;       }else{$x2  = $rowdata['Archivo'];}
				if(isset($fun)) {       $x3  = $fun;           }else{$x3  = $rowdata['fun'];}
				
				//se dibujan los inputs
				echo form_input('text', 'Nombre', 'Nombre', $x1, 2);
				echo form_input('text', 'Archivo', 'Archivo', $x2, 2);
				echo form_select('Funcion del boton','fun', $x3, 2, 'idFuncion', 'Nombre', 'app_funcion_boton', 0, $dbConn);					 
				?>  

				<div class="form-group">
					<input type="hidden" name="idTipoBoton" value="<?php echo $_GET['id']; ?>"  >
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post">
				...
				if(isset($Archivo)) {   $x2  = $Archivo;       }else{$x2  = '';}
				if(isset($fun)) {       $x3  = $fun;           }else{$x3  = '';}
...
//Creo la variable con la ubicacion
	$z="WHERE app_tipo_boton.idTipoBoton!=0 ";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z .=" AND app_tipo_boton.Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT app_tipo_boton.idTipoBoton FROM `app_tipo_boton` ".$z."";
...
$arrTipoBoton = array();
$query = "SELECT 
app_tipo_boton.idTipoBoton,
app_tipo_boton.Nombre, 
app_tipo_boton.Archivo, 
app_funcion_boton.Nombre AS fun
FROM `app_tipo_boton`
LEFT JOIN `app_funcion_boton` ON app_funcion_boton.idFuncion = app_tipo_boton.fun
".$z."
ORDER BY Nombre ASC
	...
	<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
		...
		<?php foreach ($arrTipoBoton as $tipo) { ?>
			<tr class="odd">
				...
				<td><?php echo $tipo['Archivo']; ?></td>
				<td><?php echo $tipo['fun']; ?></td>
				<td>
