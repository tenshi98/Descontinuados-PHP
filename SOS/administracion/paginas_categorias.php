...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = '';
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/paginas_categorias.php';
}
...
$query = "SELECT idPagCat, idPagGrupo, Nombre, idTipoCliente
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			if(isset($idPagGrupo)) {     $x1  = $idPagGrupo;     }else{$x1  = $rowdata['idPagGrupo'];}
			if(isset($Nombre)) {         $x2  = $Nombre;         }else{$x2  = $rowdata['Nombre'];}
			if(isset($idTipoCliente)) {  $x3  = $idTipoCliente;  }else{$x3  = $rowdata['idTipoCliente'];}

			//se dibujan los inputs
			echo form_select('Grupos','idPagGrupo', $x1, 2, 'idPagGrupo', 'Nombre', 'paginas_grupos', $zz, $dbConn);
			...
			<div class="form-group">
            	<input type="hidden" name="idPagCat" value="<?php echo $_GET['id']; ?>" >
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <?php 
			//Se verifican si existen los datos
			if(isset($idPagGrupo)) {     $x1  = $idPagGrupo;     }else{$x1  = '';}
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE paginas_categorias.idTipoCliente>=0";	
}else{
	$z="WHERE paginas_categorias.idTipoCliente={$arrUsuario['idTipoCliente']}";	
}
...
LEFT JOIN `clientes_tipos`        ON clientes_tipos.idTipoCliente      = paginas_categorias.idTipoCliente
".$z."
