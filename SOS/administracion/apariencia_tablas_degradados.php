...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Degradado creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Degradado editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Degradado borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">		
			<td><?php echo $degradado['Nombre']; ?></td>
			<td><?php echo $degradado['Codigo']; ?></td>		
			<td>  
