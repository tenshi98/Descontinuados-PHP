...
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color Fondo Activado correctamente';}
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Color de Fondo</h5>	
	</header>
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		<tr class="odd">
			<td class=" ">
				...
				<a href="<?php echo $location.'?table=background_color&val='.$colores['Codigo'].'&return1=mod&app_conf='.$_GET['app_conf']; ?>">
				<div class="box_preview <?php echo $colores['Codigo']; ?><?php if($colores['Codigo']==$rowdata['background_color']){echo ' box_preview_active';} ?>"></div>
				</a>
				<?php } ?>
			</td>
		</tr>                   
...
<div class="col-lg-4">
	<div class="box">	
		...
		<div class="body">
			<iframe class="frame_border" scrolling="auto" src="app_demo/preview_1.php?app_conf=<?php echo $_GET['app_conf'] ?>" frameborder="0" height="480" width="320"></iframe>
		</div>
	</div>
</div>
