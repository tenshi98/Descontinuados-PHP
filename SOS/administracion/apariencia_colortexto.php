...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Color de texto creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color de texto editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Color de texto borrado correctamente';}
