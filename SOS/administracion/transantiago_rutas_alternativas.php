...
$original = "transantiago_rutas_alternativas.php";
$location = $original;
...
if(isset($_GET['Fecha']) && $_GET['Fecha'] != ''){               $location .= "&Fecha=".$_GET['Fecha'] ; }
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'idRecorrido,idRuta,Fecha,HoraInicio,HoraTermino,Nombre';
...
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$location.='&id='.$_GET['id'];
	$form_obligatorios = 'idRutaAlt,idEstado,idRecorrido,idRuta,Fecha,HoraInicio,HoraTermino,Nombre';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/transantiago_rutas_multi.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Ruta Alternativa creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Ruta Alternativa editada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Ruta Alternativa borrada correctamente';}
...
<div class="col-lg-4 fleft">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos de Ruta Alternativa</h5>
		</header>
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nueva Ruta Alternativa</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
...
$z="WHERE transantiago_rutas_multi.idTipo = 1";	
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Ruta Alt</a><?php }?>
</div>
<div class="clearfix"></div>                     
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Rutas Alternativas</h5>
		</header>
    ...
    <?php foreach ($arrRutas as $rutas) { ?>
    	<tr class="odd">
			<td><?php echo $rutas['Fecha'].' - '.$rutas['HoraInicio'].' a '.$rutas['HoraTermino']; ?></td>
