...
$original = "transantiago_puntos_control.php";
$location = $original;
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Punto de Control creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Punto de Control editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Punto de Control borrado correctamente';}
...
<div class="col-lg-4 fleft">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Punto de Control</h5>
		</header>
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Punto de Control</h5>
		</header>
		<div id="div-1" class="body">
			<form class="form-horizontal" method="post" name="form1">
...
$z="WHERE transantiago_rutas_multi.idTipo = 3";		
