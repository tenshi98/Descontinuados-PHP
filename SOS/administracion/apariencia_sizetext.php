...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Tamaño de texto creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Tamaño de texto editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Tamaño de texto borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">		
			<td><?php echo $size['Nombre']; ?></td>
			<td><?php echo $size['Codigo']; ?></td>
			<td><div class="preview"><p class="<?php echo $size['Codigo']; ?>">Texto</p></div></td>		
			<td>  
