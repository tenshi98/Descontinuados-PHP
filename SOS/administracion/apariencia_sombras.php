...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Sombra Creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Sombra Modificada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Sombra borrada correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">		
			...
			<td><div class="preview <?php echo $colores['Codigo']; ?>"></div></td>		
			<td>  
