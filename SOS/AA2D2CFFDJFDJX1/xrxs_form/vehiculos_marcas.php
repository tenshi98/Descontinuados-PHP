...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if(isset($Nombre)){
				$sql_usuario = mysql_query("SELECT Nombre FROM vehiculos_marcas WHERE Nombre='".$Nombre."' "); 
			...
			if ( empty($error) ) {
				...
				$query  = "INSERT INTO `vehiculos_marcas` (Nombre) VALUES ({$a} )";
...
/*******************************************************************************************************************/		
		case 'update':	
			...
			if ( empty($error) ) {
				...
				// inserto los datos de registro en la db
				$query  = "UPDATE `vehiculos_marcas` SET ".$a." WHERE idMarca = '$idMarca'";
				$result = mysql_query($query, $dbConn);
...
/*******************************************************************************************************************/
		case 'del':	
			...
			$query  = "DELETE FROM `vehiculos_marcas` WHERE idMarca = {$_GET['del']}";
			$result = mysql_query($query, $dbConn);	
