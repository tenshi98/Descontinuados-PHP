...
//Validaciones de ingreso de datos obligatorios
	...
	if(isset($Nombre)){
		$sql_nombre = mysql_query("SELECT Nombre FROM vehiculos_modelos WHERE Nombre='".$Nombre."' AND idMarca='".$idMarca."'  "); 
	...
	<div id="txf_02" class="alert_error">  
	  	No ha ingresado un nombre para el modelo
