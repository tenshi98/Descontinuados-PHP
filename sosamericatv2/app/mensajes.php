...
<table class="table_msg">
  ...
  <tr>
    <td ><b><?=$rowusr["nombre"]?></b>, te damos la bienvenida a <b>SOSCLICK</b> y te recordamos que para el uso de nuestro sistema, debes utilizar el menu de tu dispositivo, ah&iacute; encontrar&aacute;s los siguientes Item:</td>
  </tr>
    <tr>
    <td >&nbsp;</td>
  </tr>
