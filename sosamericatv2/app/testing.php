...
//$apiKey = "AIzaSyDFhf6LAgWuYWVeQiluJ6qH-IA3_1ZSNSU";
// MENSAJES GCM FIJOS
...
if ($sms1!='0') {
	$sms=$sms1;
	$sql = "SELECT login,gcmcode, dispositivo,imei FROM ejecutivos WHERE gcmcode<>'' and fono_ejecutiv='09" . $sms . "' LIMIT 1";
	echo $apiKey."<br>"."   ".$sql."<br>";
	$result = mysql_query($sql,$base);
