...
$messageText = $nombre.", Ha generado una alerta de Seguridad, comunicate con el al +519".$telefono;
...
<script type="text/javascript">
window.onload=function(){MainActivity.getFromWebView6()};
</script>
<?php }else{?>
<style>
...
<div class="success">Operacion realizada con exito</div>
<a href="http://<?=$nombreurl?>/app/gracias_cel_01.php?longitud=<?=$_GET["longitud"]?>&latitud=<?=$_GET["latitud"]?>&imei=<?=$_GET["imei"]?>" class="myButton">Volver</a>
