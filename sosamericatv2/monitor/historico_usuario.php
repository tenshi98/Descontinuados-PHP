...
$sql2="SELECT * FROM activaciones where id_usuario=".$usuario." order by id_sms desc LIMIT 0, 10"; 
...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="581" rowspan="4" align="center" valign="middle">
        ...
        <span class="google_fjalla_gde">Hist&oacute;rico por Usuario(<?=$ejecutivo?>)</span>
	</td></tr>
</table> 
