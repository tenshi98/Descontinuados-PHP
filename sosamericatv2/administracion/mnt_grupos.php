...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_grupos_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_grupos.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_grupos_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_grupos.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_grupos.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion de Grupos</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion de Grupos
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idFono">
...
$query = "SELECT idGrupo FROM `mnt_grupos` ".$z."";
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrGrupos as $grupos) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $grupos['idGrupo']; ?></td>
			<td class=" "><?php echo $grupos['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$grupos['idGrupo']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$grupos['idGrupo'];?>
