      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Reporte por Mensaje
...
<thead>
 <tr class="tbl_title">
                ...
                <th width="17%"  align="left" height="40">Edad</th>
                <th width="17%"  align="left" height="40">Ciudad</th>
				<th width="17%"  align="left" height="40">Ubicacion</th>
				<th width="15%"  align="left" height="40">informacion</th>
              </tr>
<?$contador=0;
$contador_gral=0;
...
$gral22=mysql_query($sql2,$dbConn); 
...
<tbody role="alert" aria-live="polite" aria-relevant="all">
 <tr class="odd">
                ...
                <td width="17%"  align="left" height="40" class=" "><?=$ano?></td>
                <td width="17%"  align="left" height="40" class=" "><?=$ciudad?></td>
<td width="17%"  align="center" height="40" class=" " >
<?if ($lon<>0) {?>
<input type=image src="../images/mytracks_icon.png" onclick="window.open('mapa_mensajes.php?lon=<?=$lon?>&lat=<?=$lat?>', 'Consulta', 'width=950,height=650,scrollbars=1'); return false;" width=35/>

<?}?></td>
<td width="17%"  align="center" height="40" class=" " >
<?if ($lon<>0) {?>
<input type=image src="../images/informado.png" onclick="window.open('detalle_rut2.php?rutpersona=<?=$rut?>', 'Consulta', 'width=1050,height=700,scrollbars=1'); return false;" />
<?}?></td>
              </tr>
