...
//Validaciones de ingreso de datos obligatorios
	...
	//Se valida el ingreso del email
	if ( empty($email) )   $errors[3] 	  = '
	<div class="alert alert-danger alert-dismissable" id="txf_03">
		...
		<p class="long_txt"><b>Alerta!</b> Ingrese un correo.</p>
	</div>';
