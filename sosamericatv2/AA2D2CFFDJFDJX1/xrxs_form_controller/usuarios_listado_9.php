...
// se verifica si el usuario ya existe
	...
	$sql_usuario = mysql_query("SELECT usuario FROM usuarios_listado WHERE usuario='".$usuario."' AND mode='3'"); 
	// se verifica si el correo ya existe
    $email 	= $_POST['email'];
	$sql_email = mysql_query("SELECT email FROM usuarios_listado WHERE email='".$email."' AND mode='3'");
