...
$query = "select email from usuarios_listado where email='".$email."' AND mode='1'";
...
if ( !isset($errors[1]) && !isset($errors[2])   ) {
		...
		$query  = "UPDATE `usuarios_listado` SET password='".$nueva_clave."' WHERE email='".$email."' AND mode='1' ";
