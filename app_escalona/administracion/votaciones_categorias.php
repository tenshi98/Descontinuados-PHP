...
$original = "votaciones_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/preguntas_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/preguntas_categorias_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/preguntas_categorias.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/preguntas_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/preguntas_categorias_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/preguntas_categorias.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/preguntas_categorias.php';
}
...
<?php }?>
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idCategorias">
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE preguntas_categorias.idTipoCliente>=0";	
}else{
	$z="WHERE preguntas_categorias.idTipoCliente={$arrUsuario['idTipoCliente']}";	
}
...
$query = "SELECT idCategorias FROM `preguntas_categorias` ".$z."";
...
$arrCategorias = array();
$query = "SELECT 
preguntas_categorias.idCategorias, 
preguntas_categorias.Nombre,
clientes_tipos.RazonSocial AS sistema
FROM `preguntas_categorias`
LEFT JOIN `clientes_tipos`        ON clientes_tipos.idTipoCliente    = preguntas_categorias.idTipoCliente
".$z."
ORDER BY Nombre ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCategorias as $cat) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $cat['Nombre']; ?></td>
            <td class=" "><?php echo $cat['sistema']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$cat['idCategorias']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$cat['idCategorias'];?>
