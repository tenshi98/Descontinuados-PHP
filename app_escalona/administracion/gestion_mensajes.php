	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <textarea name="Mensaje" id="autosize" class="form-control" style="overflow: auto; word-wrap: break-word; resize: horizontal; height: 320px;"  ><?php if(isset($Mensaje)) {echo $Mensaje;} ?></textarea>
                </div>
            </div> 
