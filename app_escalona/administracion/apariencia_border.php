...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Borde creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Borde editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Borde borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrBorde as $borde) { ?>
    	<tr class="odd">		
			<td><?php echo $borde['Nombre']; ?></td>
            <td><?php echo $borde['Codigo']; ?></td>
            <td><div class="preview <?php echo $borde['Codigo']; ?>"></div></td>		
			<td>  
