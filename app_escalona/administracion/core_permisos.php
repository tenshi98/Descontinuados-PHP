...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/core_permisos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/core_permisos_2.php';
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			<div class="form-group">
                ...
                <option value="<?php echo $categorias['id_pmcat']; ?>" <?php if(isset($id_pmcat)) {if($id_pmcat==$categorias['id_pmcat']){ echo 'selected="selected"';}} elseif($rowdata['id_pmcat']==$categorias['id_pmcat']){echo 'selected="selected"';}?>  ><?php echo $categorias['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Visualizacion</label>
				<div class="col-lg-8">
                    <select name="visualizacion" class="form-control"  >
                    <option value="" selected="selected">Seleccione quien ve la transaccion</option>
                    <option value="9998" <?php if(isset($visualizacion)&&$visualizacion==9998) {echo 'selected="selected"';}elseif($rowdata['visualizacion']==9998) {echo 'selected="selected"';} ?>>Todos</option>
                    <option value="9999" <?php if(isset($visualizacion)&&$visualizacion==9999) {echo 'selected="selected"';}elseif($rowdata['visualizacion']==9999) {echo 'selected="selected"';} ?>>Solo Superadministradores</option>
                    <?php foreach ($arrTipoCliente as $tipo) { ?>                  
                    <option value="<?php echo $tipo['idTipoCliente']; ?>" <?php if(isset($visualizacion)&&$visualizacion==$tipo['idTipoCliente']) {echo 'selected="selected"';}elseif($rowdata['visualizacion']==$tipo['idTipoCliente']) {echo 'selected="selected"';} ?>><?php echo $tipo['Nombre']; ?></option> 
                    <?php } ?>             
                    </select>
				</div>
			</div>
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    <select name="visualizacion" class="form-control"  >
                    <option value="" selected="selected">Seleccione quien ve la transaccion</option>
                    <option value="9998" <?php if(isset($visualizacion)&&$visualizacion==9998) {echo 'selected="selected"';}?>>Todos</option>
                    <option value="9999" <?php if(isset($visualizacion)&&$visualizacion==9999) {echo 'selected="selected"';}?>>Solo Superadministradores</option>
                    <?php foreach ($arrTipoCliente as $tipo) { ?>
                    <option value="<?php echo $tipo['idTipoCliente']; ?>" <?php if(isset($visualizacion)&&$visualizacion==$tipo['idTipoCliente']) {echo 'selected="selected"';} ?>><?php echo $tipo['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
...
//Creo la variable con la ubicacion
	$z="WHERE core_permisos.mode='".neomode."' ";
