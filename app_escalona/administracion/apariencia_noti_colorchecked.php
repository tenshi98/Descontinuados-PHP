...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Color creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Color editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Color borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrAncho as $ancho) { ?>
    	<tr class="odd">		
            ...
            <td><div class="preview <?php echo $ancho['Codigo']; ?>"></div></td>		
			<td>  
