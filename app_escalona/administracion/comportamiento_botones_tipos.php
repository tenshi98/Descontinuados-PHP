...
<option value="12" <?php if(isset($fun)&&$fun==12) {echo 'selected="selected"';}elseif($rowdata['fun']==12){echo 'selected="selected"';}?>>Abrir Una Categoria Pregunta</option>
<option value="13" <?php if(isset($fun)&&$fun==13) {echo 'selected="selected"';}elseif($rowdata['fun']==13){echo 'selected="selected"';}?>>Abrir Una Pregunta</option>
                </select>
                </div>
            </div>
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <select name="fun" class="form-control" required>
                    ...
                    <option value="12" <?php if(isset($fun)&&$fun==12) {echo 'selected="selected"';}?>>Abrir Una Categoria Pregunta</option>
					<option value="13" <?php if(isset($fun)&&$fun==13) {echo 'selected="selected"';}?>>Abrir Una Pregunta</option>
                </select>
                </div>
            </div>
    ...
    <?php foreach ($arrTipoBoton as $tipo) { ?>
    	<tr class="odd">
			...
			switch ($tipo['fun']) {
				...
				case 12: echo "Abrir Una Categoria Pregunta"; break;
				case 13: echo "Abrir Una Pregunta"; break;
