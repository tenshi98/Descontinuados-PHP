...
if ( !empty($_POST['submit_login']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/usuario_login_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_trans/usuario_login.php';
}
//formulario para recuperar contraseña
if ( !empty($_POST['submit_pass']) )  { 
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/usuario_getpass.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/usuario_getpass_1.php';
  ...
  <body class="login">
    ...
    <?php if (isset($_GET['recover'])) {
      ...
      <div class="text-center">
        <img src="img/logo_default.png" alt="logo" width="350">
      </div>
