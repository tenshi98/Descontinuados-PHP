...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Separador creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Separador editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Separador borrado correctamente';}
