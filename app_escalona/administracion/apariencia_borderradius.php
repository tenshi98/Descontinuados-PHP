...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Borde redondeado creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Borde redondeado editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Borde redondeado borrado correctamente';}
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrBorde as $bordes) { ?>
    	<tr class="odd">		
			<td><?php echo $bordes['Nombre']; ?></td>
            <td><?php echo $bordes['Codigo']; ?></td>
            <td><div class="preview <?php echo $bordes['Codigo']; ?>"></div></td>		
			<td>  
