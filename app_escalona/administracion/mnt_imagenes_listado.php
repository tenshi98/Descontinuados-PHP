...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_trans/mnt_imagenes_listado.php';
}
...
if ( !empty($_POST['submit_edit_normal']) )  { 
	...
	$location.='&mod=true';
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_imagenes_listado.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_imagenes_listado_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_imagenes_listado.php';
}
//formulario para editar usuario
if ( !empty($_POST['submit_edit_img']) )  { 
	...
	$location.='&mod=true';
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_trans/mnt_imagenes_listado_3.php';
}
//se borra una imagen
if ( !empty($_GET['del_img']) )     {
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_trans/mnt_imagenes_listado_2.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	$location.='&delete=true';
	//Llamamos al formulario de borrado
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_imagenes_listado.php';
}
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    <select name="idCatimg" class="form-control" required >
                    <option value="" selected="selected">Seleccione una Categoria</option>
                    <?php foreach ($arrCategorias as $cat) { ?>
                    <option value="<?php echo $cat['idCatimg']; ?>" <?php if(isset($idCatimg)&&$idCatimg==$cat['idCatimg']) {echo 'selected="selected"';}elseif($cat['idCatimg']==$rowdata['idCatimg']){echo 'selected="selected"'; }?>><?php echo $cat['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
            ...
            <?php if(isset($rowdata['file'])&&$rowdata['file']!=''){?>
             ...
             <div class="col-lg-2 fcenter" >
              <img src="img_upload/<?php echo $rowdata['file'] ?>" width="100%" > 
             </div>
                 <?php
            ...
            <?php }else{?>
				...
				<div class="col-lg-8">
                    ...
                    <div class="fileUpload btn btn-primary">
                        ...
                        <input id="uploadBtn" type="file" class="upload" name="archivo" />
                    </div>
				</div>
			</div>
		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data" >
            ...
            <div class="form-group">
             ...
             <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Nombre</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre" class="form-control" value="<?php if(isset($Nombre)) {echo $Nombre;}?>"  name="Nombre" required>
				</div>
			</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrImagenes as $imagenes) { ?>
    	<tr class="odd">
            ...
            <td class=" "><img src="img_upload/<?php echo $imagenes['nombre_archivo']; ?>" width="35"></td>
			<td class=" ">
