...
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idCliente,Fono1,Rut';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/clientes_listado.php';
}
//se borra un dato
...
$query = "SELECT   email, Nombre, Apellido_Paterno, Apellido_Materno, Sexo , Rut, fNacimiento, Fono1, Fono2, idTipoCliente
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			echo form_input('text', 'Email', 'email', $x7, 1);
			echo form_input('text', 'Rut', 'Rut', $x8, 2);
			echo form_date('F Nacimiento','fNacimiento', $x9, 1);
			if($arrUsuario['tipo']=='SuperAdmin'){
			echo form_select('Sistema','idTipoCliente', $x13, 1, 'idTipoCliente', 'Nombre', 'clientes_tipos', 0, $dbConn);
			}else{
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Apoderado</a><?php }?>
</div>
