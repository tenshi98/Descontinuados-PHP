...
$original = "votaciones_listado.php";
$location = $original;
...
if (isset($_GET['created']))    {$error['usuario'] 	  = 'sucess/Lista Creada correctamente';}
if (isset($_GET['edited']))     {$error['usuario'] 	  = 'sucess/Lista Modificada correctamente';}
if (isset($_GET['deleted']))    {$error['usuario'] 	  = 'sucess/Lista borrada correctamente';}
if (isset($_GET['addresp']))    {$error['usuario'] 	  = 'sucess/Postulante creada correctamente';}
if (isset($_GET['editresp']))   {$error['usuario'] 	  = 'sucess/Postulante editada correctamente';}
if (isset($_GET['deleteresp'])) {$error['usuario'] 	  = 'sucess/Postulante borrada correctamente';}
        ...
        var data = google.visualization.arrayToDataTable([
          ['Respuestas', 'Votos']
			<?php foreach ($arrPregunta as $pregunta) { ?>
				,['<?php echo $pregunta['Respuesta']; ?>',     <?php echo $pregunta['suma']; ?>]
			<?php } ?>
        ]);
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion del Postulante</h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
			<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Postulante</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Postulante" class="form-control" value="<?php if(isset($Respuesta)) {echo $Respuesta;} else {echo $rowdata['Respuesta'];}?>"  name="Respuesta" required>
				</div>
			</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
            	<label for="text2" class="control-label col-lg-4">Nombre Lista</label>
                <div class="col-lg-8">
...
<?php }?>
			...
			<div class="form-group">
				...
				<input type="submit" id="text2"  class="btn btn-primary fright margin_width" value="Guardar Lista" name="submit_edit"> 
			</div>       
			</form>         
		</div>
	</div>
		...
		<div class="body">
			<form class="form-inline" method="post">
				<div class="form-group col-lg-10">
					<input type="text" class="form-control width100"  placeholder="Postulante" name="Respuesta">
				</div>
				<div class="form-group  col-lg-2">
                	<input type="hidden" name="idPregunta" value="<?php echo $_GET['id']; ?>">
                    <input type="submit"  class="btn btn-primary fright margin_width" value="Guardar Postulante" name="submit_resp">
				</div>
				<div class="clearfix"></div>
			</form>
		</div>
...
<div class="form-group">
<form class="form-horizontal" action="<?php echo $location ?>"  name="form1">
<label class="control-label col-lg-4">Buscar Lista</label>
    <div class="col-lg-5">
		<div class="input-group bootstrap-timepicker">
        	<input type="hidden" name="pagina" value="<?php echo $_GET['pagina']; ?>" >
...
//No crera mas preguntas si ya existe una pendiente	
	if ($rowpregunta>0){?>
        <a href="#" class="btn btn-default disabled fright margin_width" >Crear Nueva Lista</a>
    <?php }else{?>
        <a href="<?php echo $location; ?>&new=<?php echo $arrUsuario['idUsuario'] ?>" class="btn btn-default fright margin_width" >Crear Nueva Lista</a>
    <?php }?>
...
<?php 
//Solo mostrar la creacion de respuestas si la pregunta aun no ha sido publicada
if($pregunta['Estado']==1 or $pregunta['Estado']==0){?>             
