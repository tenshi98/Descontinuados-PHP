...
/*******************************************************************************************************************/
	...
	foreach ($piezas as $valor) {
		...
		switch ($valor) {
			...
			case 'idPregunta':  if(empty($idPregunta)){  $error['idPregunta']   = 'error/No ha ingresado la lista';}break;
			case 'idRespuesta': if(empty($idRespuesta)){ $error['idRespuesta']  = 'error/No ha ingresado el candidato';}break;
