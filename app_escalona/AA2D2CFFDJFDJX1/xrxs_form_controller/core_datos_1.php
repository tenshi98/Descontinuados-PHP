...
//Validaciones de ingreso de datos obligatorios
	...
	//Valida el ingreso de una direccion
	if ( empty($UrlApp) )     $errors[4] 	  = '
	<div id="txf_04" class="alert_error">  
	  	No ha ingresado la direccion de la App
	...
	//Valida el ingreso de una direccion
	if ( empty($tareasServer) )     $errors[5] 	  = '
	<div id="txf_05" class="alert_error">  
	  	No ha seleccionado la activacion de las tareas del servidor
