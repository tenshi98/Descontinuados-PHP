...
//Validaciones de ingreso de datos obligatorios
	...
	if(isset($Nombre)){
		$sql_nombre = mysql_query("SELECT Nombre FROM vehiculos_transmision WHERE Nombre='".$Nombre."'  "); 
		$n_nomb = mysql_num_rows($sql_nombre);
	} else {$n_nomb=0;}
	// Muestro error
	if($n_nomb > 0) $errors[1]  = '
	<div id="txf_01" class="alert_error">  
	  	El nombre del tipo de transmision ya existe
	...
	<div id="txf_01" class="alert_error">  
	  	No ha ingresado un Nombre para el tipo de transmision
		<a class="closed_b" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_01&apos;).className = &apos;oculto&apos;">
			<i class="fa fa-times"></i>
		</a>
	</div>';
