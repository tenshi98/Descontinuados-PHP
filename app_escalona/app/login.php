...
<div class="input"><label id="icon"><i class="fa fa-user"></i></label> <input type="text" name="Nombre" placeholder="Nombres"/></div>
<div class="input"><label id="icon"><i class="fa fa-user"></i></label> <input type="text" name="Apellido_Paterno" placeholder="Apellido Paterno" /></div>
<div class="input"><label id="icon"><i class="fa fa-user"></i></label> <input type="text" name="Apellido_Materno" placeholder="Apellido Materno" /></div>
<div class="input"><label id="icon" for="name"><i class="fa fa-envelope"></i></label> <input type="email"  name="email" placeholder="Direccion de correo" /></div>
...
<div style="text-align:center;" >	
  <img src="img/logo_ps.png" class="logo_img" />
</div>
<div class="input"><input type="text"      name="Rut"   placeholder="Ingrese su Rut" /></div>
