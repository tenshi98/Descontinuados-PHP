...
if($arrCliente['idCiudad']=='' or $arrCliente['idCiudad']==0){
	echo '<div style="text-align:center;" ><img src="img/logo_ps.png" class="logo_img" /></div>';
	echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' '.$config_app['btn_enlace_border'].' btn_link fcenter" style="width:80%;" href="usr_datos.php'.$w.'">Actualizar Mis Datos</a>';
	 ...
	 case "tb_img":
      ...
      <table class="<?php echo $componentes[0]['Codigo'] ?>">
       <?php foreach ($componentes as $idcomp) { ?>
        <tr>
            <td>
                <div class="box_img <?php echo $idcomp['grid_img'] ?>" style="text-align:center; ">
                    <img src="img/<?php echo $idcomp['url_img'] ?>" border="0" class="logo_img" />
                </div>
            </td>
        </tr>
        <?php } ?> 
