...
/**********************************************************************************************************************************/
if (empty($arrCliente) ) {
	header( 'Location: login.php'.$w.'&return_to1=usr_datos.php' );
	die;
}
/**********************************************************************************************************************************/
...
<section class="<?php echo $config_app['noti_width'].' '.$config_app['noti_border'].' '.$config_app['noti_shadow'].' '.$config_app['noti_aling'].' '.$config_app['noti_color']?>" style="height:100%;">
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
if ( ! empty($_GET['mod_datos']) ) { 
//Se traen los datos del usuario
$query = "SELECT Nombre, Apellido_Paterno, Apellido_Materno, email,Rut, Sexo, fNacimiento,Direccion,Fono1,Fono2, idCiudad, idComuna, mesa
...
<?php  if (isset($errors[16])) {echo $errors[16];}?>  
      ...
      <div class="input"><input type="text" name="Nombre" placeholder="Nombres" value="<?php if(isset($Nombres)) {echo $Nombres;} else {echo $row_data['Nombre'];}?>" /></div>
      <div class="input"><input type="text" name="Apellido_Paterno" placeholder="Apellido Paterno" value="<?php if(isset($Apellido_Paterno)) {echo $Apellido_Paterno;} else {echo $row_data['Apellido_Paterno'];}?>"/></div>
      <div class="input"><input type="text" name="Apellido_Materno" placeholder="Apellido Materno" value="<?php if(isset($Apellido)) {echo $Apellido;} else {echo $row_data['Apellido_Materno'];}?>"/></div>  
      <div class="input"><input type="email" name="email" placeholder="Direccion de correo" value="<?php if(isset($email)) {echo $email;} else {echo $row_data['email'];}?>"/></div>
      <div class="input"><input type="text" name="Rut" placeholder="Rut" value="<?php if(isset($Rut)) {echo $Rut;} else {echo $row_data['Rut'];}?>"/></div>
      <div class="input">      
        <select name="Sexo">
      ...
      <div class="input"><input type="date"  name="fNacimiento" placeholder="Fecha de nacimiento" value="<?php if(isset($fNacimiento)) {echo $fNacimiento;} else {echo $row_data['fNacimiento'];}?>"/></div>
      <div class="input"><input type="text"  name="Fono1" placeholder="Fono1" value="<?php if(isset($Fono1)) {echo $Fono1;} else {echo $row_data['Fono1'];}?>"/></div>
      <div class="input"><input type="text"  name="Fono2" placeholder="Fono2" value="<?php if(isset($Fono2)) {echo $Fono2;} else {echo $row_data['Fono2'];}?>"/></div>
      ...
      <div class="input"><input type="text" name="Direccion" placeholder="Direccion" value="<?php if(isset($Direccion)) {echo $Direccion;} else {echo $row_data['Direccion'];}?>"/></div>
	  <div class="input"><input type="text" name="mesa" placeholder="Mesa de Votacion" value="<?php if(isset($mesa)) {echo $mesa;} else {echo $row_data['mesa'];}?>"/></div>
<script>
<?php
...
function cambia_ciudad(){
  ...
  <tr height="10%">
    <td>
    <a class="<?php echo $config_app['btn_cancelar_color_fondo'].' '.$config_app['btn_cancelar_ancho'].' '.$config_app['btn_cancelar_radio'].' '.$config_app['btn_cancelar_float'].' '.$config_app['btn_cancelar_color_texto'].' '.$config_app['btn_cancelar_sombra'].' '.$config_app['btn_cancelar_border'] ?> btn_link" href="<?php echo $location; ?>" >Cancelar</a>
    </td>
  </tr>
</table>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
...
<?php }?> 
 ...
 <div class="content_pading">
  ...
  <tr height="10%">
    <td colspan="2">
    <a class="<?php echo $config_app['btn_aceptar_color_fondo'].' '.$config_app['btn_aceptar_ancho'].' '.$config_app['btn_aceptar_radio'].' '.$config_app['btn_aceptar_float'].' '.$config_app['btn_aceptar_color_texto'].' '.$config_app['btn_aceptar_sombra'].' '.$config_app['btn_aceptar_border']  ?> btn_link" href="<?php echo $location.'&mod_datos=true'; ?>" >Modificar Perfil</a>
    </td>
  </tr>
  
  <tr height="10%">
    <td colspan="2">
    <a class="<?php echo $config_app['btn_aceptar_color_fondo'].' '.$config_app['btn_aceptar_ancho'].' '.$config_app['btn_aceptar_radio'].' '.$config_app['btn_aceptar_float'].' '.$config_app['btn_aceptar_color_texto'].' '.$config_app['btn_aceptar_sombra'].' '.$config_app['btn_aceptar_border']  ?> btn_link" href="<?php echo 'principal.php'.$w; ?>" >Volver</a>
    </td>
  </tr>
