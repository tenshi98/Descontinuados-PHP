...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1" >
			...
			if(isset($idTipoAlerta)) {      $x1  = $idTipoAlerta;     }else{$x1  = '';}
			if(isset($idSubTipoAlerta)) {   $x2  = $idSubTipoAlerta;  }else{$x2  = '';}
            if(isset($f_inicio)) {          $x3  = $f_inicio;         }else{$x3  = '';}
            if(isset($f_termino)) {         $x4  = $f_termino;        }else{$x4  = '';}

			//se dibujan los inputs
			echo form_select_depend1('Tipo','idTipoAlerta', $x1, 1, 'idTipoAlerta', 'Nombre', 'alertas_tipos', 0,
									 'Subtipo','idSubTipoAlerta', $x2, 1, 'idSubTipoAlerta', 'idTipoAlerta', 'Nombre', 'alertas_subtipo', 0, 
									 $dbConn);
