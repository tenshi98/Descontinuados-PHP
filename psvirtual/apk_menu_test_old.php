    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="65%" align="right" valign="top"><table width="693" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><img src="images/sos_iphone_cut.png" width="693" height="320" /></td>
            </tr>
          </table></td>
        </tr>
      </table></td>
        ...
        <td width="49%" align="center" valign="top"><table width="90%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="top"><p><span class="google_fjalla_gde_red">&bull; ¿Qu&eacute; es SOSClick?</span><br />
              ...
              SOSClick es una aplicaci&oacute;n para Smarthphones con conexi&oacute;n a Internet, desarrollado frente a una necesidad cada vez mayor... La seguridad.</span></p>
              <p><span class="arial_cuerpo_gris">SOSClick te permite estar a un solo click de distancia de hacer un aviso de emergencia a una central que autom&aacute;ticamente se pondr&aacute; en contacto con tu celular, conociendo de antemando la ubicaci&oacute;n desde la cual presionaste SOSClick, gracias al GPS de tu celular. Adem&aacute;s, env&iacute;a 3 Mensajes de texto a celulares que hayas configurado para recibir un mensaje indic&aacute;ndo que est&aacute;s en una emergencia.</span></p>
        ...
        <td width="49%" align="center"><table width="90%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td align="left" valign="top"><p><span class="google_fjalla">&bull; Aplicaci&oacute;n 100% gratis</span><br />
              <span class="arial_cuerpo_gris">Las llamadas que recibes desde la central de emergencia, asi como los 3 SMS enviados a tus n&uacute;meros de confianza son completamente gratis para t&iacute;, o sea no gastas nada al utilizar la aplicaci&oacute;n</span></p>
              ...
              <p><span class="google_fjalla">&bull; Env&iacute;a la ubicaci&oacute;n  donde activaste la emergencia</span><br />
                <span class="arial_cuerpo_gris">Al hacer click en la aplicaci&oacute;n, esta env&iacute;a automaticamente tu ubicaci&oacute;n a trav&eacute;s del GPS a la central de emergencia, para que sea m&aacute;s f&aacute;cil localizarte.</span></p>       
              </p></td>
            </tr>
          </table></td>
        </tr>
