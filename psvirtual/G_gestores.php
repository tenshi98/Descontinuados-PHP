...
<div id="nonFooter" width="100%">
    ...
    <td align="center" valign="middle"><table width="990" align="center" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="58%" align="right" valign="middle" class="google_fjalla_bco">
          Administración de mi Cuenta</td>
        <td width="42%" height="50" align="center" valign="middle">
		<input name="button" type="submit" class="bot_sombra_izq" id="button" value="Tutorial de Uso" />
			<input name="button2" type="submit" class="bot_sombra_cent" id="button2" value="Términos y Condiciones" />
          <input name="button4" type="submit" class="bot_sombra_der" id="button4"  onclick="javascript:window.location.href='http://<?=$nombreurl?>/index.php?cierro=si';" value="Cerrar Sesión" />
		  </td>
      </tr>
    </table></td>
    </tr>
 ...
 <!--contenido-->
    ...
    <?
	$activar_vm=$_POST["activa_vm"];
	$fono_desde_dato=$_POST["fono_desde_hor"] . $_POST["fono_desde_min"];
	$fono_hasta_dato=$_POST["fono_hasta_hor"] . $_POST["fono_hasta_min"]; 
	$fono2_desde_dato=$_POST["fono2_desde_hor"] . $_POST["fono2_desde_min"]; 
	$fono2_hasta_dato=$_POST["fono2_hasta_hor"] . $_POST["fono2_hasta_min"]; 
	$celu_desde_dato=$_POST["celu_desde_hor"] . $_POST["celu_desde_min"]; 
	$celu_hasta_dato=$_POST["celu_hasta_hor"] . $_POST["celu_hasta_min"];
		$seguridad=$_POST["seguridad"];


	$sql="update ejecutivos set  fono_alarma='" . $_POST["seguridad"] . "',nom_ejecutiv='" . $_POST["nombre"] . "',cod_fono='09',fono_ejecutiv='" . $_POST["fono"] . "',pass='" . $_POST["password"] . "',cod_fono2='" . $_POST["ciudad_f2"] . "', fono2_ejecutiv='" . $_POST["fono2"] . "', celu_ejecutiv='" . $_POST["celular"] . "',fono_desde_ejecutiv='" . $fono_desde_dato . "',fono_hasta_ejecutiv='" . $fono_hasta_dato . "',fono2_desde_ejecutiv='" . $fono2_desde_dato . "',sms1='" . $_POST["sms1"] . "',sms2='" . $_POST["sms2"] . "',sms3='" . $_POST["sms3"] . "',activar_vm='" . $activar_vm . "'	where id_ejecutiv=" . $_SESSION['usuario'];
	$actualiza=mysql_query($sql,$base); 
		
?>
    

              <p><span class="google_fjalla_gde">Los datos fueron actualizados.</span></p>
