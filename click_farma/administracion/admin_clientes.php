...
$query = "SELECT idTipo, Nombre , Rut, fNacimiento,  Direccion, idSistema, Fono1, Fono2, email
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			echo form_input_icon('text', 'Email', 'email', $x11, 1,'fa fa-envelope-o');
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			if(isset($Fono1)) {            $x10 = $Fono1;             }else{$x10 = '';}
			if(isset($Fono2)) {            $x11 = $Fono2;             }else{$x11 = '';}
			if(isset($email)) {            $x12 = $email;             }else{$x12 = '';}
			...
			echo '<h3>Datos de contacto</h3>';
			echo form_input_phone('Telefono Fijo', 'Fono1', $x10, 1);
			echo form_input_phone('Telefono Movil', 'Fono2', $x11, 1);
			echo form_input_icon('text', 'Email', 'email', $x12, 1,'fa fa-envelope-o');
