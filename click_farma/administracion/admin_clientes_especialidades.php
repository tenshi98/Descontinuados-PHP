...
$original = "admin_clientes_especialidades.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/medicos_especialidades.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idEspecialidad,Nombre';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/medicos_especialidades.php';
}
//se borra un dato
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la Especialidad</h5>
		</header>
		...
		<form class="form-horizontal" method="post" name="form1">
			...
			<div class="form-group">
            	<input type="hidden" name="idEspecialidad" value="<?php echo $_GET['id']; ?>" >
...
$z="WHERE idEspecialidad>=0";	
//Verifico si la variable de busqueda existe
if(isset($_GET['search']) && $_GET['search'] != ''){ $z .= " AND Nombre LIKE '%{$_GET['search']}%'";}

//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idEspecialidad FROM `medicos_especialidades` ".$z."";
...
array_push( $arrEspc,$row );
}

?>
<div class="form-group">
<form class="form-horizontal" action="<?php echo $location ?>"  name="form1">
<label class="control-label col-lg-4">Buscar Especialidad</label>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Especialidad</a><?php }?>
</div>
...
<div class="col-lg-12">
	<div class="box">	
		<header>		
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Especialidades</h5>	
		</header>
    ...
    <?php foreach ($arrEspc as $especialidad) { ?>
    	<tr class="odd">				
			<td><?php echo $especialidad['Nombre']; ?></td>			
			<td>
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$especialidad['idEspecialidad']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$especialidad['idEspecialidad'];?>			
