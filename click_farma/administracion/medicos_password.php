...
if ( !empty($_POST['submit_pass']) )  { 
	...
	$form_obligatorios = 'idMedico,password,repassword';
	$form_trabajo= 'update';
...
$z="WHERE medicos_listado.idMedico!=''";
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">		
			...
			<td>	
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$usuarios['idMedico']; ?>" title="Cambiar Clave" class="icon-editar info-tooltip"></a><?php } ?>		
			</td>	
		</tr>
    <?php } ?>                    
	</tbody>
