...
$original = "vidasana_categoria.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/vidasana_categoria.php';
}
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Categoria creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Categoria editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Categoria borrado correctamente';}
...
$query = "SELECT idCategoria FROM `vidasana_categoria` ".$z."";
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrEspc as $especialidad) { ?>
    	<tr class="odd">				
			...
			<td>
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$especialidad['idCategoria']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$especialidad['idCategoria'];?>			
