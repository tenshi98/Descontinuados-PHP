...
Source Database       : click_farma

Target Server Type    : MYSQL
Target Server Version : 50620
File Encoding         : 65001

Date: 2016-04-29 20:48:27
*/
...
CREATE TABLE `alertas_listado` (
  `idAlerta` int(11) unsigned NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
INSERT INTO `clientes_contactos` VALUES ('2', '1', 'Joaquín Vásquez', '98358439', 'No Registrado', '2016-03-17 15:21:19', '', '0', 'Seleccionar tipo de contacto');
INSERT INTO `clientes_contactos` VALUES ('3', '1', 'Jorge Lagos', '63529875', 'No Registrado', '2016-03-17 15:40:43', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('4', '1', 'Bomberos', '132', 'No Registrado', '2016-03-17 19:02:08', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('5', '1', 'Busqueda y Salvamento Maritimo', '137', 'No Registrado', '2016-03-17 19:02:21', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('6', '1', 'Carabineros de Chile', '133', 'No Registrado', '2016-03-17 19:02:33', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('7', '1', 'Customer Care', '611', 'No Registrado', '2016-03-17 19:02:50', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('8', '1', 'Investigaciones', '134', 'No Registrado', '2016-03-17 19:03:07', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('9', '1', 'Jorge Newman', '92252702', 'No Registrado', '2016-03-17 19:03:24', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('10', '1', 'Services of Acting on Complaints', '105', 'No Registrado', '2016-03-17 21:14:09', '', '0', 'Otro');
INSERT INTO `clientes_contactos` VALUES ('11', '2', 'Marcelo Lopez1', '56998215180', 'No Registrado', '2016-03-21 19:15:47', '', '0', 'Otro');
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Limpiar al entregar';

-- ----------------------------
-- Records of clientes_listado
-- ----------------------------
INSERT INTO `clientes_listado` VALUES ('1', '1', '1', '2', 'Masculino', 'tenshi98@gmail.com', 'Victor', '23', '12345678', '0000-00-00', '955391914', '', '', '', '', '', '81dc9bdb52d04dc20036dbd8313ed055', '2016-02-25 18:42:05', '2016-02-25 18:42:05', '', 'dOqzeTIo87A:APA91bGT7p0G_IiOyO6aIAkEP1PyjWbkSSCeBwXDE6CajxuWN4h4NX5OirthWzr62Sq7JpTkHUJ2xE8Xop7eLO6VJ-vYtLWSDV4fGu4qwdW_KI4_zJzKYEkWwWCSkhXoV1bfG1PjwRPE', '0', '0', 'android', '0', '0', '1');
INSERT INTO `clientes_listado` VALUES ('2', '1', '1', '2', 'Masculino', 'carlos.valenzuela.silva@gmail.com', 'Carlos Valenzuela', '50', '82476563', '1958-07-04', '993462365', '222454618', 'Lima', 'Lima', 'San Isidro', 'camino real 1121', '81dc9bdb52d04dc20036dbd8313ed055', '0000-00-00 00:00:00', '2016-03-07 00:00:00', '', 'e37U8BwjwkE:APA91bE1lzpyx2pKYl7Q9SF4UVfgqKz6quGfOtqJ_GqAmpnpbSRXwLxAQiKu64hPwonlcy4xgv-_OJeDU-ItUh8s4rZB6pCSUJbW_TjXAAljYF02suKugsqhy9vBEJ1ZIANzepj7304-', '0', '0', 'android', '0', '0', '');
...
CREATE TABLE `core_permisos` (
  ...
  PRIMARY KEY (`idAdmpm`)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=latin1 COMMENT='Administrador';
...
INSERT INTO `core_permisos` VALUES ('23', '9', 'medicos_listado.php?pagina=1', 'medicos_listado.php', 'Medicos - Listado', '9998');
INSERT INTO `core_permisos` VALUES ('24', '9', 'medicos_activation.php?pagina=1', 'medicos_activation.php', 'Medicos - Estado', '9998');
INSERT INTO `core_permisos` VALUES ('25', '9', 'medicos_password.php?pagina=1', 'medicos_password.php', 'Medicos - Contraseña', '9998');
INSERT INTO `core_permisos` VALUES ('26', '9', 'admin_clientes_especialidades.php?pagina=1', 'admin_clientes_especialidades.php', 'Medicos - Especialidades', '9998');
INSERT INTO `core_permisos` VALUES ('27', '10', 'ofertas_diarias.php?pagina=1', 'ofertas_diarias.php', 'Ofertas Diarias', '9998');
INSERT INTO `core_permisos` VALUES ('28', '10', 'ofertas_mias.php?pagina=1', 'ofertas_mias.php', 'Ofertas para mi', '9998');
INSERT INTO `core_permisos` VALUES ('29', '11', 'vidasana_categoria.php?pagina=1', 'vidasana_categoria.php', 'Vida Sana - Categorias', '9998');
INSERT INTO `core_permisos` VALUES ('30', '11', 'vidasana_listado.php?pagina=1', 'vidasana_listado.php', 'Vida Sana - Listado', '9998');
INSERT INTO `core_permisos` VALUES ('31', '12', 'vademecum_categoria.php?pagina=1', 'vademecum_categoria.php', 'Vademecum - Categorias', '9998');
INSERT INTO `core_permisos` VALUES ('32', '12', 'vademecum_listado.php?pagina=1', 'vademecum_listado.php', 'Vademecum - Listado', '9998');
...
INSERT INTO `core_permisos_cat` VALUES ('9', 'Medicos', '17');
INSERT INTO `core_permisos_cat` VALUES ('10', 'Ofertas', '56');
INSERT INTO `core_permisos_cat` VALUES ('11', 'Vida Sana', '95');
INSERT INTO `core_permisos_cat` VALUES ('12', 'Vademecum', '117');
...
-- ----------------------------
-- Table structure for medicos_disponibilidad
-- ----------------------------
DROP TABLE IF EXISTS `medicos_disponibilidad`;
...
-- ----------------------------
-- Records of medicos_disponibilidad
-- ----------------------------
INSERT INTO `medicos_disponibilidad` VALUES ('1', 'Disponible');
INSERT INTO `medicos_disponibilidad` VALUES ('2', 'No Disponible');

-- ----------------------------
-- Table structure for medicos_especialidades
-- ----------------------------
DROP TABLE IF EXISTS `medicos_especialidades`;
CREATE TABLE `medicos_especialidades` (
  `idEspecialidad` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(120) NOT NULL,
  PRIMARY KEY (`idEspecialidad`)
) ENGINE=MyISAM AUTO_INCREMENT=22 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of medicos_especialidades
-- ----------------------------
INSERT INTO `medicos_especialidades` VALUES ('1', 'Anatomía Patológica');
INSERT INTO `medicos_especialidades` VALUES ('2', 'Anestesiología');
INSERT INTO `medicos_especialidades` VALUES ('3', 'Cirugía General');
INSERT INTO `medicos_especialidades` VALUES ('4', 'Cirugía Pediátrica');
INSERT INTO `medicos_especialidades` VALUES ('5', 'Dermatología');
INSERT INTO `medicos_especialidades` VALUES ('6', 'Laboratorio Clínico');
INSERT INTO `medicos_especialidades` VALUES ('7', 'Medicina Familiar Mención Adulto');
INSERT INTO `medicos_especialidades` VALUES ('8', 'Medicina Familiar Mención Niño');
INSERT INTO `medicos_especialidades` VALUES ('9', 'Medicina Interna');
INSERT INTO `medicos_especialidades` VALUES ('10', 'Medicina Nuclear');
INSERT INTO `medicos_especialidades` VALUES ('11', 'Medicina de Urgencia');
INSERT INTO `medicos_especialidades` VALUES ('12', 'Neurocirugía');
INSERT INTO `medicos_especialidades` VALUES ('13', 'Neurología');
INSERT INTO `medicos_especialidades` VALUES ('14', 'Obstetricia y Ginecología');
INSERT INTO `medicos_especialidades` VALUES ('15', 'Oftalmología');
INSERT INTO `medicos_especialidades` VALUES ('16', 'Otorrinolaringología');
INSERT INTO `medicos_especialidades` VALUES ('17', 'Pediatría');
INSERT INTO `medicos_especialidades` VALUES ('18', 'Psiquiatría');
INSERT INTO `medicos_especialidades` VALUES ('19', 'Psiquiatría del Niño y del Adolescente');
INSERT INTO `medicos_especialidades` VALUES ('20', 'Radiología');
INSERT INTO `medicos_especialidades` VALUES ('21', 'Radio-Oncología');

-- ----------------------------
-- Table structure for medicos_estado
-- ----------------------------
DROP TABLE IF EXISTS `medicos_estado`;
CREATE TABLE `medicos_estado` (
  `idEstado` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(30) NOT NULL,
  PRIMARY KEY (`idEstado`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Fija';
...
-- ----------------------------
-- Records of medicos_estado
-- ----------------------------
INSERT INTO `medicos_estado` VALUES ('1', 'Activo');
INSERT INTO `medicos_estado` VALUES ('2', 'Inactivo');

-- ----------------------------
-- Table structure for medicos_listado
-- ----------------------------
DROP TABLE IF EXISTS `medicos_listado`;
CREATE TABLE `medicos_listado` (
  `idMedico` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idSistema` int(11) unsigned NOT NULL,
  `idEstado` int(11) unsigned NOT NULL,
  ...
  `nLlamadas` int(11) unsigned NOT NULL,
  PRIMARY KEY (`idMedico`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Limpiar al entregar';

-- ----------------------------
-- Records of medicos_listado
-- ----------------------------
INSERT INTO `medicos_listado` VALUES ('1', '1', '1', 'medico1', '81dc9bdb52d04dc20036dbd8313ed055', '0', 'adminaaa1@admin1.cl', 'Medico de pruebas', '0', 'dni123', '0000-00-00', '998215180', '2', '9', '96', 'asd', '2016-02-24 13:55:37', '2016-02-24 13:55:37', '2016-03-10', 'Anatomía Patológica', '1', '37');

-- ----------------------------
-- Table structure for medicos_llamadas
-- ----------------------------
DROP TABLE IF EXISTS `medicos_llamadas`;
CREATE TABLE `medicos_llamadas` (
  `idLlamada` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idMedico` int(11) unsigned NOT NULL,
  `fonoMedico` varchar(30) NOT NULL,
  `idCliente` int(11) unsigned NOT NULL,
  `FonoCliente` varchar(30) NOT NULL,
  `Fecha` date NOT NULL,
  `Hora` time NOT NULL,
  PRIMARY KEY (`idLlamada`)
) ENGINE=MyISAM AUTO_INCREMENT=25 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of medicos_llamadas
-- ----------------------------
INSERT INTO `medicos_llamadas` VALUES ('1', '1', '998215180', '2', '993462365', '2016-03-07', '15:20:24');
INSERT INTO `medicos_llamadas` VALUES ('2', '1', '5114220351', '2', '993462365', '2016-03-07', '15:23:21');
INSERT INTO `medicos_llamadas` VALUES ('3', '1', '5114220351', '2', '993462365', '2016-03-07', '15:24:32');
INSERT INTO `medicos_llamadas` VALUES ('4', '1', '5114220351', '2', '993462365', '2016-03-07', '19:21:19');
INSERT INTO `medicos_llamadas` VALUES ('5', '1', '51989877461', '2', '993462365', '2016-03-07', '19:30:32');
INSERT INTO `medicos_llamadas` VALUES ('6', '1', '51989877461', '2', '993462365', '2016-03-07', '19:31:05');
INSERT INTO `medicos_llamadas` VALUES ('7', '1', '51989877461', '2', '993462365', '2016-03-08', '20:09:58');
INSERT INTO `medicos_llamadas` VALUES ('8', '1', '51989877461', '2', '993462365', '2016-03-09', '17:16:09');
INSERT INTO `medicos_llamadas` VALUES ('9', '1', '51989877461', '2', '993462365', '2016-03-10', '14:21:13');
INSERT INTO `medicos_llamadas` VALUES ('10', '1', '998215180', '2', '993462365', '2016-03-10', '15:44:37');
INSERT INTO `medicos_llamadas` VALUES ('11', '1', '998215180', '1', '998215180', '2016-03-10', '16:38:17');
INSERT INTO `medicos_llamadas` VALUES ('12', '1', '955391914', '1', '998215180', '2016-03-10', '16:41:47');
INSERT INTO `medicos_llamadas` VALUES ('13', '1', '998215180', '1', '955391914', '2016-03-10', '16:45:34');
INSERT INTO `medicos_llamadas` VALUES ('14', '1', '998215180', '1', '955391914', '2016-03-10', '16:46:57');
INSERT INTO `medicos_llamadas` VALUES ('15', '1', '998215180', '2', '993462365', '2016-03-10', '21:04:46');
INSERT INTO `medicos_llamadas` VALUES ('16', '1', '998215180', '2', '993462365', '2016-03-10', '21:57:26');
INSERT INTO `medicos_llamadas` VALUES ('17', '1', '998215180', '2', '993462365', '2016-03-11', '14:27:49');
INSERT INTO `medicos_llamadas` VALUES ('18', '1', '998215180', '2', '993462365', '2016-03-14', '15:36:12');
INSERT INTO `medicos_llamadas` VALUES ('19', '1', '998215180', '2', '993462365', '2016-03-15', '15:01:40');
INSERT INTO `medicos_llamadas` VALUES ('20', '1', '998215180', '2', '993462365', '2016-03-16', '15:00:00');
INSERT INTO `medicos_llamadas` VALUES ('21', '1', '998215180', '2', '993462365', '2016-03-16', '17:18:32');
INSERT INTO `medicos_llamadas` VALUES ('22', '1', '998215180', '2', '993462365', '2016-03-17', '13:15:31');
INSERT INTO `medicos_llamadas` VALUES ('23', '1', '998215180', '2', '993462365', '2016-03-17', '23:03:49');
INSERT INTO `medicos_llamadas` VALUES ('24', '1', '998215180', '2', '993462365', '2016-03-21', '19:14:21');

-- ----------------------------
-- Table structure for medicos_observaciones
-- ----------------------------
DROP TABLE IF EXISTS `medicos_observaciones`;
CREATE TABLE `medicos_observaciones` (
  `idObservacion` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idMedico` int(11) unsigned NOT NULL,
  `idUsuario` int(11) unsigned NOT NULL,
  `Fecha` date NOT NULL,
...
-- ----------------------------
-- Records of medicos_observaciones
-- ----------------------------
INSERT INTO `medicos_observaciones` VALUES ('1', '1', '1', '2016-02-23', 'asdasd');

-- ----------------------------
-- Table structure for medicos_sexo
-- ----------------------------
DROP TABLE IF EXISTS `medicos_sexo`;
CREATE TABLE `medicos_sexo` (
...
-- ----------------------------
-- Records of medicos_sexo
-- ----------------------------
INSERT INTO `medicos_sexo` VALUES ('1', 'Masculino');
INSERT INTO `medicos_sexo` VALUES ('2', 'Femenino');

-- ----------------------------
-- Table structure for ofertas_diarias
-- ----------------------------
DROP TABLE IF EXISTS `ofertas_diarias`;
CREATE TABLE `ofertas_diarias` (
  `idOfertasDia` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Titulo` varchar(120) NOT NULL,
  `Descripcion` text NOT NULL,
  `Valor` int(11) unsigned NOT NULL,
  `Direccion_img` varchar(120) NOT NULL,
  PRIMARY KEY (`idOfertasDia`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of ofertas_diarias
-- ----------------------------
INSERT INTO `ofertas_diarias` VALUES ('1', 'Acifin', 'Indicado para aliviar temporalmente los síntomas de la acidez, y malestar estomacal. Acifin contiene Magaldrato, el cual es un antiácido y Simeticona, sustancia encargada de la adsorción de los gases generados durante la digestión, causantes del malestar.', '1090', 'ofert_dia_img_Acifin.jpg');
INSERT INTO `ofertas_diarias` VALUES ('2', 'Agua del Carmen', 'El agua de toronjil, agua de melisa o agua del Carmen es una preparación  que desde el año 1611 elaboran los monjes de la comunidad religiosa de los Carmelitas Descalzos.', '1490', 'ofert_dia_img_Agua.jpg');
INSERT INTO `ofertas_diarias` VALUES ('3', 'Antiax', 'Hiperacidez de diverso origen; síntomas dispépticos que acompañan a la hiperacidez: flatulencia, distensión abdominal. Distensión y dolores abdominales posoperatorios.', '1090', 'ofert_dia_img_Antiax.jpg');
INSERT INTO `ofertas_diarias` VALUES ('4', 'Aspirina', 'Tratamiento sintomático de estados dolorosos leves a moderados de origen no visceral asociados a inflamación. Reducción de estados febriles. Usos: Para el alivio sintomático del dolor de cabeza, dolor de muelas, dolor de garganta relacionado con el resfrío, dolores musculares y de articulaciones, dolor de espalda, dolores menores provocados por la artritis. Alivio sintomático del dolor y la fiebre provocados por el resfrío común o influenza.', '1290', 'ofert_dia_img_Aspirina.jpg');
INSERT INTO `ofertas_diarias` VALUES ('5', 'Bepanthol', 'Cambie constantemente los pañales usados o húmedos. Limpie muy bien el área del pañal y deje secar. Aplique el ungüento abundantemente tan frecuente como sea necesario. Cada vez que cambie el pañal, al momento de dormir o cuando haya estado expuesto a prolongados cambios de pañal. Usos: Ayuda al tratamiento de las coceduras. Protege la piel irritada por las coceduras y crea una capa protectora contra la humedad.', '6990', 'ofert_dia_img_Bepanthol.jpg');
INSERT INTO `ofertas_diarias` VALUES ('6', 'Bioflora', 'Reconstituyente de la flora intestinal.', '6990', 'ofert_dia_img_Bioflora.jpg');
INSERT INTO `ofertas_diarias` VALUES ('7', 'Bion intime', 'Lactobacillus rhamnosus. Lactobacillus reuteri. Reconstituyente de la microbiota vaginal. Caps. x 30.', '12990', 'ofert_dia_img_Bion.jpg');
INSERT INTO `ofertas_diarias` VALUES ('8', 'BIOTICAPS TRÁNSITO INTESTINAL', 'Ayuda a mejorar el tránsito lento, la hinchazón y los gases', '7990', 'ofert_dia_img_BIOTICAPS.jpg');
INSERT INTO `ofertas_diarias` VALUES ('9', 'Blistex', 'Util en la sequedad y agrietamiento de los labios, ayuda a prevenir y aliviar fuegos, herpes labiales, queilitis, labios irritados por exposición al sol, viento y frío invernal.', '2190', 'ofert_dia_img_Blistex.jpg');

-- ----------------------------
-- Table structure for ofertas_mias
-- ----------------------------
DROP TABLE IF EXISTS `ofertas_mias`;
CREATE TABLE `ofertas_mias` (
  `idOfertasMias` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Titulo` varchar(120) NOT NULL,
  `Descripcion` text NOT NULL,
  `Valor` int(11) unsigned NOT NULL,
  `Direccion_img` varchar(120) NOT NULL,
  PRIMARY KEY (`idOfertasMias`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of ofertas_mias
-- ----------------------------
INSERT INTO `ofertas_mias` VALUES ('1', 'Broncotusilan Infantil', 'Mucolítico coadyuvante en la terapia de los desórdenes del tracto respiratorio caracterizados por mucus excesivamente viscoso. Enfermedades broncopulmonares agudas, como bronquitis, traqueobronquitis y neumonía. Bronquiectasia. Enfisema pulmonar. Rinorrea y rinofaringitis de la infancia. Sinusitis recurrentes. Coadyuvante en el tratamiento de la sinusitis común y en la etmoiditis. Otitis media secretora. Complicaciones pulmonares posquirúrgicas, posanestésicas y posinfecciosas infantiles.', '3590', 'ofert_mia_img_BroncotusilanInfantil.jpg');
INSERT INTO `ofertas_mias` VALUES ('2', 'CAFIASPIRINA', 'Analgésico. Antiinflamatorio. Antipirético.', '2290', 'ofert_mia_img_CAFIASPIRINA.jpg');
INSERT INTO `ofertas_mias` VALUES ('3', 'Canestén', 'Tratamiento de diferentes infecciones por hongos (micosis), tales como: pie de atleta (hongos en los pies) hongos en las manos, hongos en los pliegues cutáneos (ingles y axilas) y hongos en el cuerpo, que habitualmente se acompañan de picazón, ardor, descamación, agrietamiento y mal olor.', '2290', 'ofert_mia_img_Canestén.jpg');
INSERT INTO `ofertas_mias` VALUES ('4', 'CARYAMIL', 'Alivio de afecciones menores a la piel causadas por quemaduras, eritemas solares, detergentes, solventes orgánicos, leves picaduras de insectos. Prevención de infecciones dérmicas y alivio de las molestias provocadas por la picazón', '2490', 'ofert_mia_img_CARYAMIL.jpg');
INSERT INTO `ofertas_mias` VALUES ('5', 'Ciruelax Forte', 'Tratamiento del estreñimiento ocasional.', '2290', 'ofert_mia_img_CiruelaxForte.jpg');
INSERT INTO `ofertas_mias` VALUES ('6', 'COTIBIN FLU', 'Tratamiento sintomático de la gripe y el resfrío, cuando están asociados a tos no productiva, especialmente en pacientes que presentan somnolencia por el uso de antihistamínicos durante el día.', '1190', 'ofert_mia_img_COTIBINFLU.jpg');
...
-- ----------------------------
INSERT INTO `usuarios_accesos` VALUES ('1', '1', '2016-03-02', '11:19:50');
INSERT INTO `usuarios_accesos` VALUES ('2', '1', '2016-03-04', '11:59:20');
INSERT INTO `usuarios_accesos` VALUES ('3', '1', '2016-03-07', '11:30:58');
INSERT INTO `usuarios_accesos` VALUES ('4', '1', '2016-03-07', '13:57:41');
INSERT INTO `usuarios_accesos` VALUES ('5', '1', '2016-03-10', '09:44:28');
INSERT INTO `usuarios_accesos` VALUES ('6', '1', '2016-03-10', '11:30:42');
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='Cuidado';

-- ----------------------------
-- Records of usuarios_listado
-- ----------------------------
INSERT INTO `usuarios_listado` VALUES ('1', 'tenshi98', 'b9ad227539cc03cd8199e23aa9078065', 'SuperAdmin', '1', 'asd@bla1.cl', 'Victor Reyes', '16029464-7', '2014-05-14', 'Los Lirios 0936', '8512517', 'Santiago', 'Puente Alto', 'usr_img_img_6626.jpg', '2016-03-10', '0');
...
INSERT INTO `usuarios_tipos` VALUES ('2', 'Usuario');

-- ----------------------------
-- Table structure for vademecum_categoria
-- ----------------------------
DROP TABLE IF EXISTS `vademecum_categoria`;
CREATE TABLE `vademecum_categoria` (
...
-- ----------------------------
-- Records of vademecum_categoria
-- ----------------------------
INSERT INTO `vademecum_categoria` VALUES ('1', 'Medicamentos');
INSERT INTO `vademecum_categoria` VALUES ('2', 'Enfermedades');
INSERT INTO `vademecum_categoria` VALUES ('3', 'Monografia PA');

-- ----------------------------
-- Table structure for vademecum_listado
-- ----------------------------
DROP TABLE IF EXISTS `vademecum_listado`;
CREATE TABLE `vademecum_listado` (
  `idVademecum` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idCategoria` int(11) unsigned NOT NULL,
  `Titulo` varchar(120) NOT NULL,
  `Descripcion` text NOT NULL,
  PRIMARY KEY (`idVademecum`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of vademecum_listado
-- ----------------------------
INSERT INTO `vademecum_listado` VALUES ('2', '1', 'Aceclofenaco', '\r\nGRUPO: Antiinflamatorios no esteroideos vía sistémica.\r\n\r\nEl aceclofenaco es un fármaco que actúa impidiendo la formación de prostaglandinas en el organismo. Las prostaglandinas se producen en respuesta a una lesión, o a ciertas enfermedades, y provocan inflamación y dolor.\r\n\r\nEl aceclofenaco reduce la inflamación y el dolor. Actúa también aliviando o reduciendo la fiebre.\r\n');
INSERT INTO `vademecum_listado` VALUES ('3', '1', 'Acexamato, ', '\r\nGRUPO: Protectores gástricos\r\n\r\nEl acexamato de zinc es un medicamento derivado del zinc. Actúa promoviendo la formación de moco e inhibiendo la liberación de histamina por unas células llamadas mastocitos. La histamina se une a unas células y hace que éstas produzcan ácido.\r\n\r\nEl acexamato de zinc al inhibir la liberación de histamina hace que se reduzca la producción de ácido en el estómago. También parece que puede tener un efecto inhibitorio sobre el Helicobacter pylori, que es una bacteria implicada en el desarrollo de muchas úlceras de estómago.\r\n');
INSERT INTO `vademecum_listado` VALUES ('4', '2', 'Acné', 'ACNECLIN 	INVESTI\r\nACNECLIN 100 AP 	INVESTI\r\nACNEOUT 	HLB PHARMA\r\nACNEPAS 	ATLAS FARMAC.\r\nACNEPAS E 	ATLAS FARMAC.\r\nACNESAN 	INGENS\r\nACNIBEN TOALLITAS 	ISDIN\r\nACNOXIN 	ANDROMACO\r\nADAPALENO LAFEDAR 	LAFEDAR\r\nADAPNE 	OXAPHARMA\r\nADAPNE DUO 	OXAPHARMA\r\nASTRILUGE 	VALUGE\r\nATLACNE 	ATLAS FARMAC.\r\nATLAMICIN 	ATLAS FARMAC.\r\nbaseBEL 	FORTBENTON\r\nBENZIHEX AC 	GALDERMA\r\nBIOTIN A 	RAYMOS\r\nCLEANANCE K AVENE 	P.F.DERMO-COSM.\r\nCLIDAN 	CASSARA\r\nCLIDAN B 	CASSARA\r\nCLINDACIN 	PANALAB\r\nCLINDACUR 	OXAPHARMA\r\nCLINDACUR UNO 	OXAPHARMA\r\nCLINDOPAX 	LAGOS\r\nCLINDOXYL 	GLAXOSMITHKLINE\r\nCLINOINA 	ATLAS FARMAC.\r\nCP ACNE DUO 	PHARMATRIX\r\nCP ACNE DUO MULTIDOSIS 	PHARMATRIX\r\nCP ACNE DUO PAK 	PHARMATRIX\r\nCUTACELAN 	BAYER (BSP)\r\nDERMACNÉ 	LDA\r\nDERMASEB 	CASSARA\r\nDERMOTOPIC 	LAZAR\r\nDERMOTOPIC DUO 	LAZAR\r\nDETTONANT 	LAFEDAR\r\nDIFFERIN 	GALDERMA\r\nDIFFERIN 0,3% 	GALDERMA\r\nDONIQ 	RAYMOS\r\nDONIQ DUO 	RAYMOS\r\nDORPIEL 	INGENS\r\nDRENIX 100 	OXAPHARMA\r\nDRENIX 100 AP 	OXAPHARMA\r\nDRENIX 50 	OXAPHARMA\r\nDUO CLINDACIN 	PANALAB\r\nECNAGEL LOCION ASTRINGENTE 	NOVOPLOS\r\nECNAGEL P.B. 	NOVOPLOS\r\nEFFACLAR GEL 	LA ROCHE-POSAY\r\nEFFACLAR K 	LA ROCHE-POSAY\r\nEPIDUO 	GALDERMA\r\nERI ACNE 	ANDROMACO\r\nERIMICIN 	CASSARA');
INSERT INTO `vademecum_listado` VALUES ('7', '2', 'Alergia', 'AERIUS 	MSD ARGENTINA\r\nAERIUS D 	MSD ARGENTINA\r\nAEROTINA 	RAFFO\r\nAFEME 	CETUS\r\nALERCAS 	CASASCO\r\nALERCAS CORT 	CASASCO\r\nALERFEDINE 	LAZAR\r\nALERFEDINE 180 	LAZAR\r\nALERFEDINE D 	LAZAR\r\nALERGIANO 	NORTHIA\r\nALERGITRAT 	FECOFAR\r\nALERGITRAT L 	FECOFAR\r\nALERMUC 	ELISIUM\r\nALERNIX 24 RAPIDA ACCION 	ELEA\r\nALERPRIV 	MONTPELLIER\r\nALERPRIV D 	MONTPELLIER');

-- ----------------------------
-- Table structure for vidasana_categoria
-- ----------------------------
DROP TABLE IF EXISTS `vidasana_categoria`;
CREATE TABLE `vidasana_categoria` (
  `idCategoria` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(30) NOT NULL,
  PRIMARY KEY (`idCategoria`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=latin1 COMMENT='Fija';
...
-- ----------------------------
-- Records of vidasana_categoria
-- ----------------------------
INSERT INTO `vidasana_categoria` VALUES ('1', 'Salud');
INSERT INTO `vidasana_categoria` VALUES ('2', 'Belleza');
INSERT INTO `vidasana_categoria` VALUES ('3', 'Familia');

-- ----------------------------
-- Table structure for vidasana_listado
-- ----------------------------
DROP TABLE IF EXISTS `vidasana_listado`;
CREATE TABLE `vidasana_listado` (
  `idVidaSana` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idCategoria` int(11) unsigned NOT NULL,
  `Titulo` varchar(120) NOT NULL,
  `Descripcion` text NOT NULL,
  PRIMARY KEY (`idVidaSana`)
) ENGINE=MyISAM AUTO_INCREMENT=14 DEFAULT CHARSET=latin1 COMMENT='Fija';

-- ----------------------------
-- Records of vidasana_listado
-- ----------------------------
INSERT INTO `vidasana_listado` VALUES ('1', '1', 'Cómo empezar marzo con energía', ' Una creencia frecuente es que cuando estamos cansados o nos levantamos con poco ánimo ...\r\nEmpieza Año con Energia\r\n\r\nLuego de las vacaciones siempre cuesta volver a la rutina del trabajo, llevar los hijos al colegio y el transporte a través de la ciudad, pero existen numerosas formas de comenzar el día con toda la energía que necesitas para enfrentar las mañanas con entusiasmo.\r\n\r\nUna creencia frecuente es que cuando estamos cansados o nos levantamos con poco ánimo, una taza de café, comida con alto contenido calórico o de azúcar, como dulces o bebidas energéticas nos dará el golpe de energía que nos permitirá despertar en forma definitiva para enfocarnos durante el día, pero creando algunos hábitos sencillos evitarás esta sensación.\r\n\r\n1. No olvides el desayuno: incluye frutas, lácteos y carbohidratos. Está demostrado que esta conducta es esencial para lograr una concentración óptima y te entregará la energía necesaria para mantenerte despierto y alerta. Además, el desayuno es una buena instancia para tomar suplementos vitamínicos, sobre todo si traen ginseng. \r\n\r\n2. Beber mucha agua: las células de nuestro cuerpo necesitan estar constantemente hidratadas para trabajar con eficiencia, por lo que te recomendamos beber un vaso grande de agua al iniciar tu día para reponer los líquidos perdidos durante las horas de sueño. Prefiere el agua en estado puro o mineral, y después bebe tu café o té matutino que acostumbras.\r\n\r\n3. Hacer ejercicio: la actividad física produce endorfinas, estimulantes naturales de nuestro cuerpo que nos permiten levantar el ánimo y mantenernos despiertos. \r\n\r\n4. Seguir bebiendo agua: no basta solo con un vaso al día, pues nuestro cuerpo se encuentra realizando procesos químicos a cada minuto y necesitamos hidratarnos lo más posible. Puedes darle sabor con unas rodajas de limón, unas hojas de menta o un poco de té verde si no te gusta beber agua purificada o mineral.\r\n\r\n5. Comer sano: aumenta el consumo de verduras, frutas, legumbres y alimentos que aporten ácidos grasos omega 3 o 6, como los pescados, frutos secos, palta y aceite de oliva. Estos aceites podrían tener efecto sobre la producción de energía, la circulación sanguínea, la actividad cerebral y principalmente la prevención de problemas cardiacos. Del mismo modo, procura comer al menos cuatro veces al día en forma ordenada. \r\n\r\nComienza a seguir estos consejos todos los días hasta que se conviertan en un hábito, y notarás la diferencia. \r\n');
INSERT INTO `vidasana_listado` VALUES ('2', '2', 'Consejos, mitos y verdades para una mejor depilación', ' Rasurarse es mejor que usar crema depilatoria, que entre más remueves el vello más grueso crece o que la depilación láser es definitiva, son algunas de las cosas que has escuchado a lo largo del tiempo cuando se trata de depilación.\r\nDepilacion\r\n\r\nSon variadas las técnicas de depilación y siempre habrá alguna que te acomode más que la otra, pero siempre será bueno tener en cuenta algunos consejos que pueden facilitar esta tarea prioritaria para todas las mujeres ahora que el sol ya comienza a ser más constante.\r\n\r\n Consejos para la depilación:\r\n\r\n    Es fundamental que tu piel esté limpia, seca y sin ningún tipo de productos, si tuviera algún producto lavar con agua y jabón en abundancia.\r\n    Tener la piel exfoliada 24 horas antes de la depilación.\r\n    Trata de no repetir el proceso de depilación, en especial con cera o bandas, en un plazo inferior a 72 horas.\r\n    Si planeas tomar sol, hacer la depilación 24 horas antes de esto.\r\n    Si eres de piel sensible prefiere las variedades que te entregan las distintas marcas para tu tipo de piel. Ten la precaución de aplicar en una pequeña zona el producto para ver si tienes alguna reacción adversa.\r\n    Si experimentas cualquier reacción alérgica, irritación o ardor al aplicar el producto, retíralo inmediatamente de tu piel y lava con abundante agua. No uses el producto nuevamente. ');
INSERT INTO `vidasana_listado` VALUES ('3', '2', 'Tips de maquillaje para destacar', ' El maquillaje es tu mejor aliado\r\ntips maquillaje\r\n\r\nEl maquillaje es nuestro mejor aliado cuando queremos destacar. Es por eso que todo truco es bien recibido. A continuación toma nota de algunos tips que te servirán para evitar algunas imperfecciones, recomponer maquillaje en mal estado y más.\r\n\r\n    ¿Cejas indomables? Añade un poco de laca a un cepillo de cejas para fijar mejor el peinado. Incluso, puedes marcarlas con un poco de delineador café para que se vena más tupidas.\r\n    Revive tu rostro iluminándolo. Además del corrector de ojeras el iluminador es una excelente manera de hacer resplandecer tu rostro luego de, por ejemplo, una mala noche. Aplícalo en los lagrimales, arco de las cejas, en el centro de la frente y en la parte más elevada de los pómulos.\r\n    ¿Rompiste tu labial favorito? No es tiempo de botarlo a la basura. Une las dos partes con un poco de aire caliente del secador de pelo. Usa tus dedos para sellar los extremos y déjalo enfriar toda la noche en el refrigerador.\r\n    Sombra sin residuos. Muchas veces cuando maquillas tus ojos, sueles manchar mucho alrededor de ellos, lo que hace que tengas que volver a retocar el resto de tu rostro. Para esto puedes aplicar una capa gruesa de polvo translúcido en tus ojos y a su alrededor antes de la sombra. A terminar, solo deberás limpiar con una esponja.\r\n    Colorete perfecto. Si quieres encontrar el lugar indicado para colocar el colorete, sonríe y ponlo justo donde se levantan tus pómulos.\r\n');
INSERT INTO `vidasana_listado` VALUES ('4', '2', '¿Cómo elegir el shampoo adecuado para ti?', ' Aunque la función principal del shampoo es limpiar, debes tener presente que para cada tipo de cuero cabelludo hay un shampoo adecuado, y si deseas conseguir un objetivo determinado en tu cabello es necesario escoger aquel que mejor servirá a ese propósito\r\nshamp\r\nEspecialmente, si tienes un cuero cabelludo sensible o sufres de caspa, dermatitis, psoriasis u otras afecciones, antes de escogerlo necesitas consultar a un dermatólogo para que te ayude a identificar en qué estado de salud se encuentra tu superficie capilar.\r\n\r\nUna vez que ya has diagnosticado tu cabello y si tienes un cuero cabelludo sano, busca un shampoo que limpie el cabello, sin aditivos y que tenga propiedades cosméticas que te permitan obtener el resultado que quieres; volumen, hidratación, control del frizz, entre varios otros.\r\n\r\nConsidera también cuál es tu tipo de cabello, ya que cada formulación de shampoo incorpora diferente concentración de tensoactivos; anfóteros para cabello fino y cabello delicado, aniónicos para pelo normal o pelo graso, y catiónicos para cabello seco. Además, estos distintos tipos de shampoo tendrán mayor o menor cantidad de proteínas, siliconas y moléculas para modificar el color de tu cabello, que darán las propiedades alisantes, ondulante y varias otras según el shampoo escogido.\r\n\r\nPara cabello fino y delicado, el cual es frágil y carente de volumen, te recomendamos un shampoo que le dé cuerpo, sea extra suave y con bajas o nulas cantidades de sulfato. En cambio, para el pelo seco y dañado, que es quebradizo y opaco debido a su falta de nutrición e hidratación, el shampoo debe ser suave y colaborar en el relleno de las grietas que causa la sequedad, facilitando el brillo y la docilidad del cabello.\r\n\r\nLa caspa, que se produce por dermatitis seborreica, desbalances hormonales o estrés, entre otros factores, puedes tratarla con samphoo elaborados a base de extractos naturales, que descongestionen, purifiquen y tengan efecto acondicionador.\r\n\r\nPor otro lado, el cabello graso se ensucia con facilidad y debes evitar que los folículos pilosos se obstruyan con sebo. Para ello, el shampoo que escojas debe tener un pH regulado, que limpie profundamente pero no irrite el cuero cabelludo, y que a la vez tenga acción equilibrante y astringente en tu pelo.');
INSERT INTO `vidasana_listado` VALUES ('5', '2', 'Secreto y cuidados a la hora de tomar una ducha', ' Cuida tu cuerpo a diario.\r\nducha\r\n\r\nCuando tomas una ducha, es el momento ideal para que cuides y regalonees tu cuerpo, es por esto que te dejamos algunas recomendaciones para que te veas aún más bella:\r\n\r\n- Nutre y suaviza tu piel: Opta siempre por productos que sean naturales, sin potenciadores de aroma ni colorantes. Ideal aceite de oliva con lavanda o caléndula.\r\n\r\n-Revitaliza: La sal de mar es increíble para revitalizar tu piel, como también para sacar malas energías. Vierte media cucharadita de sal de mar es un libro de agua y aplícala sobre la piel del cuerpo, rostro y cuero cabelludo inclusive, y friccionar en forma suave y constante. No enjuagar. Hazlo al menos una vez por semana.\r\n\r\n- Higiene sin agua: Utiliza un cepillo de plástico para remover la capa córnea de la piel, que es la capa más externa de la epidermis, que está constituida por células que contienen queratina y que se eliminan continuamente al exfoliarse. Al utilizar un cepillo, activarás la circulación linfática venosa y energética.\r\n\r\nPon atención a:\r\n\r\nSecado del cuerpo: Seca tu cuerpo de manera suave, no apurado ni agresivamente. Utiliza una toalla suave.\r\n\r\nMascarillas de limpieza: Antes de utilizarla, lee bien las instrucciones y verifica si es apra usarla antes o después de la ducha.\r\n\r\nJabones: Recuerda que los jabones tiene un PH diseñado para eliminar la grasa de la piel. Es por esto, que si tienes la piel seca, no debes utilizar cualquier jabón. Asesórate por expertos. ');
INSERT INTO `vidasana_listado` VALUES ('6', '3', 'Cardiosmile, un producto natural que ayuda a disminuir el colesterol', ' ¿Sabías que existe un producto en el mundo que no solo ayuda a inhibir la absorción de colesterol en el organismo y así mejorar la salud cardiovascular, sino que además es chileno?\r\nCardiosmile\r\n\r\nCardiosmile, de Nutrartis, es un nutracéutico formulado con fitoesteroles, los cuales son componentes naturales que están presentes en frutas y vegetales e inhiben la absorción de colesterol. De esta forma, incide directamente en la concentración de colesterol “malo” (LDL) y triglicéridos en la sangre, reduciendo los primeros en un 11% y los segundos en 14% en un plazo de un mes, según indicó el Richardson Centre for Functional Foods and Nutraceuticals de la Universidad de Manitoba, Canadá.\r\n\r\nLos especialistas recomiendan que, para lograr este efecto, se deben consumir dos gramos de fitoesteroles al día, lo cual resulta complejo en una dieta normal, ya que comúnmente solo ingerimos este esteroide natural a través de legumbres, semillas, cereales y frutos secos, así como en aceites, margarinas, leches, yogurt y vegetales verdes como brócoli, lechuga, acelga y espinaca. Cardiosmile, no obstante, en un solo sachet libre de calorías, grasas, lactosa y gluten complementa la dosis diaria ideal y te permitirá acomodar el producto en tu régimen alimenticio sin riesgo de desestabilizarlo.\r\n\r\nEl consumo de fitoesteroles es especialmente recomendable en Chile, un país que donde, de acuerdo a la según la Encuesta Nacional de Salud (ENS) 2009-2010, un 38,5% de la población presenta índices elevados de colesterol total. En el caso de los triglicéridos altos, la prevalencia a nivel nacional es de un 31,2%, toda vez que un 7,7% de la población nacional presenta riesgo cardiovascular moderado y alto, y un 3,2% ha sufrido un infarto agudo al miocardio. Y es que, de acuerdo a estudios, los chilenos consumimos alrededor de 60 y 70 miligramos de fitoesteroles al día; como referencia, en Japón, país con mejores índices de alimentación saludable en su población, se consumen más de 500 miligramos al día, es decir, una diferencia de 10 veces respecto a Chile.\r\n\r\nContrario a la creencia popular que dice que los problemas cardiovasculares son propios de personas de edad avanzada, el riesgo de enfermedad cardiovascular se comienza a desarrollar a edades tempranas, por lo que se recomienda empezar lo antes posible a cuidar los marcadores de riesgo; de aquí la importancia de incluir en la dieta diaria el consumo correcto de fitoesteroles.\r\nLos niveles de colesterol elevados o dislipidemia son riesgosos para la salud debido a que pueden ocasionar accidentes cardiovasculares. El uso de fitoesteroles favorece el control de niveles sanguíneos de colesterol otorgando beneficios para la salud cardiovascular, sin embargo no reemplaza el uso de medicamentos. Si tienes el colesterol elevado consulta a tu médico. ');
INSERT INTO `vidasana_listado` VALUES ('7', '3', '¿Puedo beber alcohol si estoy tomando medicamentos? ', ' Es ampliamente conocido que el consumo de alcohol durante un tratamiento con medicamentos puede ser perjudicial. Y es en esta época de fiestas, donde las dudas de si está permitido o no tomar alcohol con un determinado fármaco también aumentan.\r\nAlcohol y Medicamentos\r\nPor eso respondemos algunas de las interrogantes que surgen al respecto de esta asociación, para que puedas disfrutar de estas fiestas sin poner en riesgo tu seguridad.\r\n\r\n¿Qué consecuencias puede tener ingerir alcohol mientras se está tomando un medicamento?\r\n\r\nLas consecuencias del consumo de alcohol dependerán de la cantidad de alcohol que se ingiere y de si se trata de un consumo esporádico o crónico:\r\n\r\n    El consumo esporádico de alcohol generalmente aumenta el efecto de ciertos medicamentos y por lo tanto aumenta la intensidad de sus efectos adversos e incluso puede causar intoxicación.\r\n\r\n     \r\n    El consumo crónico de alcohol en cantidades elevadas, por el contrario, puede causar que algunos fármacos se eliminen más rápido del organismo y por lo tanto su efecto sea menor al esperado, excepto si se llega a una situación de cirrosis hepática, en que el funcionamiento del hígado está disminuido y los medicamentos se eliminan más lentamente del organismo.\r\n\r\n¿La ingesta de alcohol afecta a todos los medicamentos por igual?\r\n\r\nNo. La severidad de la interacción entre medicamentos y alcohol depende del medicamento y la cantidad de alcohol ingerida.\r\n\r\n¿Con qué medicamentos está absolutamente contraindicado beber alcohol?\r\n\r\nAlgunos medicamentos aumentan de manera desproporcionada la cantidad de alcohol en la sangre, provocando una serie de síntomas conocidos como efecto disulfiram, también conocido como efecto Antabus. Estos síntomas son de diversa gravedad y pueden incluir náuseas, vómitos, enrojecimiento facial, ansiedad, taquicardia, disminución de presión arterial e insuficiencia respiratoria.\r\n\r\nMedicamentos que pueden causar efecto disulfiram son: Algunos antibióticos (cefoperazona y los derivados de “sulfas” como el co-trimoxazol), el antidiabético glibenclamida, y los antiinfecciosos ketoconazol y metronidazol.  Las personas que están en tratamiento con estos medicamentos tienen absolutamente contraindicada la ingesta de alcohol, aún en cantidades moderadas.\r\n\r\n¿Existe algún medicamento cuyo efecto aumente con el alcohol?\r\n\r\nSí. El  efecto depresor de los medicamentos que actúan en el sistema nervioso central, (como los que utilizamos para dormir o para calmar la ansiedad)  aumenta con el alcohol. Esta interacción se manifiesta con un notorio aumento de somnolencia, letargo, disminución del estado de alerta y de los reflejos. Esta interacción también se presenta con antialérgicos, relajantes musculares y algunos antitusivos.\r\n\r\nLas personas que utilizan anticoagulantes (como acenocumarol) deben evitar la ingesta de alcohol, pues la acción del medicamento aumenta, con el consecuente riesgo de hemorragias.\r\n\r\nLa ingesta esporádica de alcohol también aumenta los efectos secundarios del antiepiléptico fenitoina.\r\n\r\nSi estoy tomando antiinflamatorios ¿puedo ingerir alcohol?\r\n\r\nSi bien no existe una contraindicación absoluta, es importante recordar que el uso de antiinflamatorios y alcohol aumenta el riesgo de sufrir lesiones en la mucosa gástrica. Si ha presentado molestias gástricas, es recomendable reducir o evitar el consumo de alcohol.\r\n\r\n¿Es cierto que no puedo beber alcohol si estoy tomando antibióticos u otros antiinfecciosos?\r\n\r\nLa mayoría de los antibióticos no presentan interacciones de gravedad con alcohol.\r\n\r\nSin embargo,  como ya mencionamos, la ingesta de alcohol está absolutamente contraindicada en pacientes que utilizan algunos de los siguientes medicamentos antiinfecciosos: metronidazol,  ketoconazol, cotrimoxazol y otros derivados de las “sulfas”,  cefoperazona,\r\n\r\nTambién  es importante tener en cuenta que al igual que en caso de los antinflamatorios, el alcohol puede aumentar la probabilidad de sufrir molestias gástricas asociadas al uso de estos medicamentos.\r\n\r\nConsulta siempre a tu médico o Químico Farmacéutico.\r\n\r\nRecuerda que:\r\n\r\n    Los medicamentos son seguros y efectivos cuando se utilizan  adecuadamente.\r\n    Los medicamentos y el alcohol pueden interactuar de manera dañina, aún si no se toman al mismo tiempo.\r\n    El médico o el químico farmacéutico pueden ayudarle  a determinar qué medicamentos interactúan peligrosamente con el alcohol.\r\n    Las interacciones entre medicamentos y alcohol son más frecuentes y severas en adultos mayores.\r\n    Si consume alcohol, hágalo en forma moderada (una o dos copas de vino) y no realice actividades que requieran estar alerta, como conducir vehículos o manejar instrumentos o maquinaria de precisión.\r\n\r\n');
INSERT INTO `vidasana_listado` VALUES ('8', '3', 'Espirulina, la súper alga para tu dieta', ' La espirulina se considera un superalimento, ya que tiene múltiples beneficios para la salud y la dieta\r\nSpirulina\r\n\r\nUn alga unicelular de color azul verdosos y con forma de espiral, que de ahí recibe su nombre, la espirulina es cosumida por millones de personas en el mundo que la usan como un complemento alimenticio en su dieta por su rico contenido de proteínas, ácidos grasos esenciales, minerales y vitaminas y su reconocido efecto de saciedad a la hora de comer.\r\n\r\nLa espirulina también sirve como ayudante en casos de desórdenes alimenticios, desmineralización y agotamiento, ayudando a recuperar la forma física, la energía y a desintoxicar el organismo.\r\n\r\nPor todo lo anterior la espirulina se considera un superalimento, ya que tiene múltiples beneficios para la salud y la dieta, como por ejemplo:\r\n\r\n    Mejora el sistema inmunológico y reduce el estrés oxidativo por su alto contenido en antioxidantes.\r\n    Gracias a su aporte de Omega 3 puede contribuir a disminuir el riesgo de enfermedades cardiovasculares.\r\n    Efecto protector frente a la contaminación producida por metales pesados gracias al alto poder desintoxicante de la clorofila.\r\n    Por su efecto prebiótico puede contribuir a mantener el equilibrio de la flora intestinal. Por su alto contenido de proteínas (65% de su peso) y Vitamina B12 es un excelente suplemento para los vegetarianos.\r\n    Activa las funciones cerebrales por sus aminoácidos valina, isoleucina y leucina y por las vitaminas B1, B3 y B12. Incrementa la vitalidad y la memoria.\r\n');
INSERT INTO `vidasana_listado` VALUES ('9', '3', 'Tips para acostumbrar a tu bebé a dejar el pecho y tomar mamadera ', ' ¡Toma Nota!\r\nbebe\r\nSeas madre primeriza o tengas varios hijos, el momento en que quieres que tu bebé deje el pecho y comience a tomar leche en mamadera es complejo, porque amamantar es una acción física y cálida en que madre e hijo están cerca y muchas madres temen que este cambio sea resistido por el bebé.\r\n\r\nAlgunos bebés, además, comen poco cuando su madre no está en casa, ya que ellos pueden olerla hasta a 6 metros de distancia, y darse cuenta que tú y la leche materna están cerca, aunque estés en otra pieza o en el patio. Existen, también, bebés que prefieren la posición de mamar aunque beban leche desde una botella, mientras que otros se sentirán incómodos de esa manera.\r\n\r\nEspera hasta cuatro semanas, toda vez que la lactancia esté bien establecida, antes que termine tu postnatal para comenzar a darle mamadera y así acostumbrarlo, adecuarte al cambio y además resolver con tiempo cualquier inconveniente que pudiera surgir. Prueba varias posiciones mientras miras al bebé a los ojos, para darle a tu pequeño la oportunidad de habituarse de a poco a esta experiencia nueva para él.\r\n\r\nPuede que a tu bebé le tome algo de tiempo acostumbrarse al nuevo tipo de succión de la leche, ya que requiere movimientos de boca y lengua diferentes al amamantamiento.\r\n\r\nOfrécele la mamadera un poco antes de la hora en que siempre la toma, ya que de esta forma tendrá apetito pero no estará hambriento, y se frustrará menos al no sentir la calidez del pezón materno.\r\n\r\nTambién, te recomendamos que sea otra persona la que le dé su primera mamadera, pues se confundirá menos que si lo haces tú, puesto que quizás se pregunte por qué no lo estás amamantando.\r\n\r\nAunque sabemos que es difícil, no te asustes si tu bebé come menos cuando no estás en casa y empiezan a despertar con más frecuencia por la noche. Aprovecha estos momentos con calma, para reconectar con tu bebé y facilitar esta transición.');
INSERT INTO `vidasana_listado` VALUES ('10', '1', 'Consejos para hidratación en el deporte', ' Las bebidas reconstituyentes son de mucha ayuda ya que no solo aportan líquido sino que también electrolitos y carbohidratos que favorecen la recuperación de energía y sales pérdidas durante el ejercicio.\r\nHidratacion Deportiva\r\n\r\nUn concepto fundamental que debemos tener claro es que el cuerpo humano está compuesto en un 60% de agua, por lo que el consumo de líquido antes, durante y después de la actividad física es básico.\r\n\r\nLas bebidas reconstituyentes son de mucha ayuda ya que no solo aportan líquido, sino que también electrolitos y carbohidratos que favorecen la recuperación de energía y sales pérdidas durante el  ejercicio.\r\n\r\nAlgunos consejos a la hora de seleccionar la bebida reconstituyente o rehidratante son:\r\n\r\n    Tener una precaución con los tipos de carbohidratos que consumimos en estas bebidas hidratantes, ya que altas concentraciones de carbohidratos simples como  glucosa, fructosa enlentecen el vaciado gástrico con consecuencia como pesadez, malestar o dolor estomacal mermando el rendimiento.\r\n    Preferir las que nos proporcionan carbohidratos más complejos como Maltodextrina.\r\n    Es importante que las bebidas isotónicas tengan una temperatura que sea agradable para quien las consume, ni muy frías ni muy tibias, la idea es que sean refrescantes.\r\n    Siempre debes considerar que la velocidad de deshidratación es mucho mayor que la velocidad de hidratación, por lo que es importante que estés  bien hidratado antes de la práctica deportiva.\r\n    Un estándar en  hidratación en deportes más bien aeróbicos, como por ejemplo el Body Jump y Body combat, es tomar entre 120 a 200 ml de agua o bebida reconstituyente cada 15 a 20 minutos, de esta forma te mantendrás bien hidratado.\r\n    Y finalmente, nunca permitas presentar sensación de sed.\r\n\r\n\r\nSabías que para conocer tu nivel de hidratación simplemente debes observa tú orina:\r\n\r\n    Si la orina esta turbia, muy concentrada o es poco volumen significa que estas  mal hidratado\r\n    Si la orina tiene un volumen promedio y es clara  significa que estas bien hidratado');
INSERT INTO `vidasana_listado` VALUES ('11', '1', 'Consejos de nutrición deportiva', ' No existe nada mejor para obtener un buen control de peso que comer varias veces al día, ideal entre 5 a 6 porciones balanceadas en nutrientes y alimentos saludables.\r\nAlimentacion Deportiva\r\n\r\nUna nutrición balanceada es fundamental para todo tipo de persona, la vida es cuestión de equilibrio por lo que conseguir una buena ingesta diaria de carbohidratos, proteínas, lípido, minerales y vitaminas, es fundamental.\r\n\r\nNo existe nada mejor para obtener un buen control de peso que comer varias veces al día, ideal entre 5 a 6 porciones,  balanceadas en nutrientes y alimentos saludables. Es muy frecuente que la ingesta de calorías sea mayor a las que se requieren diariamente, lo que repercute en alteraciones en el peso.\r\nLa alimentación en la práctica deportiva:\r\n\r\n    Conlleva a un mayor gasto energético\r\n    Se debe suplir esta demanda de nutriente de forma cuantitativa y equilibrada en variedad:\r\n        Carbohidratos: 60-65%\r\n        Lípido: 25-30%\r\n        Proteínas: 10-15%\r\n        Minerales y Vitaminas según Dosis Diaria Recomendada\r\n        Agua.\r\n\r\nEstos porcentajes pueden variar según la el tipo de deporte a practicar por ejemplo:\r\n\r\n    Los nadadores para lograr mayor flotabilidad tienen un porcentaje de grasa mayor que un boxeador o futbolista en los cuales predomina más el porcentaje de masa muscular para optimizar mayor velocidad y potencia. Por lo que la ingesta diaria de alimentos puede variar entre ellos.\r\n    En general para cualquier práctica deportiva, ya sean clases típicas en los GYM como: Body Combat, Body Pump, Body Jump, es fundamental tener reservas de glucosa para poder obtener energía rápida, ya que son ejercicios continuados por tiempos prolongados y que presentan demandas energéticas altas. Esto lo puedes lograr consumiendo  entre media hora  a una hora antes unos 30 a 60 gramos de carbohidratos denominados buenos (pastas, arroz, pan), evitar los considerados malos (papas fritas, caramelos, rosquillas).\r\n    Post práctica deportiva, priorizar el consumo de proteínas para la recuperación y formación muscular.');
INSERT INTO `vidasana_listado` VALUES ('12', '1', 'Aclara tus dudas de sobre el cáncer de mamas', ' Queremos aclarar todas tus dudas sobre el cáncer de mamas, enseñándote qué factores influencian su aparición, cuáles son los grupos de riesgo, sus síntomas y cómo se previene.\r\nCáncer Mama\r\n\r\n¿Qué es el cáncer?\r\n\r\nEl cáncer a nivel general es una enfermedad caracterizada por una división y crecimiento descontrolado de células anormales, que poseen la capacidad de invadir tejidos y órganos de alrededor, viajan por la sangre y el líquido linfático hasta otros órganos más alejados y crecen en ellos.\r\n\r\n¿Por qué se produce el cáncer?\r\n\r\nLas razones de porqué se produce el cáncer aún no están bien esclarecidas, se han identificado varios factores:\r\n\r\n    Herencia.\r\n    Exposición a sustancias químicas (por ejemplo, el fumar o los hábitos alimenticios),\r\n    La radiación.\r\n    Algunos virus o bacterias.\r\n\r\nEspecíficamente el cáncer de mamas corresponde a la segunda causa de muerte por tumores cancerígenos en las mujeres chilenas.\r\n\r\n¿Cuáles son los grupos de riesgo para el cáncer de mamas?\r\n\r\nInvestigaciones han demostrado que en mujeres aumentan las posibilidades de desarrollar cáncer de mama cuando tiene:\r\n\r\n    Edad avanzada.\r\n    Menstruación a temprana edad.\r\n    Edad avanzada al momento del primer parto o no haber tenido hijos.\r\n    Historial de cáncer de mama o enfermedad de mama benigna (no cancerosa).\r\n    Madre o hermana con cáncer de mama.\r\n    Tratamiento con radioterapia en mama/pecho.\r\n    Tejido de mama que muestra ser denso en la mamografía.\r\n    Uso de hormonas como estrógeno y progesterona.\r\n\r\n¿Cuáles son los síntomas del cáncer de seno?\r\n\r\nEn su generalmente no causa ningún dolor, y es posible que no se presente síntoma alguno. Sin embargo, conforme crece el cáncer, puede causar cambios a los que debe poner especial atención:\r\n\r\n    Presencia de una masa o engrosamiento en la mama, cerca de ésta o en el área de la axila.\r\n    Cambio en el tamaño o forma de la mama.\r\n    Secreción, sensibilidad del pezón, o pezón hundido hacia dentro del mama.\r\n    Pliegues u hoyuelos en la mama (la piel asemeja la de una naranja)\r\n    Cambio en la forma como se ve o se siente la piel de la mama, de la aureola o del pezón (por ejemplo, caliente, hinchada, roja o escamosa.\r\n\r\nPor lo general estos síntomas se deben a otras causas diferentes del cáncer, pero es importante verificar con el médico para un diagnostico acabado y comenzar un tratamiento tan pronto como sea posible.\r\n\r\n¿Qué exámenes se pueden hacer para detectar el cáncer de mamas?\r\n\r\nTambién la realización de exámenes regularmente ayuda a prevenir la aparición del cáncer de mamas o su pronta detección. Éstos son:\r\n\r\nPalpación. Generalmente, las masas benignas se sienten diferentes a las masas malignas o cancerosas.   Al   tocar   y   examinar   con   las   manos   el   bulto   y  los  tejidos  de  su  alrededor, se puede obtener información relevante (tamaño, textura y sí se mueve fácilmente). Puedes encontrar un completo tutorial aquí.\r\n\r\nMamografía. Es una radiografía de la mama. Actualmente tiene dos propósitos básicos: detección temprana (detecta alteraciones o lesiones dentro del tejido mamario antes de que sean palpables por la paciente o por algún especialista) o diagnóstico (para establecer la naturaleza de la alteración).\r\n\r\n Ecografía. La ecografía utiliza ondas de sonido. Es  complementario a la mamografía, y ayuda a determinar la densidad de un posible tejido anormal.\r\n\r\n ¿Cómo se previene el cáncer de mamas?\r\n\r\n La prevención del cáncer de mama se basa en un diagnóstico oportuno que permita realizar un tratamiento efectivo en una etapa precoz de la enfermedad.');
INSERT INTO `vidasana_listado` VALUES ('13', '1', 'Venta directa de Anticonceptivo de emergencia o píldora del día después', ' Los medicamentos que contengan levonorgestrel en presentaciones de 0,75 y 1,5mg, conocidos también como la píldora del día después, cambian su condición de venta de receta médica retenida a venta directa.\r\nPildora dia despues\r\n\r\nDurante el mes de septiembre de acuerdo a la resolución N°3094 del Instituto de Salud Pública, los medicamentos que contengan levonorgestrel en presentaciones de 0,75 y 1,5mg, conocidos también como la píldora del día después, cambian su condición de venta de receta médica retenida a venta directa.\r\n\r\nPero con la venta directa sin receta son muchas las dudas que te puedes plantear, ¿cuándo es efectivo su uso? Y ¿qué contraindicaciones puede tener para la salud de la mujer?, por eso acá te ayudamos con algunos datos que te pueden ayudar.\r\n\r\n¿Cuándo tomarla?\r\n\r\nLo primero es enfatizar que como lo menciona su nombre es un método de “emergencia” y que no se debe usar regularmente. Se recomienda siempre adoptar un método de anticoncepción regular y de acuerdo a las necesidades de cada mujer, y sólo usar la píldora del día después como último recurso.\r\n\r\nEn el caso de requerir el método de emergencia, esta debe ser tomada antes de 72 horas después del encuentro sexual. Así, la píldora actuará bloqueando la ovulación y alterando el ciclo menstrual para imposibilitar un eventual embarazo.\r\n\r\nEl Instituto de Salud Pública informa:\r\n\r\n    Existe una amplia experiencia de uso del producto en países que poseen un sistema de alta vigilancia sanitaria (EEUU,  Francia y España), en los que se expende sin receta médica.\r\n    En Chile, a 10 años de su lanzamiento, la farmacovigilancia del medicamento no registra notificaciones negativas.\r\n    Se considera un método anticonceptivo seguro y eficaz, cuando se utiliza en forma ocasional.\r\n\r\nConsideraciones de uso\r\n\r\n    La anticoncepción de emergencia es un método de uso ocasional. En ningún caso debe sustituir a un método anticonceptivo.\r\n    El porcentaje de falla del método es más alto que el de los métodos anticonceptivos de uso regular.\r\n    Reacciones adversas más frecuentes: náuseas y vómitos. Contraindicaciones: No tiene.\r\n    Dosis recomendada: 1 comprimido de 1.5 mg tan pronto como sea posible, o bien 1 comprimido de 0.75 mg tan pronto como sea posible y repetir a las 12 horas. No existe diferencia de eficacia entre estas formas de uso.\r\n');
