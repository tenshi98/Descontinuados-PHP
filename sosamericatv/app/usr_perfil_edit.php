...
ejecutivos.ciudad_ejecutiv AS region,
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <select name="region" required="required" class="ciudad_ejecutiv">
		<option value='<?=$rowusr['region']?>'><?=$rowusr['region']?></option>
		<?php //consulta
		$SQL_comuna=" SELECT descripcion FROM regiones  order by  descripcion asc";
		$comuna=mysql_query($SQL_comuna,$dbConn); 
		while($fila_comuna=mysql_fetch_array($comuna)) {?>
		<option value="<?php echo $fila_comuna["descripcion"]; ?>" <?php if($fila_comuna["descripcion"]==$rowusr['ciudad']){echo 'selected="selected"';}?>><?php echo $fila_comuna["descripcion"]; ?></option>
		<?php } ?>
	</select>
	</div>
   ...
   <tr>
    ...
    <select name="ciudad_ejecutiv" required="required" class="ciudad_ejecutiv">
		<option value='<?=$rowusr['ciudad']?>'><?=$rowusr['ciudad']?></option>
		<?php //consulta
