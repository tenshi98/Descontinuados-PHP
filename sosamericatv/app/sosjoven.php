...
<h2>Sos Joven</h2>
	<table width="100%" border="0" height="52%" cellspacing="6" cellpadding="5"  valign="middle">
	<tr>
	<td width="45%" height="20%"  align="center" bgcolor="#08298A" class="sombra_interna esquina_red_bot padding_bot">
	<!-- UBICACION -->
		<a href="http://<?=$nombreurl?>/app/sosjoven_02.php?longitud=<?=$_GET["longitud"]?> &latitud=<?=$_GET["latitud"]?> &imei=<?=$_GET["imei"]?> &id=<?=$_GET["id"]?>&activacion=ubicacion" target="_self">	<img src="images/ubicacion.png" width="100%" id="Image3" border=0 /></a>
	<!-- UBICACION -->
	</td>
	<td width="45%" height="20%"  align="center" bgcolor="#6A0888" class="sombra_interna esquina_red_bot padding_bot">
	<!-- LLEGUE -->
		<a href="http://<?=$nombreurl?>/app/sosjoven_02.php?longitud=<?=$_GET["longitud"]?> &latitud=<?=$_GET["latitud"]?> &imei=<?=$_GET["imei"]?> &id=<?=$_GET["id"]?>&activacion=llegue" target="_self">	<img src="images/llegue.png" width="100%" id="Image3" border=0 /></a>
	<!-- LLEGUE -->
	</td>	
	</tr>
	...
	<!-- UBICACION -->
		<a href="http://<?=$nombreurl?>/app/sosjoven_02.php?longitud=<?=$_GET["longitud"]?> &latitud=<?=$_GET["latitud"]?> &imei=<?=$_GET["imei"]?> &id=<?=$_GET["id"]?>&activacion=transporte" target="_self">	<img src="images/transporte.png" width="100%" id="Image3" border=0 /></a>
	<!-- UBICACION -->
	</td>
	<td width="45%" height="20%"  align="center" bgcolor="#173B0B" class="sombra_interna esquina_red_bot padding_bot">
	<!-- LLEGUE -->
		<a href="http://<?=$nombreurl?>/app/sosjoven_02.php?longitud=<?=$_GET["longitud"]?> &latitud=<?=$_GET["latitud"]?> &imei=<?=$_GET["imei"]?> &id=<?=$_GET["id"]?>&activacion=llamame" target="_self">	<img src="images/llamame.png" width="100%" id="Image3" border=0 /></a>
	<!-- LLEGUE -->
	</td>	
	</tr>
	</table>
