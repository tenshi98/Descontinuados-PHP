...
<?
	...
	$sql2="SELECT * FROM mensajes where  LEFT( fecha_hora, 10 ) ='".$_POST["fecha"]."' order by fecha_hora desc LIMIT 0, 10"; 
...
{ 
		...
		$sql3="SELECT * FROM ejecutivos where  id_ejecutiv=".$registro["gcmcode"]; 
