...
$query = "SELECT activaciones.id_sms,ejecutivos.nom_ejecutiv,activaciones.tipo_llamada,activaciones.fecha_hora,	activaciones.lat,	activaciones.lon FROM `activaciones` LEFT JOIN ejecutivos    ON ejecutivos.id_ejecutiv     = activaciones.id_usuario ".$z." ORDER BY activaciones.id_sms DESC LIMIT 200";
?>
...
while ( $row = mysql_fetch_assoc ($resultado)) {
	...
	map.addMarker({
        lat: <?=$lat?>,
        lng: <?=$lon?>,
        title: '<?=$row["nom_ejecutiv"]?> - <?=$fecha_hoy?>',
...
<div class="col-lg-12">
  ...
  <tr>
    <td width="581" rowspan="4" align="center" valign="middle">
        ...
        <span class="google_fjalla_gde">Ultimas 200 Activaciones</span>
	</td></tr>
</table> 
