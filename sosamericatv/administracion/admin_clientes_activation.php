...
if (isset($_GET['search'])){
	$z="WHERE ejecutivos.nom_ejecutiv LIKE '%{$_GET['search']}%' and estado_usr='0'";	
} else {
	$z="WHERE estado_usr='0'";
}
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
	 ...
	 echo $row_ultima_alarma["fecha_hora"]; ?></td>
            ...
            //Creacion de variable de anclaje
           	$w='&anclaje='.$usuarios['id_ejecutiv'];	
			?>      				
            <ul class="interruptor">   

                <li class="primer_int on"><a href="#">OFF</a></li>
                <li class="ultimo_int"><a href="<?php echo $location.'&id='.$usuarios['id_ejecutiv'].'&estado=1'.$w ; ?>">ON</a></li>
