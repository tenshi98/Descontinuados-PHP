...
$original = "mnt_social_atencion.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_social_antecedentes.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_social_antecedentes_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_social_antecedentes.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_social_antecedentes.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_social_antecedentes_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_social_antecedentes.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_social_antecedentes.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion motivo de Atencion</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion motivo de Atencion
...
<div id="txf_03" class="alert_sucess">  
	Requisito Modificado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Requisito borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de Requisito</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idAntecedente">
...
//Creo la variable con la ubicacion
	$z="WHERE idAntecedente>'0' ";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z .="AND Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idAntecedente FROM `mnt_social_antecedentes` ".$z."";
...
<label class="control-label col-lg-4">Buscar Requisito</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Requisito</a><?php }?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Requisitos </h5>
		</header>
    ...
    <?php foreach ($arrCatpem as $catpem) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $catpem['idAntecedente']; ?></td>
			<td class=" "><?php echo $catpem['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$catpem['idAntecedente']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$catpem['idAntecedente'];?>
