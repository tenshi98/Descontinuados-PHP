...
//Traspaso de valores input a variables
	...
	if ( !empty($_POST['Ubicacion_x']) )          $Ubicacion_x 	        = $_POST['Ubicacion_x'];
	if ( !empty($_POST['Ubicacion_y']) )          $Ubicacion_y 	        = $_POST['Ubicacion_y'];
	if ( !empty($_POST['Tipo_propiedad']) )       $Tipo_propiedad 	    = $_POST['Tipo_propiedad'];
