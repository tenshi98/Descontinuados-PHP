...
//Se validan si existe el usuario o el email asociado de este en la base de datos
	...
	if(isset($descripcion)){
		$sql_usuario = mysql_query("SELECT descripcion FROM mnt_oirs_destino WHERE descripcion='".$descripcion."'"); 
		$n_dest = mysql_num_rows($sql_usuario);
	} else {$n_dest=0;}
	
	// Valido si el usuario existe
	if($n_dest > 0) $errors[1]  = '
...
//Validaciones de ingreso de datos obligatorios
	...
	<div id="txf_02" class="alert_error">  
	  	No ha ingresado la descripcion del Destino
