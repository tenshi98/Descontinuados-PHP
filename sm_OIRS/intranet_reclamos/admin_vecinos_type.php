...
$location = "admin_vecinos_type.php";
$location = $original;
/**********************************************************************************************************************************/
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Modificacion Tipo de Clientes</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Modificacion Tipo de Clientes
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion Tipo de Cliente de <?php echo $rowdata['Nombre']; ?></h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
        
        	<div class="form-group">
				<label for="text2" class="control-label col-lg-4">Tipo de Cliente</label>
				<div class="col-lg-8">
...
if (isset($_GET['search'])){
	$z="WHERE clientes_listado.Nombres LIKE '%{$_GET['search']}%'";	
} else {
	$z="";
}
...
".$z."
ORDER BY clientes_listado.tipo ASC, clientes_listado.usuario ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$usuarios['idCliente']; ?>" title="Editar Tipo de Usuario" class="icon-editar info-tooltip"></a><?php } ?>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
