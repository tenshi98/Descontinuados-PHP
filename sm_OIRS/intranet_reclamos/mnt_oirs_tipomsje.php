...
$original = "mnt_oirs_tipomsje.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_oirs_tipomsje.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_oirs_tipomsje_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_oirs_tipomsje.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_oirs_tipomsje.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_oirs_tipomsje_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_oirs_tipomsje.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_oirs_tipomsje.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion de Tipos de mensajes</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion de Tipos de mensajes
...
<div id="txf_03" class="alert_sucess">  
	Tipo de mensaje Creado correctamente
...
<div id="txf_03" class="alert_sucess">  
	Tipo de mensaje Modificado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Tipo de mensaje borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de Tipo de mensaje</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="id_Tipomsje">
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Tipo de mensaje</h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
        	<div class="form-group">
...
$query = "SELECT id_Tipomsje FROM `mnt_oirs_tipomsje` ".$z."";
...
<label class="control-label col-lg-4">Buscar Tipo de mensaje</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Tipo de mensaje</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrTipo as $mensaje) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $mensaje['id_Tipomsje']; ?></td>
			<td class=" "><?php echo $mensaje['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$mensaje['id_Tipomsje']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$mensaje['id_Tipomsje'];?>
