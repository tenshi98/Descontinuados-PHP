...
Source Database       : eduka_cursos

Target Server Type    : MYSQL
Target Server Version : 50620
File Encoding         : 65001

Date: 2016-04-29 20:49:25
*/
...
-- ----------------------------
-- Table structure for clientes_cursos_capitulos_comentarios
-- ----------------------------
DROP TABLE IF EXISTS `clientes_cursos_capitulos_comentarios`;
CREATE TABLE `clientes_cursos_capitulos_comentarios` (
...
-- ----------------------------
-- Records of clientes_cursos_capitulos_comentarios
-- ----------------------------
INSERT INTO `clientes_cursos_capitulos_comentarios` VALUES ('1', '2', '1', '92', '2016-03-31', 'asddasd');

-- ----------------------------
-- Table structure for clientes_cursos_capitulos_evaluaciones
-- ----------------------------
DROP TABLE IF EXISTS `clientes_cursos_capitulos_evaluaciones`;
CREATE TABLE `clientes_cursos_capitulos_evaluaciones` (
  `idRespuestas` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idCliente` int(11) unsigned NOT NULL,
  `idProducto` int(11) unsigned NOT NULL,
  `idCapitulo` int(11) unsigned NOT NULL,
...
-- ----------------------------
-- Records of clientes_cursos_capitulos_evaluaciones
-- ----------------------------
INSERT INTO `clientes_cursos_capitulos_evaluaciones` VALUES ('1', '2', '1', '9', '1');
...
INSERT INTO `clientes_cursos_capitulos_vistos` VALUES ('2', '2', '1', '9', '1');
INSERT INTO `clientes_cursos_capitulos_vistos` VALUES ('3', '2', '1', '92', '1');
INSERT INTO `clientes_cursos_capitulos_vistos` VALUES ('4', '2', '1', '93', '1');
...
-- ----------------------------
-- Table structure for productos_listado_quiz
-- ----------------------------
DROP TABLE IF EXISTS `productos_listado_quiz`;
CREATE TABLE `productos_listado_quiz` (
  `idQuiz` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idQuizMain` int(11) unsigned NOT NULL,
  `Pregunta` text NOT NULL,
  `idCorrecta` int(11) unsigned NOT NULL,
...
-- ----------------------------
-- Records of productos_listado_quiz
-- ----------------------------
INSERT INTO `productos_listado_quiz` VALUES ('2', '0', 'aszczxc', '1', 'zxc', 'asd', 'xzcz', 'zxc');
INSERT INTO `productos_listado_quiz` VALUES ('3', '0', 'sdfsdf', '1', 'sdf', 'qwe', 'rty', 'jkl');
INSERT INTO `productos_listado_quiz` VALUES ('4', '3', 'sdfsdfs sdfsdf', '1', 'sdf', 'sdf', 'sdf', 'sdf');
INSERT INTO `productos_listado_quiz` VALUES ('5', '3', 'FDGDFGFD', '3', 'DFGFDGFD', 'DFGDFGDFG', 'DFGDFGDFG', 'DFGDFGDFG');

-- ----------------------------
-- Table structure for productos_listado_quiz_correcta
-- ----------------------------
DROP TABLE IF EXISTS `productos_listado_quiz_correcta`;
CREATE TABLE `productos_listado_quiz_correcta` (
  `idCorrecta` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(10) NOT NULL,
  PRIMARY KEY (`idCorrecta`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of productos_listado_quiz_correcta
-- ----------------------------
INSERT INTO `productos_listado_quiz_correcta` VALUES ('1', '1');
INSERT INTO `productos_listado_quiz_correcta` VALUES ('2', '2');
INSERT INTO `productos_listado_quiz_correcta` VALUES ('3', '3');
INSERT INTO `productos_listado_quiz_correcta` VALUES ('4', '4');

-- ----------------------------
-- Table structure for productos_listado_quiz_main
-- ----------------------------
DROP TABLE IF EXISTS `productos_listado_quiz_main`;
CREATE TABLE `productos_listado_quiz_main` (
  `idQuizMain` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `idProducto` int(11) unsigned NOT NULL,
  `Titulo` text NOT NULL,
  PRIMARY KEY (`idQuizMain`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of productos_listado_quiz_main
-- ----------------------------
INSERT INTO `productos_listado_quiz_main` VALUES ('2', '9', 'aszczxc');
INSERT INTO `productos_listado_quiz_main` VALUES ('3', '1', 'sadasd');
INSERT INTO `productos_listado_quiz_main` VALUES ('4', '1', 'ssssqqq');
...
INSERT INTO `productos_listado_sesion` VALUES ('27', '9', 'Test');
...
-- ----------------------------
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('1', '1', 'Introduccion', '00:05:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_02.jpg', '1_cursoId=1_cap_Clase 1 - Introduccion.mp4', 'sadasdasd', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('2', '2', 'Breve historia del HTML5', '00:04:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_01.jpg', '1_cursoId=1_cap_Clase 2 - Breve historia del HTML5.mp4', 'asdasd', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('3', '3', 'HTML Pagina Basica', '00:09:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_01.jpg', '1_cursoId=1_cap_Clase 3 - HTML Pagina Basica.mp4', 'dd', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('4', '3', 'HTML etiquetas estructurales', '00:15:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_01.jpg', '1_cursoId=1_cap_Clase 4 - HTML etiquetas estructurales.mp4', 'd', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('5', '3', 'Desarrollar una pagina web de una columna con HTML5', '00:18:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_01.jpg', '1_cursoId=1_cap_Clase 5 - desarrollar una pagina web de una columna con HTML5.mp4', 'A', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('6', '3', 'Manejo de contenidos dentro de una pagina con HTML5', '00:22:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_01.jpg', '1_cursoId=1_cap_Clase 6 - Manejo de contenidos dentro de una pagina con HTML5.mp4', '', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('7', '3', 'Formato de una pagina con dos columnas con HTML5', '00:27:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_02.jpg', '1_cursoId=1_cap_Clase 7 - Formato de una pagina con dos columnas con HTML5.mp4', '', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('8', '3', 'Pagina con HTML5 de tres columnas', '00:15:00', '1_cursoId=1_cap_0102-paginaenhtml5_page_02.jpg', '1_cursoId=1_cap_Clase 8 - Pagina con HTML5 de tres columnas.mp4', '', '1', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('9', '4', 'Quiz', '00:26:00', '', '', 'Responde correctamente las preguntas:', '1', '2', '2', '3', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('93', '4', 'preguntas abiertas', '00:00:00', '', '', 'sadasd', '1', '1', '4', '0', 'asdasd');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('10', '5', 'Bienvenida', '00:01:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 1 - Bienvenida.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('11', '5', 'Uso de archivos', '00:01:00', '', '', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('14', '6', 'Gestión de archivos', '00:06:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 5 - Gestión de archivos.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('12', '6', 'Características de Brackets', '00:05:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 3 - Características de Brackets.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('13', '6', 'Interfaz', '00:03:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 4 - Interfaz.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('15', '6', 'Live Development', '00:05:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 6 - Live Development.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('16', '6', 'Quick Edit', '00:06:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 7 - Quick Edit.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('17', '6', 'Quick Edit en transiciones CSS', '00:06:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 8 - Quick Edit en transiciones CSS.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('18', '6', 'Quick View', '00:03:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 9 - Quick View.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('19', '6', 'Live Highlight - Find Definition', '00:05:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 10 - Live Highlight - Find Definition.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('20', '6', 'Quick Docs', '00:03:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 11 - Quick Docs.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('21', '6', 'Instalar extensiones', '00:05:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 12 - Instalar extensiones.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('22', '6', 'Usar extensiones', '00:04:00', '1_cursoId=2_cap_115778_ad87_6.jpg', '1_cursoId=2_cap_Clase 13 - Usar extensiones.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('23', '7', 'Edge Code', '00:02:00', '_cursoId=2_cap_115778_ad87_6.jpg', '_cursoId=2_cap_Clase 14 - Edge Code.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('24', '7', 'Interfaz y uso de fuentes web', '00:05:00', '_cursoId=2_cap_115778_ad87_6.jpg', '_cursoId=2_cap_Clase 15 - Interfaz y uso de fuentes web.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('25', '7', 'Edge Inspect', '00:03:00', '_cursoId=2_cap_115778_ad87_6.jpg', '_cursoId=2_cap_Clase 16 - Edge Inspect.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('26', '7', 'Adobe Kuler', '00:04:00', '_cursoId=2_cap_115778_ad87_6.jpg', '_cursoId=2_cap_Clase 17 - Adobe Kuler.mp4', '', '2', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('27', '8', 'Introducción al Curso ', '00:10:00', '', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 1.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('28', '8', 'Conceptos Básicos de Desarrollo Web', '00:09:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 2.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('29', '8', 'Otros Cursos en Español de Zenva', '00:05:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 3.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('30', '9', 'Títulos y Párrafos', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 4.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('31', '9', 'Links ', '00:04:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 5.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('32', '9', 'Imágenes ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 6.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('33', '9', 'Listas ', '00:05:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 7.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('34', '9', 'Tablas ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 8.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('35', '9', 'Formularios ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 9.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('36', '9', 'Tipos de Inputs ', '00:02:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 10.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('37', '9', 'Área de Texto ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 11.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('38', '9', 'Listas de Selección ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 12.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('39', '9', 'Estructura de un Documento HTML ', '00:07:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 13.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('40', '9', 'Estructura del Proyecto ', '00:06:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 14.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('41', '10', ' 	 Incluyendo el CSS', '00:05:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 15.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('42', '10', 'Selecciones ', '00:03:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 16.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('43', '10', 'reset.css ', '00:05:00', '1_cursoId=3_cap_81372_0fe9_5.jpg', '1_cursoId=3_cap_Como Programar para Emprendedores - HTML y CSS 17.mp4', '', '3', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('44', '11', 'Como comprar un dominio / hospedaje, conectar las cuentas, e instalar WordPress. ', '00:18:00', '1_cursoId=4_cap_82004_7feb_4.jpg', '1_cursoId=4_cap_Clase 1.mp4', '', '4', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('45', '11', 'Como añadir paginas, posts, widgets, una barra lateral, y temas a tu pagina web. ', '00:32:00', '1_cursoId=4_cap_82004_7feb_4.jpg', '1_cursoId=4_cap_Clase 2.mp4', '', '4', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('46', '11', 'Cómo agregar Facebook, Google Maps, botones de PayPal, y mas. ', '00:37:00', '1_cursoId=4_cap_82004_7feb_4.jpg', '1_cursoId=4_cap_Clase 3.mp4', '', '4', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('47', '12', 'Instalación en cPanel (Parte 1) ', '00:09:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 2 - Instalacion en cPanel (Parte 1).mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('48', '12', 'Instalación en cPanel (Parte 2) ', '00:10:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 3 - Instalacion en cPanel (Parte 2).mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('49', '12', 'Instalación en MAMP ', '00:08:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 4 - Instalacion en MAMP.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('50', '12', 'El escritorio de WordPress ', '00:08:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 5 - El escritorio de WordPress.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('51', '12', 'Actualizando desde el escritorio ', '00:05:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 6 - Actualizando desde el escritorio.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('52', '13', 'Diferencia entre Entradas y Páginas ', '00:02:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 7 - Diferencia entre Entradas y Páginas.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('53', '13', 'Publicando una entrada (Parte 1) ', '00:09:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 8 - Publicando una entrada (Parte 1).mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('54', '13', 'Publicando una entrada (Parte 2) ', '00:07:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 9 - Publicando una entrada (Parte 2).mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('55', '13', 'Insertando una imagen ', '00:06:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 10 - Insertando una imagen.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('56', '13', 'Crear galerías de imágenes ', '00:08:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 11 - Crear galerias de imagenes.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('57', '14', 'Ajustando la página de inicio ', '00:16:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 20 - Ajustando la pagina de inicio.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('58', '14', 'Gestionando los comentarios ', '00:04:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 21 - Gestionando los comentarios.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('59', '14', 'Ajustes generales, escritura y lectura ', '00:02:00', '1_cursoId=5_cap_115234_b2d9_10.jpg', '1_cursoId=5_cap_Clase 22 - Ajustes generales, escritura y lectura.mp4', '', '5', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('60', '15', 'Introducción a MySQL ', '00:05:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 2 - Introduccion a MySQL.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('61', '15', 'Términos básicos sobre bases de datos ', '00:11:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 3 - Terminos basicos sobre bases de datos.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('62', '15', 'Conceptos generales sobre diseño de bases de datos ', '00:08:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 4 - Conceptos generales sobre diseño de bases de datos.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('63', '15', 'Tipos de datos en MySQL ', '00:02:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 5 - Tipos de datos en MySQL.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('64', '16', 'El lenguaje estructurado de MySQL ', '00:05:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 13 - El lenguaje estructurado de MySQL.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('65', '16', 'Crear una base de datos en MySQL ', '00:06:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 14 - Crear una base de datos en MySQL.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('66', '16', 'Crear una tabla con SQL ', '00:05:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 15 - Crear una tabla con SQL.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('67', '17', 'La sentencia SELECT ', '00:04:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 23 - La sentencia SELECT.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('68', '17', 'Hacer una selección condicional con WHERE', '00:03:00', '1_cursoId=6_cap_150082_eace_3.jpg', '1_cursoId=6_cap_Clase 24 - Hacer una seleccion condicional con WHERE.mp4', '', '6', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('69', '18', 'Introduccion', '00:05:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 1 - Introduccion (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('70', '18', 'Instalacion de PHP', '00:07:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 2 - Instalacion de PHP (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('71', '18', 'Estandares de desarrollo (Windows)', '00:03:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 3 - Estandares de desarrollo (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('72', '18', 'Instalacion de Composer', '00:13:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 4 - Instalacion de Composer (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('73', '18', 'Creacion de un proyecto', '00:05:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 5 - Creacion de un proyecto (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('74', '18', 'Configuracion de PhpStorm', '00:03:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 6 - Configuracion de PhpStorm (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('75', '18', 'Iniciando el servidor web', '00:02:00', '1_cursoId=7_cap_165688_80c5_3.jpg', '1_cursoId=7_cap_Clase 7 - Iniciando el servidor web (Windows).mp4', '', '7', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('76', '19', 'Capitulo 1', '00:06:00', '1_cursoId=8_cap_109676_5b18_6.jpg', '1_cursoId=8_cap_Como utilizar Photoshop desde cero 1.mp4', '', '8', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('77', '19', 'Capitulo 2', '00:04:00', '1_cursoId=8_cap_109676_5b18_6.jpg', '1_cursoId=8_cap_Como utilizar Photoshop desde cero 2.mp4', '', '8', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('78', '19', 'Capitulo 3', '00:05:00', '1_cursoId=8_cap_109676_5b18_6.jpg', '1_cursoId=8_cap_Como utilizar Photoshop desde cero 3.mp4', '', '8', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('79', '20', 'Imagen digital y pixeles ', '00:03:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 1 - Imagen digital y pixeles.mp4', '', '9', '1', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('80', '20', 'Resolución ', '00:06:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 2 - Resolucion.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('81', '20', 'Formatos de imagen ', '00:18:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 3 - Formatos de imagen.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('82', '21', 'Abrir una imagen desde Photoshop ', '00:08:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 8 - Abrir una imagen desde Photoshop.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('83', '21', 'Abrir una imagen con Bridge ', '00:07:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 9 - Abrir una imagen con Bridge.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('84', '21', 'Interfaz de Bridge ', '00:11:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 10 - Interfaz de Bridge.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('85', '21', 'Configurar miniaturas en Bridge ', '00:08:00', '1_cursoId=9_cap_22870_9fde_5.jpg', '1_cursoId=9_cap_Clase 11 - Configurar miniaturas en Bridge.mp4', '', '9', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('86', '22', 'Capitulo 1', '01:00:00', '1_cursoId=10_cap_203834_464d_2.jpg', '1_cursoId=10_cap_Crea presentaciones de impacto con Prezi 1.mp4', '', '10', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('87', '22', 'Capitulo 2', '00:18:00', '1_cursoId=10_cap_203834_464d_2.jpg', '1_cursoId=10_cap_Crea presentaciones de impacto con Prezi 2.mp4', '', '10', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('88', '22', 'Capitulo 3', '00:09:00', '1_cursoId=10_cap_203834_464d_2.jpg', '1_cursoId=10_cap_Crea presentaciones de impacto con Prezi 3.mp4', '', '10', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('89', '22', 'Capitulo 4', '00:09:00', '1_cursoId=10_cap_203834_464d_2.jpg', '1_cursoId=10_cap_Crea presentaciones de impacto con Prezi 4.mp4', '', '10', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('90', '22', 'Capitulo 5', '00:14:00', '1_cursoId=10_cap_203834_464d_2.jpg', '1_cursoId=10_cap_Crea presentaciones de impacto con Prezi 5.mp4', '', '10', '0', '0', '0', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('91', '27', 'asdasdas', '03:12:00', '', '', 'asdas', '9', '1', '2', '2', '');
INSERT INTO `productos_listado_sesion_capitulo` VALUES ('92', '4', 'Debate cerrado', '00:00:00', '', '', 'responda la siguiente pregunta', '1', '0', '3', '0', 'Que vino primero, el huevo o la gallina');

-- ----------------------------
-- Table structure for productos_listado_tipo
-- ----------------------------
DROP TABLE IF EXISTS `productos_listado_tipo`;
CREATE TABLE `productos_listado_tipo` (
...
-- ----------------------------
-- Records of productos_listado_tipo
-- ----------------------------
INSERT INTO `productos_listado_tipo` VALUES ('1', 'Normal');
INSERT INTO `productos_listado_tipo` VALUES ('2', 'Quiz');
INSERT INTO `productos_listado_tipo` VALUES ('3', 'Debate Cerrado');
INSERT INTO `productos_listado_tipo` VALUES ('4', 'Preguntas Abiertas');
...
-- ----------------------------
-- Table structure for productos_redes
-- ----------------------------
DROP TABLE IF EXISTS `productos_redes`;
CREATE TABLE `productos_redes` (
  `idRedes` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre` varchar(30) NOT NULL,
  PRIMARY KEY (`idRedes`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- ----------------------------
-- Records of productos_redes
-- ----------------------------
INSERT INTO `productos_redes` VALUES ('1', 'Si');
INSERT INTO `productos_redes` VALUES ('2', 'No');
