...
/*******************************************************************************************************************/
	...
	foreach ($piezas as $valor) {
		...
		switch ($valor) {
			...
			case 'UrlApp':           if(empty($UrlApp)){           $error['UrlApp']          = 'error/No ha ingresado la UrlApp';}break;
			case 'tareasServer':     if(empty($tareasServer)){     $error['tareasServer']    = 'error/No ha seleccionado la tareasServer';}break;
...
/*******************************************************************************************************************/		
		case 'insert':
			...
			if($n1 > 0) {$error['email_principal'] = 'error/El email ya existe en el sistema';}
			...
			if($n2 > 0) {$error['Nombre'] = 'error/El Nombre ya existe en el sistema';}
