      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <?php echo '<i class="'.$rowlevel['IconoCategoria'].'"></i> '.$rowlevel['nombre_transaccion']; ?>		<!-- InstanceEndEditable --> </h3>
          </div>
        </header>
      </div>
      <div id="left">
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Permisos de <?php echo $rowdata['Nombre'] ?></h5>	
	</header>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all"><?php 
	...
	<tr> 
		...
		<td>	<?php $w='&anclaje='.$permiso['idAdmpm'];?>
			<ul class="interruptor">   
			   <?php if ( $permiso['contar']=='1' ) {?>   
				<li class="primer_int"><a href="<?php echo $location.$xxx; ?>&prm_del=<?php echo $permiso['idpermiso'].$w; ?>">OFF</a></li>
				<li class="ultimo_int on"><a href="#">ON</a></li>
			   <?php } else {?>
				<li class="primer_int on"><a href="#">OFF</a></li>
				<li class="ultimo_int"><a href="<?php echo $location.$xxx; ?>&prm_add=<?php echo $permiso['idAdmpm'].$w; ?>">ON</a></li>
			   <?php }?>    
			</ul>
		</td>
		<td>
		  <?php if ($permiso['level'] > 0){ ?>
			  <a href="<?php echo $location.$xxx.'&perm='.$permiso['idpermiso'].'&mod=1'.$w ?>" title="Solo ver"                       class="icon-number-1 info-tooltip <?php if ($permiso['level'] == 1) { echo 'icon-number-selected';} ?>"></a>
			  <a href="<?php echo $location.$xxx.'&perm='.$permiso['idpermiso'].'&mod=2'.$w ?>" title="Ver - Editar"                   class="icon-number-2 info-tooltip <?php if ($permiso['level'] == 2) { echo 'icon-number-selected';} ?>"></a>
			  <a href="<?php echo $location.$xxx.'&perm='.$permiso['idpermiso'].'&mod=3'.$w ?>" title="Ver - Editar - Crear"           class="icon-number-3 info-tooltip <?php if ($permiso['level'] == 3) { echo 'icon-number-selected';} ?>"></a>
			  <a href="<?php echo $location.$xxx.'&perm='.$permiso['idpermiso'].'&mod=4'.$w ?>" title="Ver - Editar - Crear - Borrar"  class="icon-number-4 info-tooltip <?php if ($permiso['level'] == 4) { echo 'icon-number-selected';} ?>"></a>
		  <?php } ?>
		</td> 
	</tr> 
 <?php } ?>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">		
			...
			<td class="word_break"><?php echo $usuarios['Nombre']; ?></td>
