...
<div class="col-lg-12">
    ...
    <?php foreach ($arrContactos as $cont) { ?>
    	<tr class="odd">
			...
			<td>
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$cont['idAgenda']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$cont['idAgenda'];?>
