...
PERIODO
FROM Calificacion
WHERE Id_Funcionario = {$arrUsuario['idCasChile']} AND Fecha_Cierre!=''
	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="principal_datos_calificacion.php?pagina=1" >Calificaciones</a></li>
			</ul>
		</header>
        <div class="body">
				...
				<table class="table">
					...
					<?php foreach($arrCalificacion as $calificacion) {?>
						<tr>
							...
							<td width="120px"><a target="_blank" href="view_calificacion.php?periodo=<?php echo $calificacion['PERIODO'].'&idCasChile='.$arrUsuario['idCasChile']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
						</tr>
					<?php } ?>
				</table>
				</div>	
