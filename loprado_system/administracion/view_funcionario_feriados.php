...
FROM Feriados
WHERE Id_Funcionario = {$rowdata['idCasChile']} AND Id_Periodo>=".$AnoDesde."
	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="view_funcionario_feriados.php?pagina=1&view=<?php echo $_GET['view'];?>" >Feriados</a></li>
