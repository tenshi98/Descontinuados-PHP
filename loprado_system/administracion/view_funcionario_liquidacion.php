	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="view_funcionario_liquidacion.php?pagina=1&view=<?php echo $_GET['view'];?>" >Liquidacion</a></li>
					...
					foreach ($arrLiquidacion as $Ano=>$liquidaciones) { ?>
						...
						<?php foreach($liquidaciones as $liquidacion) {?>
							<tr>
								...
								<td width="120px"><a target="_blank" href="view_liquidacion.php?periodo=<?php echo $Ano.'&mes='.$liquidacion['Mes'].'&idCasChile='.$rowdata['idCasChile']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
							</tr>
						<?php } ?>  
					<?php } ?>
				</table>
