      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-file-word-o"></i> Archivos de ayuda
...
<div class="acc-container">
	...
	<?php
	filtrar($arrArchivo, 'NombreCategoria');
	$nn=0;
	foreach($arrArchivo as $categoria=>$archivos) {
		if($nn==0){$aa='open';}else{$aa='';}
		echo '<div class="acc-btn"><h1 >Modulo '.$categoria.'</h1></div>
				<div class="acc-content '.$aa.'">
		...
		foreach($archivos as $archivo) {
			...
			echo '<tr class="odd">';
			echo '<td>'.$archivo['NombreProcedimiento'].'</td>';
			echo '<td>'.$archivo['Version'].'</td>';
			echo '<td><a href="upload/'.$archivo['Direccion_img'].'" title="Descargar Archivo" class="icon-down info-tooltip"></a></td>';
			echo '</tr>';
