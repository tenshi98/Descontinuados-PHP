...
$original = "principal_datos_licencias.php";
$location = $original;
$location .= '?d=d';
/**********************************************************************************************************************************/
...
$arrLicencias = array();
$query = "SELECT  
Fecha_Ingreso, Id_Licencia, Fec_Emision, Fec_Inicio, Fec_Termino, Fec_Recepcion, Fec_ing_isapre, Total_Dias
FROM LicenciaMedica
WHERE Id_Funcionario = {$rowdata['idCasChile']}
ORDER BY Fec_Recepcion DESC";
	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="view_funcionario_licencias.php?pagina=1&view=<?php echo $_GET['view'];?>" >Licencias</a></li>
        ...
        <div class="body">
			...
			<div class="col-lg-12">
				<h2 class="text-primary">Licencias Medicas</h2>
				<div class="table-responsive">
				<table class="table">
					<tr class="info">
						<td colspan="9">Detalle de Licencias</td>
					</tr>
					<tr class="active">
						...
						<td>Fecha prest Isapre</td>
						<td>N° Dias</td>
					</tr>
					<?php foreach($arrLicencias as $licencia) {?>
						<tr>
							<td><?php echo Fecha_estandar($licencia['Fecha_Ingreso']) ?></td>
							<td><?php echo $licencia['Id_Licencia'] ?></td>
							<td><?php echo Fecha_estandar($licencia['Fec_Emision']) ?></td>
							<td><?php echo Fecha_estandar($licencia['Fec_Inicio']) ?></td>
							<td><?php echo Fecha_estandar($licencia['Fec_Termino']) ?></td>
							<td><?php echo Fecha_estandar($licencia['Fec_Recepcion']) ?></td>
							<td><?php echo Fecha_estandar($licencia['Fec_ing_isapre']) ?></td>
							<td><?php echo $licencia['Total_Dias'] ?></td>
						</tr> 
					<?php } ?>
				</table>
				</div>	
