...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Ver Datos de la Notificacion</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Ver Datos de la Notificacion
...
$query = "SELECT Titulo,Notificacion,Fecha
...
<div class="col-lg-12">
	<div class="box">
        ...
        <div class="body">
				...
				<p class="text-muted"><?php echo $row_data['Notificacion'];?></p>
        </div>	
	</div>
</div>
