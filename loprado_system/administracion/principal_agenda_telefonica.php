      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-phone"></i> Agenda Telefonica
...
<a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Contacto</a>
</div>
    ...
    <?php foreach ($arrContactos as $cont) { ?>
    	<tr class="odd">
			...
			<td>
				...
				<a href="<?php echo $location.'&id='.$cont['idAgenda']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a>
				<?php $ubicacion=$location.'&del='.$cont['idAgenda'];?>
