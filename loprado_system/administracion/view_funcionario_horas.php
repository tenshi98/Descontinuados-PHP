...
WHERE Id_Funcionario = {$rowdata['idCasChile']} AND Vigente=0
	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="view_funcionario_horas.php?pagina=1&view=<?php echo $_GET['view'];?>" >Horas Compensatorias</a></li>
