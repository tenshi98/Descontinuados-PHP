	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="principal_datos_asistencia.php?pagina=1" >Asistencia</a></li>
				...
				<table class="table">
					...
					echo '
						<tr>
							...
							<td width="120px"><a target="_blank" href="view_asistencia.php?periodo='.$actual.'&mes='.$i.'&idCasChile='.$arrUsuario['idCasChile'].'" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
						</tr>';
					}?>
					...
					echo '
						<tr>
							...
							<td width="120px"><a target="_blank" href="view_asistencia.php?periodo='.$anterior.'&mes='.$i.'&idCasChile='.$arrUsuario['idCasChile'].'" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
						</tr>';
					}?>
