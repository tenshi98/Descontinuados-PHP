...
$original = "principal_datos_asistencia.php";
$location = $original;
$location .= '?d=d';
/**********************************************************************************************************************************/
	...
	<div class="box">
		<header>
			...
			<ul class="nav nav-tabs pull-right">
				...
				<li class="active"><a href="view_funcionario_asistencia.php?pagina=1&view=<?php echo $_GET['view'];?>" >Asistencia</a></li>
        ...
        <div class="body">
			...
			<div class="col-lg-12">
				<h2 class="text-primary">Libro de Asistencia</h2>
				<div class="table-responsive">
				<table class="table">
					<tr class="info">
						<td colspan="9">Detalle de Asistencia</td>
					</tr>
					<?php
					$actual = ano_actual();
					$anterior = ano_actual()-1;
					?>
					<tr class="active"><td colspan="2">Periodo <?php echo $actual ?></td></tr>
					<?php
					...
					echo '
						<tr>
							<td>'.$actual.' - '.numero_a_mes($i).'</td>
							<td width="120px"><a target="_blank" href="view_asistencia.php?periodo='.$actual.'&mes='.$i.'&idCasChile='.$rowdata['idCasChile'].'" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
						</tr>';
					}?>
					<tr class="active"><td colspan="2">Periodo Anterior (<?php echo $anterior ?>)</td></tr>
					<?php
					for ($i = 1; $i <= 12; $i++) {
					echo '
						<tr>
							<td>'.$anterior.' - '.numero_a_mes($i).'</td>
							<td width="120px"><a target="_blank" href="view_asistencia.php?periodo='.$anterior.'&mes='.$i.'&idCasChile='.$rowdata['idCasChile'].'" title="Ver Informacion" class="icon-ver info-tooltip"></a></td>
						</tr>';
					}?>
