...
/*******************************************************************************************************************/
	...
	//Traspaso de Fonoes input a variables
...
/*******************************************************************************************************************/
	...
	foreach ($piezas as $Fono) {
		...
		switch ($Fono) {
			...
			case 'Direccion_img':  if(empty($Direccion_img)){ $error['Direccion_img']  = 'error/No ha ingresado el nombre de la imagen';}break;
		}
	}	
/*******************************************************************************************************************/
				  ...
				  if (in_array($_FILES['imgLogo']['type'], $permitidos) && $_FILES['imgLogo']['size'] <= $limite_kb * 1024){
					...
					if (!file_exists($ruta)){
					  ...
					  if ($resultado){
							...
							$query  = "INSERT INTO `ofertas_diarias` (Titulo, Descripcion, Fono, Direccion_img) VALUES ({$a} )";
