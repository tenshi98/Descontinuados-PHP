...
if (isset($_POST['idCliente']) ) {
	...
	clientes_notificaciones.idTrabajos,
	clientes_notificaciones.Latitud,
	clientes_notificaciones.Longitud,
	...
	if(isset($arrNotificaciones)&&$arrNotificaciones!=''){
        ...
        foreach ($arrNotificaciones as $noti) {
			...
			$response["noti"][$i]["idTrabajos"]   = $noti["idTrabajos"];
			$response["noti"][$i]["Latitud"]      = $noti["Latitud"];
			$response["noti"][$i]["Longitud"]     = $noti["Longitud"];
			$response["noti"][$i]["idTipoNoti"]   = $noti["idTipoNoti"];
			$i++;
		}
