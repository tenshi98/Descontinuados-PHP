...
$original = "admin_oferta_activation.php";
$location = $original;
...
<div class="toolbar"></div>	
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Ofertador : </strong><?php echo $rowdata['nombre_cliente']; ?></p>
...
<label class="control-label col-lg-4">Buscar Ofertadores</label>
