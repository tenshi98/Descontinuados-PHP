...
if ( !empty($_POST['edit_datos']) )  { 
	...
	$form_obligatorios = 'idSistema,Nombre,Rubro,Rut,Ciudad,Comuna,Direccion,NombreContrato,NContrato,FContrato,DContrato,idTheme';
	$form_trabajo= 'update';
...
Fax, Web, Rubro, Contacto, NombreContrato,NContrato,FContrato,DContrato
FROM `core_sistemas`
