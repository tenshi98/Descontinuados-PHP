...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'email,password,Nombre,Rut,fNacimiento,idSexo,idSistema,idProfesion'; 
	$form_trabajo= 'insert';
...
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idCliente,Nombre,idSexo,idSistema,idProfesion';
	$form_trabajo= 'update';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form/clientes_listado.php';
}
//se borra un dato
...
$query = "SELECT Nombre , Rut, fNacimiento, idSexo, idSistema, Fono1, Fono2, idProfesion
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Trabajador</h5>
		</header>
		<div id="div-1" class="body">
			...
			<form class="form-horizontal" method="post" name="form1">
				...
				if(isset($idProfesion)) {  $x8 = $idProfesion;  }else{$x8 = $rowdata['idProfesion'];}
				...
				echo '<h3>Datos de Profesiones</h3>';
				echo form_select('Profesiones','idProfesion', $x8, 2, 'idProfesion', 'Nombre', 'clientes_profesiones', 0, $dbConn);
	...
	<div class="box dark">
		...
		<div id="div-1" class="body">
			...
			<form class="form-horizontal" method="post" name="form1">
				...
				if(isset($idProfesion)) {  $x10 = $idProfesion;  }else{$x10 = '';}
				...
				echo '<h3>Datos de Profesiones</h3>';
				echo form_select('Profesiones','idProfesion', $x10, 2, 'idProfesion', 'Nombre', 'clientes_profesiones', 0, $dbConn);
				...
				echo '<input type="hidden" name="Descripcion"        value="Sin Descripcion" >';
				echo '<input type="hidden" name="nEstrellas"         value="5" >';
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE clientes_listado.idSistema>=0 AND clientes_listado.idTipo=1";	
}else{
	$z="WHERE clientes_listado.idSistema={$arrUsuario['idSistema']} AND clientes_listado.idTipo=1";
}	
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Trabajador</a><?php }?>
</div>
