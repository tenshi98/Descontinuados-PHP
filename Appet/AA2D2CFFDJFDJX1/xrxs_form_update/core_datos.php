...
if ( !isset($errors[1]) && !isset($errors[2])&& !isset($errors[3])&& !isset($errors[4])&& !isset($errors[5])&& !isset($errors[6]) && !isset($errors[7]) && !isset($errors[8]) && !isset($errors[9]) && !isset($errors[10]) && !isset($errors[11])  ) {
		...
		//filtro de Dias_alcalde
		if(isset($Dias_alcalde) && $Dias_alcalde != ''){ 
        	$a .= ",Dias_alcalde='".$Dias_alcalde."'" ;
        }
		//filtro de idUsuario
		if(isset($idUsuario) && $idUsuario != ''){ 
        	$a .= ",idUsuario='".$idUsuario."'" ;
        }
		//filtro de url_principal
		if(isset($url_principal) && $url_principal != ''){ 
        	$a .= ",url_principal='".$url_principal."'" ;
        }
		//filtro de path_upload
		if(isset($path_upload) && $path_upload != ''){ 
        	$a .= ",path_upload='".$path_upload."'" ;
        }
		//filtro de idTheme
