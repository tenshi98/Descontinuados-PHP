...
//Traspaso de valores input a variables
	...
	if ( !empty($_POST['Dias_alcalde']) )     $Dias_alcalde 	 = $_POST['Dias_alcalde'];
	if ( !empty($_POST['idUsuario']) )        $idUsuario 	     = $_POST['idUsuario'];
	if ( !empty($_POST['url_principal']) )    $url_principal     = $_POST['url_principal'];
	if ( !empty($_POST['path_upload']) )      $path_upload       = $_POST['path_upload'];
