...
$query = "SELECT usuario,  email, Nombre, Rut, fNacimiento, Fono, Direccion_img,idCiudad, idComuna,idCalle, n_calle
...
<div class="col-lg-6">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Ciudad : </strong><?php echo $rowdata['nombre_ciudad']; ?></p>
