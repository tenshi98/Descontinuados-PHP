...
$original = "mnt_ubicacion_ciudad.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_ubicacion_ciudad.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_ubicacion_ciudad_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/mnt_ubicacion_ciudad.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/mnt_ubicacion_ciudad.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/mnt_ubicacion_ciudad_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/mnt_ubicacion_ciudad.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/mnt_ubicacion_ciudad.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Mantencion de Ciudades</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Mantencion de Ciudades
...
<div id="txf_03" class="alert_sucess">  
	Ciudad Modificada correctamente
	<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la Ciudad</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idCiudad">
...
<label class="control-label col-lg-4">Buscar Ciudad</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Ciudad</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Ciudades</h5>
		</header>
    ...
    <?php foreach ($arrCiudad as $ciudad) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $ciudad['idCiudad']; ?></td>
			<td class=" "><?php echo $ciudad['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$ciudad['idCiudad']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$ciudad['idCiudad'];?>
