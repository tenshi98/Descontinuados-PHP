...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/core_permisos_cat.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/core_permisos_cat_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/core_permisos_cat.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/core_permisos_cat.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/core_permisos_cat_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/core_permisos_cat.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/core_permisos_cat.php';
}
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="id_pmcat">
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCatpem as $catpem) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $catpem['id_pmcat']; ?></td>
