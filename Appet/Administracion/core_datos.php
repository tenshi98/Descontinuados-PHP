...
$query = "SELECT email_principal, Nombre, Rut, Direccion, Fono, Ciudad, Comuna, Dias_alcalde,idUsuario,url_principal,path_upload,idTheme
FROM `core_datos`
WHERE id_Datos = '1'";
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Dias para firma Alcalde</label>
				<div class="col-lg-8">
					<input type="number" name="Dias_alcalde" min="1" max="5" value="<?php echo $rowdata['Dias_alcalde']; ?>" class="form-control" required>
				</div>
			</div>
            ...
            <div class="form-group">
                ...
                <option value="<?php echo $usr['idUsuario']; ?>" 
				<?php if(isset($idUsuario)) {if($idUsuario==$usr['idUsuario']){ echo 'selected="selected"';}} else {if($rowdata['idUsuario']==$usr['idUsuario']){echo 'selected="selected"';}}?>><?php echo $usr['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">URL principal</label>
				<div class="col-lg-8">
					<input type="text" name="url_principal"  value="<?php echo $rowdata['url_principal']; ?>" class="form-control" required>
				</div>
			</div>
            
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Path upload</label>
				<div class="col-lg-8">
					<input type="text" name="path_upload"  value="<?php echo $rowdata['path_upload']; ?>" class="form-control" required>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<?php if(isset($idTheme)) {if($idTheme==$theme['idTheme']){ echo 'selected="selected"';}} else {if($rowdata['idTheme']==$theme['idTheme']){echo 'selected="selected"';}}?>><?php echo $theme['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
...
core_datos.Ciudad,  
core_datos.Comuna,  
core_datos.Dias_alcalde,
usuarios_listado.nombre AS usuario_encargado,
core_datos.url_principal,
core_datos.path_upload,
core_theme_colors.Nombre AS tema
FROM `core_datos`
LEFT JOIN `usuarios_listado`  ON   usuarios_listado.idUsuario  = core_datos.idUsuario
LEFT JOIN `core_theme_colors` ON   core_theme_colors.idTheme   = core_datos.idTheme
WHERE id_Datos = '1'";
$resultado = mysql_query ($query, $dbConn);
$rowdata = mysql_fetch_assoc ($resultado);	?>
...
<div class="col-lg-5 fcenter">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Dias para firma Alcalde : </strong><?php echo $rowdata['Dias_alcalde']; ?></p> 
            <p class="text-muted"><strong>Encargado de la creacion de las OIRS : </strong><?php echo $rowdata['usuario_encargado']; ?></p> 
            <p class="text-muted"><strong>URL principal : </strong><?php echo $rowdata['url_principal']; ?></p> 
            <p class="text-muted"><strong>Path upload : </strong><?php echo $rowdata['path_upload']; ?></p>
            <p class="text-muted"><strong>Combinacion de Colores : </strong><?php echo $rowdata['tema']; ?></p>        
