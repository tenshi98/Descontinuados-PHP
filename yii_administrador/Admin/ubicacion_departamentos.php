...
$original = "ubicacion_departamentos.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/ubicacion_departamentos.php';
}
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Departamento creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Departamento editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Departamento borrado correctamente';}
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion del Departamento</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" name="idDepartamento" value="<?php echo $_GET['id']; ?>" >
...
$query = "SELECT idDepartamento FROM `ubicacion_departamento` ".$z."";
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Departamento</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrDepartamento as $depto) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $depto['Nombre']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$depto['idDepartamento']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$depto['idDepartamento'];?>
