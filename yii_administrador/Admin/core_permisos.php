...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'id_pmcat,Direccionbase,Nombre,visualizacion';
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/core_permisos.php';
}
...
$query = "SELECT id_pmcat, Direccionbase, Nombre, visualizacion
FROM `core_permisos`
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			if(isset($visualizacion)) {        $x4  = $visualizacion;       }else{$x4  = $rowdata['visualizacion'];}
			...
			echo form_select_ext('Visualizacion','visualizacion',  $x4, 2, 'idSistema', 'Nombre', 'core_sistemas', 0, $dbConn);
			?>

			<div class="form-group">
            	<input type="hidden" name="idAdmpm" value="<?php echo $_GET['id']; ?>" >
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			if(isset($visualizacion)) {        $x4  = $visualizacion;       }else{$x4  = '';}
