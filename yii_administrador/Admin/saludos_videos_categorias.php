...
$original = "saludos_videos_categorias.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/saludos_videos_categorias.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idVideoCat,Nombre';
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/saludos_videos_categorias.php';
}
//se borra un dato
...
if ( !empty($_POST['submit_img']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'idVideoCat,img';
...
FROM `saludos_videos_categorias`
WHERE idVideoCat = {$_GET['img_id']}";
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" enctype="multipart/form-data">           
			...
			<div class="form-group">
            	<input type="hidden" name="idVideoCat" value="<?php echo $_GET['img_id']; ?>">
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" name="idVideoCat" value="<?php echo $_GET['id']; ?>" >
...
$query = "SELECT idVideoCat FROM `saludos_videos_categorias` ".$z."";
...
$arrCategoria = array();
$query = "SELECT idVideoCat,Nombre, img
FROM `saludos_videos_categorias`
".$z."
ORDER BY Nombre ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCategoria as $cat) { ?>
    	<tr class="odd">
			...
			<td>
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$cat['idVideoCat']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&img_id='.$cat['idVideoCat']; ?>" title="Editar Imagen" class="icon-editar-img info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$cat['idVideoCat'];?>
