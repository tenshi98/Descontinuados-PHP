...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'ProfDesc';
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/perfil_profesion.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'ProfCod,ProfDesc';
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/perfil_profesion.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Profesion creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Profesion editada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Profesion borrada correctamente';}
//Manejador de errores
if(isset($error)&&$error!=''){echo errors_list($error);};?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 if ( ! empty($_GET['id']) ) { 
// Se traen todos los datos de mi usuario
$query = "SELECT ProfDesc
FROM `profesion`
WHERE ProfCod = {$_GET['id']}";
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion de la Profesion</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
            ...
            if(isset($ProfDesc)) {        $x1  = $ProfDesc;       }else{$x1  = $rowdata['ProfDesc'];}

			//se dibujan los inputs
            echo form_input('text', 'Nombre', 'ProfDesc', $x1, 2); 
			?>


			<div class="form-group">
            	<input type="hidden" name="ProfCod" value="<?php echo $_GET['id']; ?>" >
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <?php 
			//Se verifican si existen los datos
            if(isset($ProfDesc)) {        $x1  = $ProfDesc;       }else{$x1  = '';}
...
if (isset($_GET['search'])){
	$z.="WHERE ProfDesc LIKE '%{$_GET['search']}%'";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT ProfCod FROM `profesion` ".$z."";
...
$query = "SELECT ProfCod,ProfDesc
FROM `profesion`
".$z."
ORDER BY ProfDesc ASC
...
<label class="control-label col-lg-4">Buscar Profesion</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Profesion</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Profesiones</h5>
		</header>
    ...
    <?php foreach ($arrDepartamento as $depto) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $depto['ProfDesc']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$depto['ProfCod']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$depto['ProfCod'];?>
