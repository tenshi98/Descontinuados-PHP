...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'usuario,password,repassword,Nombre,email,Rut,fNacimiento,idSistema';
	$form_trabajo= 'insert';
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			if(isset($tipo)) {          $x4  = $tipo;         }else{$x4  = '';}
            if(isset($Nombre)) {        $x5  = $Nombre;       }else{$x5  = '';}
            ...
            if(isset($Ciudad)) {        $x10 = $Ciudad;       }else{$x10 = '';}
            if(isset($Comuna)) {        $x11 = $Comuna;       }else{$x11 = '';}
            if(isset($Direccion)) {     $x12 = $Direccion;    }else{$x12 = '';}
			if(isset($idSistema)) {     $x13 = $idSistema;    }else{$x13 = '';}
			...
			echo form_select_tipousr('Tipo de Usuario','tipo', $x4, 2);
            echo form_input('text', 'Nombre', 'Nombre', $x5, 2); 
            echo form_input('text', 'Fono', 'Fono', $x6, 1); 
            echo form_input('text', 'Email', 'email', $x7, 2);
            echo form_input('text', 'Rut', 'Rut', $x8, 2);
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Usuario</a><?php } ?>
</div>
<div class="clearfix"></div>                       
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td>
<?php if ($rowlevel['level_ver']==1){?><a href="<?php echo $location.'&view='.$usuarios['idUsuario']; ?>" title="Visualizar" class="icon-ver info-tooltip"></a><?php } ?>
...
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$usuarios['idUsuario'];?>
