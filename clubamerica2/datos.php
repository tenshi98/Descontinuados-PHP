...
if ( !empty($_POST['edit_datos']) )  {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_4.php';
...
if ( !empty($_POST['edit_clave']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/usuarios_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_3.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/usuarios_listado_update.php';
}
?>
<!doctype html>
...
$query = "SELECT usuario, tipo, email, Nombre, Rut, fNacimiento, Fono, Direccion_img
