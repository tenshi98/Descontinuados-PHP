...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/usuarios_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_6.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/usuarios_listado.php';
}
?>
<!doctype html>
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Modificacion Tipo de Usuarios</title>
    <!-- InstanceEndEditable -->
...
if (confirm("øRealmente deseas eliminar el registro?")) {
        //EnvÌa el formulario
        location=direccion;
    } else {
        //No envÌa el formulario
       return false;
    }	
}
</script> 
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Modificacion Tipo de Usuarios
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion Tipo de usuario de <?php echo $rowdata['Nombre']; ?></h5>
		</header>
        	...
        	<div class="form-group">
				...
				<div class="col-lg-8">
					<select  class="form-control" tabindex="15" name="tipo" required >
                            ...
                            <option value="Administrador" <?php if(isset($tipo)&&$tipo=='Administrador') {echo 'selected="selected"';}else { if ($rowdata['tipo']=='Administrador') {echo 'selected="selected"';}}?>>Administrador</option>
                            <option value="Normal" <?php if(isset($tipo)&&$tipo=='Normal') {echo 'selected="selected"';}else { if ($rowdata['tipo']=='Normal') {echo 'selected="selected"';}}?>>Normal</option>
					</select>
				</div>
			</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$usuarios['idUsuario']; ?>" title="Editar Tipo de Usuario" class="icon-editar info-tooltip"></a><?php } ?>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
    ...
    <div class="row">
        <div class="col-lg-9 fcenter">
            <div class="dataTables_paginate paging_bootstrap">
                <ul class="pagination">
                	<?php if(($num_pag - 1) > 0) { ?>
                    <li class="prev"><a href="<?php echo $location.($num_pag-1).$x ?>">‚Üê Anterior</a></li>
                    <?php } else {?>
                    <li class="prev disabled"><a href="">‚Üê Anterior</a></li>
                    <?php } ?>
                    ...
                    <li class="next"><a href="<?php echo $location.($num_pag+1).$x ?>">Siguiente ‚Üí </a></li>
                    <?php } else {?>
                    <li class="next disabled"><a href="">Siguiente ‚Üí </a></li>
                    <?php } ?>
                </ul>
            </div> 
        </div>
