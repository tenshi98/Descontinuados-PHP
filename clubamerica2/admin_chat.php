...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/chats_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/chats_listado_1.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/chats_listado.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/chats_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/chats_listado_2.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/chats_listado.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/chats_listado.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Administracion de Chats</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Administrar Chats
...
<div class="col-lg-8 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Chat</h5>
		</header>
        ...
        <form class="form-horizontal" method="post" name="form1">
			...
			<div class="form-group">
				<input type="hidden" name="idChat" value="<?php echo $_GET['id']; ?>" >
...
// Se traen todos los datos de mi usuario
$query = "SELECT 
chats_listado.Nombre, 
usuarios_listado.Nombre AS nombre_usr
FROM `postulante_chats_listado`
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = chats_listado.idUsuario 
WHERE chats_listado.idChat = {$_GET['view']}";
$resultado = mysql_query ($query, $dbConn);
$rowdata = mysql_fetch_assoc ($resultado);	?>
...
<div class="col-lg-6">
	<div class="box">
		<header>
			<h5>Ver Datos del Chat</h5>
			<div class="toolbar"></div>
		</header>
        <div class="body">
            <h2 class="text-primary">Datos Basicos</h2>
            <p class="text-muted"><strong>Nombre del Chat : </strong><?php echo $rowdata['Nombre']; ?></p>
...
//Variable con la ubicacion
	$z="WHERE postulante_chats_listado.idChat!='0'";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z.="AND postulante_chats_listado.Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idChat FROM `postulante_chats_listado` ".$z."";
...
$arrRooms = array();
$query = "SELECT 
postulante_chats_listado.idChat, 
postulante_chats_listado.Nombre, 
usuarios_listado.Nombre AS nombre_usr
FROM `postulante_chats_listado`
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = postulante_chats_listado.idUsuario 
".$z."
ORDER BY Nombre ASC
...
<label class="control-label col-lg-4">Buscar Chat</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Chat</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Chats</h5>
		</header>
    ...
    <?php foreach ($arrRooms as $habitaciones) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&view='.$habitaciones['idChat']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$habitaciones['idChat']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$habitaciones['idChat'];?>
