...
WHERE postulante_chats_listado.idChat = {$_GET['view']}";
$resultado = mysql_query ($query, $dbConn);
$rowdata = mysql_fetch_assoc ($resultado);	?>
<div class="col-lg-6">
	<div class="box">
...
//Variable con la ubicacion
	$z="WHERE postulante_chats_listado.idUsuario='{$arrUsuario['idUsuario']}'";
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Chat</h5>
		</header>
