    ...
    <?php foreach ($arrRooms as $habitaciones) { ?>
    	<tr class="odd">
			...
			if ($habitaciones['estadovideo1']==0) {?>
				<a href="ver_video.php?correo=<?=$habitaciones['PostFoto1']?>" rel=shadowbox;width=640;height=360><?echo $habitaciones['PostProfesion1'];?></a><br> 
			<?}
			if ($habitaciones['estadovideo2']==0) {?>
				<a href="ver_video.php?correo=<?=$habitaciones['PostFoto2']?>" rel=shadowbox;width=640;height=360><?echo $habitaciones['PostProfesion2'];?></a><br>
			<?}
			if ($habitaciones['estadovideo3']==0) {?>
				<a href="ver_video.php?correo=<?=$habitaciones['PostFoto3']?>" rel=shadowbox;width=640;height=360><?echo $habitaciones['PostProfesion3'];?></a><br>
