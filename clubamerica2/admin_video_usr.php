...
if ( !empty($_GET['estado']) ) {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/video_usuario_estado.php';
}
?>
<!doctype html>
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Creacion de administradores Videochat</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Creacion de administradores Videochat
...
<label class="control-label col-lg-4">Buscar Usuario por Email</label>
    <div class="col-lg-5">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
            ...
            //Verifico si existe la variable de busqueda y pagina
           	$w='&anclaje='.$usuarios['PostEmail'];	
			?>      				
            <ul class="interruptor">   
               <?php if ( $usuarios['rol']=='2' ) {?>   
                <li class="primer_int"><a href="<?php echo $location.'&id_usuario='.$usuarios['id_usuario'].'&estado=1'.$w ; ?>">OFF</a></li>
                <li class="ultimo_int on"><a href="#">ON</a></li>
               <?php } else {?>
                <li class="primer_int on"><a href="#">OFF</a></li>
                <li class="ultimo_int"><a href="<?php echo $location.'&id_usuario='.$usuarios['id_usuario'].'&estado=2'.$w ; ?>">ON</a></li>
               <?php }?>    
            </ul>
