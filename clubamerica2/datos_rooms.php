...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/rooms_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/rooms_listado_1.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/rooms_listado.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/rooms_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/rooms_listado_2.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/rooms_listado.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/rooms_listado.php';
}
...
<html class="no-js"><!-- InstanceBegin template="/Templates/administrador.dwt" codeOutsideHTMLIsLocked="false" -->
  <head>
    ...
    <title>Administracion de Videochats</title>
    <!-- InstanceEndEditable -->
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Administrar Videochats
...
<div id="txf_03" class="alert_sucess">  
	Videochat Creado correctamente
...
<div id="txf_03" class="alert_sucess">  
	Videochat Modificado correctamente
	<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
<div id="txf_03" class="alert_sucess">  
	Videochat borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onClick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
$query = "SELECT Nombre
FROM `postulante_videochat_listado`
...
<div class="col-lg-8 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Videochat</h5>
		</header>
...
// Se traen todos los datos de mi usuario
$query = "SELECT 
postulante_videochat_listado.Nombre, 
usuarios_listado.Nombre AS nombre_usr
FROM `postulante_videochat_listado`
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = postulante_videochat_listado.idUsuario 
...
<div class="col-lg-6">
	<div class="box">
		<header>
			<h5>Ver Datos del Videochat</h5>
			<div class="toolbar"></div>
		</header>
        <div class="body">
            <h2 class="text-primary">Datos Basicos</h2>
            <p class="text-muted"><strong>Nombre del Videochat : </strong><?php echo $rowdata['Nombre']; ?></p>
...
//Variable con la ubicacion
	$z="WHERE postulante_videochat_listado.idUsuario='{$arrUsuario['idUsuario']}'";
//Verifico si la variable de busqueda existe
if (isset($_GET['search'])){
	$z.="AND postulante_videochat_listado.Nombre LIKE '%{$_GET['search']}%' ";	
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idRoom FROM `postulante_videochat_listado` ".$z."";
...
$arrRooms = array();
$query = "SELECT 
postulante_videochat_listado.idRoom, 
postulante_videochat_listado.Nombre, 
usuarios_listado.Nombre AS nombre_usr
FROM `postulante_videochat_listado`
LEFT JOIN `usuarios_listado`   ON usuarios_listado.idUsuario   = postulante_videochat_listado.idUsuario 
...
<label class="control-label col-lg-4">Buscar Videochat</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Videochat</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Videochats</h5>
		</header>
