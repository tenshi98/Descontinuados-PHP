...
if ( !empty($_GET['modvideo']) ) {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/video_usuario_aprobar.php';
}
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Aprobar Videos
...
$direccionWeb = 'http://pruebas2.naturalphone.cl/americatv/videoAdmin/index';?>
...
<div class="col-lg-12">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
    	...
    	<tr class="odd">
			...
			<td class=" ">
<?php if($rowdata['vid_prof1']!=''&&$rowdata['vid_aprob1']!=''){?>            
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $direccionWeb.'?view='.$_GET['view'].'&columna=vid_aprob1'; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob1&estado=2'; ?>" title="Aprobar Video" class="icon-aprobar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob1&estado=3'; ?>" title="Rechazar Video" class="icon-cancelar info-tooltip"></a><?php } ?>
<?php } ?>
			</td>
		</tr>
        ...
        <tr class="odd">
			...
			<td class=" ">
<?php if($rowdata['vid_prof2']!=''&&$rowdata['vid_aprob2']!=''){?>            
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $direccionWeb.'?view='.$_GET['view'].'&columna=vid_aprob2'; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob2&estado=2'; ?>" title="Aprobar Video" class="icon-aprobar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob2&estado=3'; ?>" title="Rechazar Video" class="icon-cancelar info-tooltip"></a><?php } ?>
<?php } ?>
			</td>
		</tr>
       ...
       <tr class="odd">
			...
			<td class=" ">
<?php if($rowdata['vid_prof3']!=''&&$rowdata['vid_aprob3']!=''){?>            
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $direccionWeb.'?view='.$_GET['view'].'&columna=vid_aprob3'; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob3&estado=2'; ?>" title="Aprobar Video" class="icon-aprobar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&modvideo='.$_GET['view'].'&columna=vid_aprob3&estado=3'; ?>" title="Rechazar Video" class="icon-cancelar info-tooltip"></a><?php } ?>
<?php } ?>
			</td>
		</tr>
...
$query = "SELECT id_usuario FROM `postulante` ".$z."";
...
$arrUsers = array();
$query = "SELECT id_usuario, PostNombres, PostApellPapa, PostApellMama, alias, rol, PostEmail
FROM `postulante`
".$z."
ORDER BY rol DESC
...
<label class="control-label col-lg-4">Buscar Usuario</label>
    <div class="col-lg-5">
		<div class="input-group bootstrap-timepicker">
			...
			<input class="form-control timepicker-default" type="text" name="search" value="<?php if (isset($_GET['search'])) { echo $_GET['search'];}?>" placeholder="Email">
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			<td class=" "><a name="<?php echo $usuarios['PostEmail'] ?>"></a> <?php echo $usuarios['PostEmail']; ?></td>
			<td class=" "><?php echo $usuarios['PostNombres'].' '.$usuarios['PostApellPapa'].' '.$usuarios['PostApellMama']; ?></td>
            <td class=" "><?php echo $usuarios['alias']; ?></td>
			<td class=" "><?php if($usuarios['rol']==2){echo 'Administrador';}elseif($usuarios['rol']==1){echo 'Normal';} ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&view='.$usuarios['id_usuario']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php } ?>
			</td>
		</tr>
    <?php } ?>                    
	</tbody>
