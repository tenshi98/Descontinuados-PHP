...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_12.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/usuarios_listado.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/usuarios_listado.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_13.php';
...
if ( !empty($_GET['del']) )     {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/usuarios_listado.php';
}
...
$query = "SELECT usuario,  email, Nombre, Rut, fNacimiento, Fono
