...
if ( !empty($_POST['submit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/core_permisos_cat.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/core_permisos_cat_2.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_insert/core_permisos_cat.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_common/core_permisos_cat.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_controller/core_permisos_cat_2.php';
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_update/core_permisos_cat.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_form_del/core_permisos_cat.php';
}
