...
if ( !empty($_GET['prm_add']) ) {
	...
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/usuario_prm_add.php';
}
...
if ( !empty($_GET['prm_del']) ) {
	...
	$location.='#'.$_GET['anclaje'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/usuario_prm_del.php';
}
...
if ( !empty($_GET['perm']) ) {
	...
	$location.='#'.$_GET['anclaje'];
	//Llamamos a las partes del formulario
	require_once 'AR2D2CFFDJFDJX1/xrxs_trans/usuario_prm_level.php';
}
