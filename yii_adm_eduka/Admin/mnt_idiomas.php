...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/productos_idiomas.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'Nombre,idIdioma';
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/productos_idiomas.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Idioma creado correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Idioma editado correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Idioma borrado correctamente';}
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" name="idIdioma" value="<?php echo $_GET['id']; ?>" >
...
$query = "SELECT idIdioma FROM `productos_idiomas` ".$z."";
...
<label class="control-label col-lg-4">Buscar Idioma</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Idioma</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Idiomas</h5>
		</header>
    ...
    <?php foreach ($arrCuentas as $cuentas) { ?>
    	<tr class="odd">
			...
			<td>
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$cuentas['idIdioma']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$cuentas['idIdioma'];?>
