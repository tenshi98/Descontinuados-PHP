...
$original = "admin_clientes_tipo_cuenta.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/clientes_tipo_cuentas.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'Nombre,idTipoCuenta';
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/clientes_tipo_cuentas.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Cuenta creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Cuenta editada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Cuenta borrada correctamente';}
...
$query = "SELECT Nombre
FROM `clientes_tipo_cuentas`
WHERE idTipoCuenta = {$_GET['id']}";
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion Tipo de cuenta</h5>
		</header>
		...
		<form class="form-horizontal" method="post">
			...
			<div class="form-group">
            	<input type="hidden" name="idTipoCuenta" value="<?php echo $_GET['id']; ?>" >
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			<div class="icons"><i class="fa fa-edit"></i></div>
			<h5>Crear Nuevo Tipo de cuenta</h5>
		</header>
		<div id="div-1" class="body">
		<form class="form-horizontal" method="post">
...
$query = "SELECT idTipoCuenta FROM `clientes_tipo_cuentas` ".$z."";
...
$arrCuentas = array();
$query = "SELECT idTipoCuenta,Nombre
FROM `clientes_tipo_cuentas`
".$z."
ORDER BY Nombre ASC
...
array_push( $arrCuentas,$row );
}?>
<div class="form-group">
<form class="form-horizontal" action="<?php echo $location ?>"  name="form1">
<label class="control-label col-lg-4">Buscar Tipo Cuenta</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Cuenta</a><?php } ?>
</div>
...
<div class="col-lg-12">
	<div class="box">
		<header>
			<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Tipos de cuenta</h5>
		</header>
    ...
    <?php foreach ($arrCuentas as $cuentas) { ?>
    	<tr class="odd">
			<td><?php echo $cuentas['Nombre']; ?></td>
			<td>
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$cuentas['idTipoCuenta']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$cuentas['idTipoCuenta'];?>
