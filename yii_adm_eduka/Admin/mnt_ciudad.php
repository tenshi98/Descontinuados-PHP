...
if ( !empty($_POST['submit']) )  { 
	...
	$form_trabajo= 'insert';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/mnt_ubicacion_ciudad.php';
}
//formulario para editar
if ( !empty($_POST['submit_edit']) )  { 
	//Llamamos al formulario
	$form_obligatorios = 'Nombre,idCiudad';
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/mnt_ubicacion_ciudad.php';
}
//se borra un dato
...
if (isset($_GET['created'])) {$error['usuario'] 	  = 'sucess/Ciudad creada correctamente';}
if (isset($_GET['edited']))  {$error['usuario'] 	  = 'sucess/Ciudad editada correctamente';}
if (isset($_GET['deleted'])) {$error['usuario'] 	  = 'sucess/Ciudad borrada correctamente';}
...
<?php if ($rowlevel['level_crear']==1){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Ciudad</a><?php } ?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrCuentas as $cuentas) { ?>
    	<tr class="odd">
			...
			<td>
<?php if ($rowlevel['level_editar']==1){?><a href="<?php echo $location.'&id='.$cuentas['idCiudad']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php } ?>
<?php if ($rowlevel['level_borrar']==1){?><?php $ubicacion=$location.'&del='.$cuentas['idCiudad'];?>
