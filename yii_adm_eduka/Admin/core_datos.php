...
if ( !empty($_POST['edit_datos']) )  {
	...
	$form_trabajo= 'update';
	require_once '../XRXS_2D2CFFDJFDJX1/xrxs_form/core_datos.php';
}
?>
<!doctype html>
...
$query = "SELECT Nombre,Fono,email_principal,  Rut, Direccion,  Ciudad, Comuna
FROM `core_datos`
WHERE id_Datos = '1'";
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            if(isset($email_principal)) {   $x7  = $email_principal;   }else{$x7  = $rowdata['email_principal'];}
            ...
            echo form_input('text', 'Email', 'email_principal', $x7, 2);
