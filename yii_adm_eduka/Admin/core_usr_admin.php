...
if ( !empty($_POST['submit']) )  { 
	...
	$form_obligatorios = 'usuario,password,repassword,Nombre,email,Rut,fNacimiento';
	$form_trabajo= 'insert';
...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            if(isset($Fono)) {          $x5  = $Fono;         }else{$x5  = $rowdata['Fono'];}
            if(isset($email)) {         $x6  = $email;        }else{$x6  = $rowdata['email'];}
            if(isset($Rut)) {           $x7  = $Rut;          }else{$x7  = $rowdata['Rut'];}
            if(isset($fNacimiento)) {   $x8  = $fNacimiento;  }else{$x8  = $rowdata['fNacimiento'];}
            if(isset($Ciudad)) {        $x9  = $Ciudad;       }else{$x9  = $rowdata['Ciudad'];}
            if(isset($Comuna)) {        $x10 = $Comuna;       }else{$x10 = $rowdata['Comuna'];}
            ...
            echo form_date('Fecha de Nacimiento','fNacimiento', $x8, 2); 
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td>
            <a href="<?php echo $location.'&view='.$usuarios['idUsuario']; ?>" title="Visualizar" class="icon-ver info-tooltip"></a>
