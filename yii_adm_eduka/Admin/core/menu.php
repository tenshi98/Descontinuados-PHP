...
foreach($rowmenu as $menu=>$productos) {
  ...
  foreach($productos as $producto) {
	...
	echo '<li class=""><a href="'.$producto['Direccionbase'].'?pagina=1"><i class="fa fa-credit-card"></i> '.$producto['Nombre'].'</a> </li>';
  }
echo '</ul>';  
echo '</li>';    
}?>  
...
if($arrUsuario['tipo']=='SuperAdmin'){?>
	...
	<li class="">
		...
		<ul>
			<li class=""><a href="core_datos.php">                   <i class="fa fa-credit-card"></i> Datos de Soporte</a></li>
            <li class=""><a href="core_sistemas.php?pagina=1">       <i class="fa fa-credit-card"></i> Sistemas</a></li>
