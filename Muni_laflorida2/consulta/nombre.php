...
<table width="960" border="0" cellpadding="0" cellspacing="0" class="tabla_sup">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			...
			<th width="80">Ir al detalle</th></tr></thead>
...
$count = count($r);
?>
<?php if($result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"][0]["NOMBRE"]!=''){?>
...
<?php }else{?>
         <tr>
			<td><?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["NOMBRE"] ?></td>
			<td><?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["RUT"] ?></td>
			<td><?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["DIRECCION"] ?></td>
			<td><input type="submit" class="rojo_sombra" value="&laquo; Ver Detalle" onclick="window.open('mostrardatos.php?r=<?php echo $result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"]["RUT"] ?>&donde=1', 'San Miguel==Consulta Vecinos', 'width=1000,height=700,scrollbars=1'); return false;" /></td>
