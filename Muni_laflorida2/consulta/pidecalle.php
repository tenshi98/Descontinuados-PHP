      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_sup">
        ...
        <tr>
          <td colspan="3" align="center" valign="middle"><table id="table1" border="0" height="163" width="834">
            <tbody>
              <tr>
                <td width="343" align="center" ><img src="images/la_florida_ch.png" height="260" border="0"/></td>
				...
				<form name="form1" method="post" action="calles.php" onsubmit="return validacalle()">
                  <table border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      ...
                      <td>&nbsp;</td>
                      <td height="25" colspan="2"><input name="calle" type="text" class="campo_rut" id="calle" size="50" maxlength="20" value="" onkeypress="return isAlpha2(event);" placeholder="Ej: Tannembaun" style="width:220px !important;"/></td>
                    </tr>
