...
//$param = array('Nombre_Comuna'=>$Comuna,'NombreFuncion'=>'busquedapordir','XMLConsulta'=>'<PARAMETROS><CALLE>'.$_POST["calle"].'</CALLE><NRO>'.$_POST["numero"].'</NRO></PARAMETROS>');
if ($_POST["numero"]=='') {
$param = array('Nombre_Comuna'=>$Comuna,'NombreFuncion'=>'busquedapordir','XMLConsulta'=>'<PARAMETROS><CALLE>'.$_POST["calle"].'</CALLE></PARAMETROS>');
}else{
$param = array('Nombre_Comuna'=>$Comuna,'NombreFuncion'=>'busquedapordir','XMLConsulta'=>'<PARAMETROS><CALLE>'.$_POST["calle"].'</CALLE><NRO>'.$_POST["numero"].'</NRO></PARAMETROS>');
}
...
?>
    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_int">
			 <tr><td>
			 <div align="left"><span class='pestana'>Total Registros <? echo $count;?></span></div>
...
<table width='100%' border='1' cellspacing='0' cellpadding='0' class='bordered' >
    <thead>
        <tr>
            ...
            <th width="80">Ir al detalle</th>
        </tr>
    </thead>
<?php for($i=0;$i<=$count-1;$i++){ 
	if ($result["pfConsultaBDExtResult"]["diffgram"]["NewDataSet"]["Table"][$i]["COMUNA"]==$Comuna) {
	?>
<tr>
