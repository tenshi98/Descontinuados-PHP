...
if ( !empty($_POST['search']) ) {
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_trans/busqueda_llamadas.php';
}
...
//Variable con la ubicacion
	$z="WHERE idUsuario= {$_GET['view']}";
//Verifico si se han ingresado las fechas
if (isset($_GET['Inicia']) && $_GET['Inicia']!='' && isset($_GET['Termina']) && $_GET['Termina']!='' ){
	$z.=" AND Fecha BETWEEN '".$_GET['Inicia']."' AND '".$_GET['Termina']."'";	
}
//Verifico si se especifico un tipo
if (isset($_GET['Tipo']) && $_GET['Tipo']!='' ){
	$z.=" AND Estado='".$_GET['Tipo']."'  ";	
}
// Se trae un listado con todos los usuarios
$arrLlamadas = array();
$query = "SELECT Estado
FROM `usuarios_llamadas`
".$z;
$resultado = mysql_query ($query, $dbConn);
while ( $row = mysql_fetch_assoc ($resultado)) {
array_push( $arrLlamadas,$row );
} 
//Se cuentan las opciones
$abiertas      = 0;
$cerradas_1    = 0;
$cerradas_2    = 0;
$interrumpidas = 0;
foreach ($arrLlamadas as $llamadas) {

	switch ($llamadas['Estado']) {
		case 1:
			//$abiertas++;
			break;
		case 2:
    ...
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Estados', 'Valores'],
          //['Llamadas recibidas',     <?php echo $abiertas ?>],
          ['Llamadas cerradas por el cliente',      <?php echo $cerradas_1 ?>],
          ['Llamadas cerradas por el ejecutivo',  <?php echo $cerradas_2 ?>],
          ['Llamadas interrumpidas por el ejecutivo', <?php echo $interrumpidas ?>]
        ]);
      ...
      <div id="top">
        ...
        <header class="head">
          <div class="main-bar">
            ...
            <i class="fa fa-dashboard"></i> Llamadas
...
<div class="col-lg-12">
    <div class="box">
        ...
        <h5>Buscar Vecinos</h5>
        </header>
        <div class="body">
            <form  class="form-inline"  method="post">
            <div class="row form-group">
                <div class="col-lg-6">
                	<input type="text" class="form-control" name="Inicia" id="datepicker1" readonly placeholder="Fecha Inicio" >
                </div>
                <div class="col-lg-6">
                	<input type="text" class="form-control" name="Termina" id="datepicker2" readonly placeholder="Fecha Termino" >
                </div>
            </div>
            <div class="row form-group">
                <div class="col-lg-6">
                <select class="form-control" name="Tipo">
                    ...
                    <option value="2">Llamadas cerradas por elcliente</option>
                    <option value="3">Llamadas cerradas por elejecutivo</option>
                    <option value="4">Llamadas interrumpidas porel ejecutivo</option>
                </select>
                </div><!-- /.col-lg-6 -->
            </div><!-- /.row -->
            <input type="submit" class="btn btn-primary" value="Buscar" name="search">
            </form>
        </div>
    </div>
</div> 
