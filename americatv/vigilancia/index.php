    ...
    <td align="center" valign="middle"><table width="990" align="center" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" class="logo_flot">
          ...
          Visualizaci&oacute;n de Datos de Vigilancia</td>
          ...
          <tr>
            <td height="50" align="center" valign="middle"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_bca_sombra">
              <tr>
                  ...
                  <tr>
                    <td align="center"><table width="50%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
						...
						<?
						$SQL_lee4="select LEFT( fecha_hora, 10 ) as fecha  from vigilancia group by LEFT( fecha_hora, 10 )  order by LEFT( fecha_hora, 10 ) desc";
				...
				<?
				$SQL_lee4="select id_usuario  from vigilancia group by id_usuario  order by id_usuario desc";
				$res=mysql_query($SQL_lee4,$base); 
