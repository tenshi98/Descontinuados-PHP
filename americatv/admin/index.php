    ...
    <td align="center" valign="middle"><table width="990" align="center" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="58%" align="right" valign="middle" class="google_fjalla_bco"><table border="0" cellpadding="0" cellspacing="0" class="logo_flot">
          ...
          Administración <?=$nombreurl?></td>
        <td width="42%" height="50" align="center" valign="middle">
		<input name="button" type="submit" class="bot_sombra_izq" id="button" value="" />
          <input name="button2" type="submit" class="bot_sombra_cent" id="button2" value="Cerrar Sesión"  onclick="javascript:window.location.href='http://<?=$nombreurl?>/index.php?cierro=si';"/>
...
<TD align=center>		<input name="button" type="submit" class="bot_sombra_izq" id="button" value="" />
          <input name="button2" type="submit" class="bot_sombra_cent" id="button2" value="Administrar Interfaz"  onclick="javascript:window.location.href='http://<?=$nombreurl?>/admin_pantalla/interfaz.php';"/>
          <input name="button4" type="submit" class="bot_sombra_der" id="button4" value="" />
		  <br><br>		  
		  </TD>
</TR>
...
<TD align=center>		<input name="button" type="submit" class="bot_sombra_izq" id="button" value="" />
          <input name="button2" type="submit" class="bot_sombra_cent" id="button2" value="Administrar Preguntas"  onclick="javascript:window.location.href='http://<?=$nombreurl?>/admin_pantalla/preguntas.php';"/>
          <input name="button4" type="submit" class="bot_sombra_der" id="button4" value="" />
		  <br><br>		  
		  </TD>
</TR>
