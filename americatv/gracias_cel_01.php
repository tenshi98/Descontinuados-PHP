...
$sql ="SELECT * FROM ejecutivos WHERE login='" . $_GET["login"] . "'";
...
<br><br><br><br><br><br><br>
 <form name="formuchat" method="post" action="http://<?=$nombreurl?>/fin_llamado.php">
<input type="hidden" name="login" id="login" value='<?=$_GET["login"]?>'  >
<input name="chatat" type="submit" class="bot_red_med" id="button5"  value="Llamada Gestionada, continuar" />
  </form>
</div>
<!--div align="center">
