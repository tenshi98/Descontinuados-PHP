...
<table width="990" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla_top">
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="35%" height="350" align="right" valign="top">
				<div id="apDiv1">
			    <table width="450" border="0" align="center" cellpadding="0" cellspacing="0" class="tabla_bca_sombra2">
				<tr>
				  <td><video id=0 controls width=370 height=221 poster="http://<?=$nombreurl?>/images/imagen_probando.jpg" preload="auto" >
            ...
            <object type="application/x-shockwave-flash" data="http://<?=$nombreurl?>/fplayer/flowplayer-3.2.1.swf" width="370" height="221">
		...
		<img alt="Multimail" src="http://<?=$nombreurl?>/images/imagen_probando.jpg" width="370" height="221" title="No tiene capacidad de ver video" />
	</object>
			</video><br />
					<span class="arial_cuerpo_gris"><br />Video Explicativo de SOSClick</span></td>
				</tr>
		        </table>
        ...
        <td width="65%" align="right" valign="top"><table width="690" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td align="center" valign="top"><img src="images/sos_iphone_cut.png" width="690"  border="0" />
