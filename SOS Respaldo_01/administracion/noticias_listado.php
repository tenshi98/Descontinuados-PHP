...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_listado.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_listado_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/noticias_listado.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_listado.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_listado_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/noticias_listado.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/noticias_listado.php';
}
...
$zy=" AND idTipoCliente>0";	
}else{
$zz="WHERE idTipoCliente={$arrUsuario['idTipoCliente']}";
$zy=" AND idTipoCliente={$arrUsuario['idTipoCliente']}";		
}  
...
// Se trae un listado con todas las comunas
 if ($rowdata['idNotGrupo']!=0&&$rowdata['idNotGrupo']!=''){
	$arrCategoria = array();
	$query = "SELECT idNotCat, Nombre
	FROM `noticias_categorias`
	WHERE idNotGrupo = ".$rowdata['idNotGrupo']." ".$zy."
	ORDER BY Nombre ASC ";
	$resultado = mysql_query ($query, $dbConn);
	while ( $row = mysql_fetch_assoc ($resultado)) {
...
<?php }?> 
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="<?php echo $grupos['idNotGrupo']; ?>" <?php if(isset($idNotGrupo)&&$idNotGrupo==$grupos['idNotGrupo']) {echo 'selected="selected"';} elseif($rowdata['idNotGrupo']==$grupos['idNotGrupo']){ echo 'selected="selected"'; }?>><?php echo $grupos['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="<?php echo $categoria['idNotCat']; ?>" <?php if(isset($idNotCat)&&$idNotCat==$categoria['idNotCat']) {echo 'selected="selected"';} elseif($rowdata['idNotCat']==$categoria['idNotCat']){ echo 'selected="selected"'; }?>><?php echo $categoria['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
...
function cambia_categoria(){
	...
	document.form1.idNotCat.options[0].selected = true
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Comentarios</label>
				<div class="col-lg-8">
                    <select name="Comentarios" class="form-control" required>
                    <option value="" selected="selected">Seleccione una Opcion</option> 
                    <option value="1" <?php if(isset($Comentarios)&&$Comentarios==1) {echo 'selected="selected"';} elseif($rowdata['Comentarios']==1) {echo 'selected="selected"';} ?> >Permitir comentarios</option> 
                    <option value="2" <?php if(isset($Comentarios)&&$Comentarios==2) {echo 'selected="selected"';} elseif($rowdata['Comentarios']==2) {echo 'selected="selected"';} ?> >No Permitir comentarios</option>           
                    </select>
				</div>
			</div>
            
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Publicacion comentarios</label>
				<div class="col-lg-8">
                    <select name="Aprobar" class="form-control" required>
                    <option value="" selected="selected">Seleccione una Opcion</option> 
                    <option value="1" <?php if(isset($Aprobar)&&$Aprobar==1) {echo 'selected="selected"';} elseif($rowdata['Aprobar']==1) {echo 'selected="selected"';} ?> >Automatica</option> 
                    <option value="2" <?php if(isset($Aprobar)&&$Aprobar==2) {echo 'selected="selected"';} elseif($rowdata['Aprobar']==2) {echo 'selected="selected"';} ?> >Espera Aprobacion</option>           
                    </select>
				</div>
			</div>
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idNotListado">
...
<?php }?>           
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    ...
                    <option value="" selected="selected">Seleccione un Grupo de Categorias</option>
                    <?php foreach ($arrGrupos as $grupos) { ?>
                    <option value="<?php echo $grupos['idNotGrupo']; ?>" <?php if(isset($idNotGrupo)&&$idNotGrupo==$grupos['idNotGrupo']) {echo 'selected="selected"';} ?>><?php echo $grupos['Nombre']; ?></option>
                    <?php } ?>             
                    </select>
				</div>
			</div>
	...
	document.form1.idNotCat.options[0].selected = true
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    <select name="Comentarios" class="form-control" required>
                    <option value="" selected="selected">Seleccione una Opcion</option> 
                    <option value="1" <?php if(isset($Comentarios)&&$Comentarios==1) {echo 'selected="selected"';} ?> >Permitir comentarios</option> 
                    <option value="2" <?php if(isset($Comentarios)&&$Comentarios==2) {echo 'selected="selected"';} ?> >No Permitir comentarios</option>           
                    </select>
				</div>
			</div>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
                    <select name="Aprobar" class="form-control" required>
                    <option value="" selected="selected">Seleccione una Opcion</option> 
                    <option value="1" <?php if(isset($Aprobar)&&$Aprobar==1) {echo 'selected="selected"';} ?> >Automatica</option> 
                    <option value="2" <?php if(isset($Aprobar)&&$Aprobar==2) {echo 'selected="selected"';} ?> >Espera Aprobacion</option>           
                    </select>
				</div>
			</div>
