...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		...
		<form class="form-horizontal" method="post" name="form1">
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Filtro Usuarios</label>
				<div class="col-lg-8">
...
<script type="text/javascript">
	<!--
	var myfilter = new filterlist(document.form1.idUsuario);
	//-->
</script>            
            <div class="form-group">
            	<label for="text2" class="control-label col-lg-4">Tipo de mensaje</label>
            ...
            <div class="form-group">
				...
				<div class="col-lg-8">
					<div class="input-group bootstrap-timepicker">
						<input placeholder="Rango Fechas inicio" class="form-control timepicker-default" type="text" name="rango_b" id="datepicker2" >
						<span class="input-group-addon add-on"><i class="fa fa-calendar"></i></span> 
					</div>
				</div>
			</div>
