...
$original = "taxistas_propietarios.php";
$location = $original;
...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_propietarios.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_propietarios_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/taxista_propietarios.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_propietarios.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_propietarios_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/taxista_propietarios.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se agregan ubicaciones
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/taxista_propietarios.php';
}
...
<div id="txf_03" class="alert_sucess">  
	Propietario borrado correctamente
	<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">
		<i class="fa fa-times"></i>
	</a>
</div>
...
function cambia_ciudad(){
	...
	document.form1.idComuna.options[0].selected = true
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Nombre de la Empresa</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre de la Empresa" class="form-control" value="<?php if(isset($NombreEmpresa)) {echo $NombreEmpresa;} else {echo $rowdata['NombreEmpresa'];}?>" name="NombreEmpresa" >
				</div>
			</div>
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idPropietario">
...
function cambia_ciudad(){
	...
	document.form1.idComuna.options[0].selected = true
            ...
            <div class="form-group">
				<label for="text2" class="control-label col-lg-4">Nombre de la empresa</label>
				<div class="col-lg-8">
					<input type="text" id="text2" placeholder="Nombre de la empresa" class="form-control"  name="NombreEmpresa" <?php if(isset($NombreEmpresa)) {echo 'value="'.$NombreEmpresa.'"';}?> >
				</div>
			</div>
...
taxista_propietarios.fNacimiento, 
taxista_propietarios.Direccion, 
taxista_propietarios.Fono1, 
taxista_propietarios.Fono2, 
taxista_propietarios.NombreEmpresa, 
mnt_ubicacion_ciudad.Nombre AS nombre_region,
mnt_ubicacion_comunas.Nombre AS nombre_comuna
FROM `taxista_propietarios`
LEFT JOIN `mnt_ubicacion_ciudad`      ON mnt_ubicacion_ciudad.idCiudad      = taxista_propietarios.idCiudad
LEFT JOIN `mnt_ubicacion_comunas`     ON mnt_ubicacion_comunas.idComuna     = taxista_propietarios.idComuna
WHERE taxista_propietarios.idPropietario = {$_GET['view']}";
$resultado = mysql_query ($query, $dbConn);
$rowdata = mysql_fetch_assoc ($resultado);
?>
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
            ...
            <p class="text-muted"><strong>Nombre de la empresa : </strong><?php echo $rowdata['NombreEmpresa']; ?></p>
...
$query1 = "SELECT idPropietario FROM `taxista_propietarios` ".$z."";
...
FROM `taxista_propietarios`
".$z."
ORDER BY taxista_propietarios.Nombre ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td class=" "><?php echo $usuarios['NombreEmpresa']; ?></td>
			<td class=" ">
