...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_categorias_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/noticias_categorias.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_categorias.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_categorias_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/noticias_categorias.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/noticias_categorias.php';
}
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
			<div class="form-group">
                ...
                <option value="<?php echo $grupos['idNotGrupo']; ?>" <?php if(isset($idNotGrupo)) {if($idNotGrupo==$grupos['idNotGrupo']){ echo 'selected="selected"';}} elseif($rowdata['idNotGrupo']==$grupos['idNotGrupo']){echo 'selected="selected"';}?>  ><?php echo $grupos['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
...
<?php }?> 
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idNotCat">
	...
	<div class="box dark">
		...
		<form class="form-horizontal" method="post">
            ...
            <div class="form-group">
                ...
                <option value="<?php echo $grupo['idNotGrupo']; ?>" <?php if(isset($idNotGrupo)&& $idNotGrupo==$grupo['idNotGrupo']){ echo 'selected="selected"';}?>><?php echo $grupo['Nombre']; ?></option>
                <?php } ?>
                </select>
                </div>
            </div>
