...
$original = "apariencia_principal.php";
$location = $original;
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 if ( ! empty($_GET['view']) ) { ?>            
<div class="col-lg-12"><div class="box">	<header>		<h5>Listado de opciones</h5>		<div class="toolbar"></div>	</header>
        <div class="body">
<a href="apariencia_principal_bgcolor.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;"  >Modificar Fondo</a>
<a href="apariencia_principal_botoncolor.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar aspecto botones</a>
<a href="apariencia_principal_formcolor.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;"  >Modificar formularios</a>
<a href="apariencia_principal_emergentes.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar aspecto mensajes error y otros</a>
<a href="apariencia_principal_user.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar aspecto ventana bienvenida</a>
<a href="apariencia_principal_listados.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar aspecto de los listados</a>  
<a href="apariencia_principal_notificaciones.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar ventana de notificaciones</a>
<a href="apariencia_principal_titulos.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar aspecto de los Titulos</a>
<a href="apariencia_principal_areas.php?app_conf=<?php echo $_GET['view'] ?>" class="btn btn-primary fleft" style="margin:5px;" >Modificar interfaz</a>    
...
<a href="apariencia_principal.php?pagina=<?php echo $_GET['pagina'] ?>" class="btn btn-danger fright margin_width" data-original-title="" title="">Volver</a>
<div class="clearfix"></div>
</div>
