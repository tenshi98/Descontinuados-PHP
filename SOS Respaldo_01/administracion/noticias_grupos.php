...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_grupos_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/noticias_grupos.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/noticias_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/noticias_grupos_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/noticias_grupos.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/noticias_grupos.php';
}
...
<?php }?> 
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idNotGrupo">
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE noticias_grupos.idTipoCliente>=0";	
}else{
	$z="WHERE noticias_grupos.idTipoCliente={$arrUsuario['idTipoCliente']}";	
}
...
$query = "SELECT idNotGrupo FROM `noticias_grupos` ".$z."";
...
$arrGrupo = array();
$query = "SELECT 
noticias_grupos.idNotGrupo,
noticias_grupos.Nombre,
clientes_tipos.RazonSocial AS sistema
FROM `noticias_grupos`
LEFT JOIN `clientes_tipos`        ON clientes_tipos.idTipoCliente      = noticias_grupos.idTipoCliente
".$z."
ORDER BY Nombre ASC
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrGrupo as $grupo) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$grupo['idNotGrupo']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$grupo['idNotGrupo'];?>
