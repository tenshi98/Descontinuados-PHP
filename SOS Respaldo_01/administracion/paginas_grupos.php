...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/paginas_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/paginas_grupos_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/paginas_grupos.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/paginas_grupos.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/paginas_grupos_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/paginas_grupos.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se consiguen las variables de busqueda y paginacion
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/paginas_grupos.php';
}
...
$query = "SELECT Nombre, idTipoCliente
FROM `paginas_grupos`
WHERE idPagGrupo = {$_GET['id']}";
...
<?php }?> 
			...
			<div class="form-group">
            	<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idPagGrupo">
...
if($arrUsuario['tipo']=='SuperAdmin'){
	$z="WHERE paginas_grupos.idTipoCliente>=0";	
}else{
	$z="WHERE paginas_grupos.idTipoCliente={$arrUsuario['idTipoCliente']}";	
}
...
$query = "SELECT idPagGrupo FROM `paginas_grupos` ".$z."";
...
$arrGrupo = array();
$query = "SELECT 
paginas_grupos.idPagGrupo,
paginas_grupos.Nombre,
clientes_tipos.RazonSocial AS sistema
FROM `paginas_grupos`
LEFT JOIN `clientes_tipos`        ON clientes_tipos.idTipoCliente      = paginas_grupos.idTipoCliente
".$z."
ORDER BY paginas_grupos.Nombre ASC
...
<label class="control-label col-lg-4">Buscar Grupo</label>
    <div class="col-lg-5">
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nuevo Grupo</a><?php }?>
</div>
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrGrupo as $grupo) { ?>
    	<tr class="odd">
			<td class=" "><?php echo $grupo['Nombre']; ?></td>
            <td class=" "><?php echo $grupo['sistema']; ?></td>
			<td class=" ">
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$grupo['idPagGrupo']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$grupo['idPagGrupo'];?>
