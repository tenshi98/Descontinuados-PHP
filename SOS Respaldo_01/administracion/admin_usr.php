...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/usuarios_listado_1.php';
...
Usuario Creado correctamente<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;"><i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['mod'])) {?>
<div id="txf_03" class="alert_sucess">  
Usuario Modificado correctamente<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;"><i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  
Usuario borrado correctamente<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;"><i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 if ( ! empty($_GET['id']) ) { 
// Se traen todos los datos de mi usuario
$query = "SELECT usuario,  email, Nombre, Rut, fNacimiento, Direccion, Fono, Ciudad, Comuna, Direccion_img, idTipoCliente
...
<div class="icons"><i class="fa fa-edit"></i></div>
		...
		<div class="form-group">			
			...
			<div class="col-lg-8">				
				<input type="text" id="text2" placeholder="Ciudad" class="form-control" value="<?php if(isset($Ciudad)) {echo $Ciudad;} else {echo $rowdata['Ciudad'];}?>" name="Ciudad">			
			</div>		
		</div>
		...
		<div class="form-group">			
			...
			<div class="col-lg-8">				
				<input type="text" id="text2" placeholder="Comuna" class="form-control" value="<?php if(isset($Comuna)) {echo $Comuna;} else {echo $rowdata['Comuna'];}?>" name="Comuna">			
			</div>		
		</div>
...
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
 ...
 <form class="form-horizontal" method="post">
			...
			<div class="form-group">			
				<label for="text2" class="control-label col-lg-4">Ciudad</label>			
				<div class="col-lg-8">				
					<input type="text" id="text2" placeholder="Ciudad" class="form-control"  name="Ciudad" <?php if(isset($Ciudad)) {echo 'value="'.$Ciudad.'"';}?>>			
				</div>		
			</div>
			...
			<div class="form-group">			
				<label for="text2" class="control-label col-lg-4">Comuna</label>			
				<div class="col-lg-8">				
					<input type="text" id="text2" placeholder="Comuna" class="form-control"  name="Comuna" <?php if(isset($Comuna)) {echo 'value="'.$Comuna.'"';}?>>			
				</div>		
			</div>
...
<div class="form-group">
	...
	<div class="col-lg-8">	
		<select name="idTipoCliente" class="form-control" required >		
			<option value="" selected="selected">Seleccione el Sistema Asociado</option>		
			<?php foreach ($arrTipoCliente as $tipo) { ?>		
