...
if ( !empty($_POST['submit']) )  { 
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_conductores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_conductores_1.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/taxista_conductores.php';
}
...
if ( !empty($_POST['submit_edit']) )  { 
	...
	//Llamamos a las partes del formulario
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/taxista_conductores.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/taxista_conductores_2.php';
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/taxista_conductores.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
	//Se agregan ubicaciones
	...
	require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/taxista_conductores.php';
}
...
taxista_conductores.NombreEmpresa, 
...
if (isset($_GET['search']) && $_GET['search'] != ''){
	$z .=" AND taxista_conductores.Rut LIKE '%{$_GET['search']}%'";
	$x .= "&search=".$_GET['search'] ; 	
}

if(isset($_GET['Nombre']) && $_GET['Nombre'] != '')  { 
	$z .= " AND taxista_conductores.Nombre LIKE '%{$_GET['Nombre']}%' " ;
...
if(isset($_GET['Sexo']) && $_GET['Sexo'] != '')  { 
	$z .= " AND taxista_conductores.Sexo = '".$_GET['Sexo']."'" ;
	$x .= "&Sexo=".$_GET['Sexo'] ; 
}
if(isset($_GET['idCiudad']) && $_GET['idCiudad'] != '')  { 
	$z .= " AND taxista_conductores.idCiudad = '".$_GET['idCiudad']."'" ;
	$x .= "&idCiudad=".$_GET['idCiudad'] ; 
}
if(isset($_GET['idComuna']) && $_GET['idComuna'] != '')  { 
	$z .= " AND taxista_conductores.idComuna = '".$_GET['idComuna']."'" ;
...
<div class="col-lg-12">
    ...
    <?php foreach ($arrUsers as $usuarios) { ?>
    	<tr class="odd">
			...
			<td class=" ">
<?php if ($rowlevel['level']>=1){?><a href="<?php echo $location.'&view='.$usuarios['idConductor']; ?>" title="Ver Informacion" class="icon-ver info-tooltip"></a><?php }?>   
