...
<div class="col-lg-6 fcenter">
	<div class="box dark">
		<header>
			...
			<h5>Modificacion datos del Taxista</h5>
		</header>
...
<?php }?>
			...
			<div class="form-group">
				...
				<input type="hidden" value="Si" name="Alarma">
...
<div class="col-lg-4">
	<div class="box">
        ...
        <div class="body">
            ...
            <h2 class="text-primary">Perfil del Taxista</h2>
            ...
            <p class="text-muted"><strong>Tipo Taxista : </strong><?php echo $rowdata['tipo']; ?></p>
...
LEFT JOIN `detalle_general`        ON detalle_general.id_Detalle           = clientes_listado.Estado
LEFT JOIN `clientes_tipos`         ON clientes_tipos.idTipoCliente         = clientes_listado.idTipoCliente
LEFT JOIN `taxista_vehiculos`      ON taxista_vehiculos.idVehiculo         = clientes_listado.idVehiculo
...
<div class="form-group">
<form class="form-horizontal" action="<?php echo $location ?>"  name="form1">
<label class="control-label col-lg-4">Buscar Vehiculo</label>
    <div class="col-lg-5">
		<div class="input-group bootstrap-timepicker">
