...
$original = "apariencia_grillas.php";
$location = $original;
...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/app_grilla.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/app_grilla_1.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_insert/app_grilla.php';
}
...
//Llamamos a las partes del formulario
require_once '../AA2D2CFFDJFDJX1/xrxs_form_common/app_grilla.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_controller/app_grilla_2.php';
require_once '../AA2D2CFFDJFDJX1/xrxs_form_update/app_grilla.php';
}
//se borra un dato
if ( !empty($_GET['del']) )     {
//Se consiguen las variables de busqueda y paginacion
...
require_once '../AA2D2CFFDJFDJX1/xrxs_form_del/app_grilla.php';
}
...
<div id="txf_03" class="alert_sucess">  Grilla Creada correctamente
...
<div id="txf_03" class="alert_sucess">  Grilla Modificada correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php  if (isset($_GET['delete'])) {?>
<div id="txf_03" class="alert_sucess">  Grilla borrada correctamente
<a class="closed_c" href="javascript:void(0);" onclick="document.getElementById(&apos;txf_03&apos;).className = &apos;oculto&apos;">	<i class="fa fa-times"></i></a>
</div>
<?php }?>
<?php ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
	...
	<div class="box dark">	
		...
		<div id="div-1" class="body">	
			<form class="form-horizontal" method="post" name="form1">		
				...
				<div class="form-group">
					<input type="hidden" value="<?php echo $_GET['id']; ?>" name="idGrilla">			
...
if (isset($_GET['search'])){$z="WHERE app_grilla.Nombre LIKE '%{$_GET['search']}%'";	
} else {$z="";
}
//Realizo una consulta para saber el total de elementos existentes
$query = "SELECT idGrilla FROM `app_grilla` ".$z."";
...
$arrGrilla = array();
$query = "SELECT  idGrilla, Nombre, Codigo
FROM `app_grilla`
".$z."
ORDER BY app_grilla.Nombre ASC
...
<label class="control-label col-lg-4">Buscar Nombre de grilla</label>
...
<?php if ($rowlevel['level']>=3){?><a href="<?php echo $location; ?>&new=true" class="btn btn-default fright margin_width" >Crear Nueva Grilla</a><?php }?>
</div>
...
<div class="box">	
	<header>		
		<div class="icons"><i class="fa fa-table"></i></div><h5>Listado de Grillas</h5>	
	</header>
...
<table id="dataTable" class="table table-bordered table-condensed table-hover table-striped dataTable">
    ...
    <?php foreach ($arrGrilla as $grilla) { ?>
    	<tr class="odd">		
			...
			<td class=" ">  
<?php if ($rowlevel['level']>=2){?><a href="<?php echo $location.'&id='.$grilla['idGrilla']; ?>" title="Editar Informacion" class="icon-editar info-tooltip"></a><?php }?>
<?php if ($rowlevel['level']>=4){?><?php $ubicacion=$location.'&del='.$grilla['idGrilla'];?>			
