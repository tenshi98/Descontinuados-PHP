	...
	foreach ($arrNoticias as $noti) {
		echo '<li>';
			echo '<h1 class="'.$config_app['noti_ul_color_tittle'].' '.$config_app['noti_ul_size_tittle'].'">';
				echo '<span class="'.$config_app['noti_ul_color_new'].' '.$config_app['noti_ul_size_new'].'">'.Fecha_completa($noti['Fecha']).'</span> ';
			echo '</h1>';
...
if($noti['votado']>0){
	echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' '.$config_app['btn_enlace_border'].' btn_link fright" href="list_preguntas.php'.$w.'&view_result='.$noti['idPregunta'].$xyz.'">Ver Resultados</a>';
}else{
	echo '<a class="'.$config_app['btn_enlace_color_fondo'].' '.$config_app['btn_enlace_radio'].' '.$config_app['btn_enlace_color_texto'].' '.$config_app['btn_enlace_sombra'].' '.$config_app['btn_enlace_border'].' btn_link fright" href="list_preguntas.php'.$w.'&view_noti='.$noti['idPregunta'].$xyz.'">Ver</a>';
}
