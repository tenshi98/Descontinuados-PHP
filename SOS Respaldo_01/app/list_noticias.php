...
<?php }?>
    ...
    <td width="80%">
    <h1 class="<?php echo $config_app['title2_size'].' '.$config_app['title2_color'] ?>"><?php if(isset($rowdata['Nombre'])&&$rowdata['Nombre']!=''){echo $rowdata['Nombre'];}else{echo 'Sin Datos';} ?></h1>
    </td>
  </tr>
  <tr height="90%">
    <td style="padding: 2%;" colspan="2">
