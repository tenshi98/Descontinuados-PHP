...
list($idTipoAlerta, $cercanos, $contactar, $desplegar, $idCliente, $lat, $lon, $gsm, $client, $sistema) =   split("3xyzxyz3", $_GET['mensaje'], 10);
...
$a .= ",'".$gsm."'" ;
$a .= ",'".$desplegar."'" ;
$query  = "INSERT INTO `alertas_listado` (idCliente, idTipoAlerta, Fecha, Hora, Longitud, Latitud, Gsm, desplegar) VALUES ({$a} )";
...
if($cercanos==1){
	...
	foreach ($arrAviso as $aviso) { 
		...
		$a .= ",'".$idCliente."'" ;
		$a .= ",'".$idTipoAlerta."'" ;
		$query  = "INSERT INTO `clientes_notificaciones` (idAlerta, idRecibidor, mensaje, Fecha,Leida, idCliente,idTipoAlerta) VALUES ({$a} )";
		$result = mysql_query($query, $dbConn);
	}
