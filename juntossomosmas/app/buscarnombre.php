...
//Se trae un listado con las preguntas
 ?>
    ...
    <div class="cuerpo_gris_12"><center><span class="tit_red">Busqueda por Nombre</span></center>
...
$ejecutivos="select nom_ejecutiv,id_ejecutiv FROM ejecutivos WHERE nom_ejecutiv like '%".$_POST["nombre"]."%'";
