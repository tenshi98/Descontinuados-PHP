...
<div class="widht80 fcenter perfil">
    ...
    <div class="cuerpo_gris_12"><center><span class="tit_red">Administracion</span></center>
...
<!--a href="<?php echo $activar.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Activar Seguidores"/></a><br>
<a href="<?php echo $eliminar.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Eliminar Seguidores"/></a><br>
<a href="<?php echo $desactivarforos.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Desactivar Foros"/></a><br>
<a href="<?php echo $crear.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Crear Grupo"/></a><br>
<a href="<?php echo $buscar.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Seguir a ..."/></a><br>
<a href="<?php echo $siguesa.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="Tu sigues a ..."/></a><br>
