...
list($messageText, $username) =   split("3xyzxyz3", $_GET['mensaje'], 2);
...
$sql = "insert into mensajes (mensaje,grupo,fecha_hora,estado,link,categoria,subcategoria) values ('".$messageText."','".$username."','".$fecha."','0','".$link."',99,0)";
$result = mysql_query($sql,$base);
...
/***************************************************************************************************************************/
	...
	$sql0 = "SELECT dispositivo,login,gcmcode FROM ejecutivos WHERE gcmcode<>''";
