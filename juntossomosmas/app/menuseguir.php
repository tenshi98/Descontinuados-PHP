...
$location = "administrar.php";
$notificacion = "comunicaciones.php";
$topten = "topten.php";
$buscarNombre = "buscarnombre.php";
$buscarCelular = "buscarcelular.php";
/**********************************************************************************************************************************/
...
//Se trae un listado con las preguntas
 ?>
    ...
    <div class="cuerpo_gris_12"><center><span class="tit_red">Buscar </span></center>
...
<a href="<?php echo $topten.'?imei='.$_GET['imei'] ?>"><input id="post_button" type="button" value="10 m&aacute;s seguidos"/></a>	
   </div>

<div class="clear"></div>
<div class="border_btn"></div>

	<!--form id="formnombre" name="formnombre" action="buscarnombre.php?id=<?=$_GET['id']?>&longitud=<?=$_GET['longitud']?>&latitud=<?=$_GET['latitud']?>&imei=<?=$_GET['imei']?>"  method="post" target="_self" >
		<input type="text" name="nombre" placeholder="Ingresar Nombre">
		<input id="post_button" type="submit" value="Buscar por Nombre"/>
    </form>	
<div class="clear"></div>
<div class="border_btn"></div>
		<form id="formcel" name="formcel" action="buscarcelular.php?id=<?=$_GET['id']?>&longitud=<?=$_GET['longitud']?>&latitud=<?=$_GET['latitud']?>&imei=<?=$_GET['imei']?>"  method="post" target="_self" >
		<input type="text" name="celular"  placeholder="Ingresar Celular">
		<input id="post_button" type="submit" value="Buscar Numero Celular"/>
    </form>	

<div class="clear"></div>
<div class="border_btn"></div-->
		<form id="formgrp" name="formgrp" action="buscargrupo.php?id=<?=$_GET['id']?>&longitud=<?=$_GET['longitud']?>&latitud=<?=$_GET['latitud']?>&imei=<?=$_GET['imei']?>"  method="post" target="_self" >
		<input type="text" name="grupo"  placeholder="Ingresar Nombre del Grupo">
		<input id="post_button" type="submit" value="Buscar Grupo"/>
    </form>	
