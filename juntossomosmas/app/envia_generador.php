...
$sql = "insert into mensajes (mensaje,grupo,fecha_hora,estado,link,categoria,subcategoria,enviador) values ('".$messageText."','".$username."','".$fecha."','0','".$link."',99,0,".$yo.")";
$result = mysql_query($sql,$base);
...
/***************************************************************************************************************************/
	...
	$sql0 = "SELECT mi_id FROM ejecutivo_seguidores WHERE tipo='P' and id_sigo=".$username;
...
/***************************************************************************************************************************/	
	...
	if($dispositivo=='android'){
		...
		$data = array('registration_id' => $userIdentificador,'collapse_key' => $collapsekey,'data.mensaje_empresa' => $messageText);
		$ch = curl_init();
