...
if ($tipo=="Sosclick") {
$messageText = $nombre.", Ha generado una alerta de Seguridad, comunicate con el al +569".$telefono;
//$fono_alarma="22454622";
}

if ($tipo=="Violencia Familiar") {
$messageText = $nombre.", Ha generado una alerta de Violencia Familiar, comunicate con el al +569".$telefono;
//$fono_alarma="22454637";
}

if ($tipo=="Carrete Sano") {
$messageText = $nombre.", Ha generado una alerta de Carrete Seguro, comunicate con el al +569".$telefono;
//$fono_alarma="22454618";
}

$collapseKey = $telefono;
$link = "http://".$nombreurl;
$apiKey = 'AIzaSyCTClamg_UjiY1Z9RNY3gmGW_ElciYU5bw';
...
//PARA MI
   ...
   $data = array('registration_id' => $userIdentificador,'collapse_key' => $collapseKey,'data.mensaje_psvirtual' => $messageText,'data.fecha' => $fecha);
   $ch = curl_init();
