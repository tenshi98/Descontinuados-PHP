...
$usuario=400;
	...
	$sql2="SELECT * FROM vigilancia where id_usuario=".$usuario." order by fecha_hora desc LIMIT 0, 10"; 
...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <span class="google_fjalla_gde">Hist&oacute;rico por Usuario(<?=$ejecutivo?>)</span>	</td></tr>
</table>
         ...
         <td align="center" valign="middle"><table width="100%" border="0" cellpadding="0" cellspacing="0" class="tabla_bca_sombra">
              <tr>
                    <td align="center" valign="middle">
                      ...
                      <tr><td><div align="center"><div id="amishbuggy" style="width: 900px; height: 600px" ></div></div></td></tr>
