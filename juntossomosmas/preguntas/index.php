...
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Seleccione</span></td>
	<td>Militantes Solamente<input type="radio" name="quien" value="0" checked>&nbsp;&nbsp;&nbsp;Militantes y Simpatizantes<input type="radio" name="quien" value="1" selected></td>
</tr>

<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Link Informativo</span></td>
	<td><input name="link_data" type="text" class="arial_light_cuadro" placeholder="Link Informativo" value="<?php if (isset($link_data)) { echo $link_data;}else{ echo $row_data['link_data'];}?>"/></td>
</tr>
<tr>
...
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 3</span></td>
	<td><input name="Opcion3" type="text" class="arial_light_cuadro" placeholder="Opcion 3" value="<?php if (isset($Opcion3)) { echo $Opcion3;}else{ echo $row_data['Opcion3'];}?>"/></td>
</tr>
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 4</span></td>
	<td><input name="Opcion4" type="text" class="arial_light_cuadro" placeholder="Opcion 4" value="<?php if (isset($Opcion4)) { echo $Opcion4;}else{ echo $row_data['Opcion4'];}?>"/></td>
</tr>
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 5</span></td>
	<td><input name="Opcion5" type="text" class="arial_light_cuadro" placeholder="Opcion 5" value="<?php if (isset($Opcion5)) { echo $Opcion5;}else{ echo $row_data['Opcion5'];}?>"/></td>
</tr>
<tr>
...
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 3</span></td>
	<td><input name="Opcion3" type="text" class="arial_light_cuadro" placeholder="Opcion 3" value="<?php if (isset($Opcion3)) { echo $Opcion3;} ?>" />     </td>
</tr>
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 4</span></td>
	<td><input name="Opcion4" type="text" class="arial_light_cuadro" placeholder="Opcion 4" value="<?php if (isset($Opcion4)) { echo $Opcion4;} ?>" />     </td>
</tr>
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Opcion 5</span></td>
	<td><input name="Opcion5" type="text" class="arial_light_cuadro" placeholder="Opcion 5" value="<?php if (isset($Opcion5)) { echo $Opcion5;} ?>" />     </td>
</tr>
<tr>
	<td width="19%"height="40" align="left" valign="middle"><span class="arial_tit_gris">Estado</span></td>
	<td>
...
<tr>
	<td width="19%"height="40" align="left" valign="middle"></td>
	<td>
    <input name="fecha" type="hidden"  value="<?php echo fecha_actual() ; ?>" />
...
<?php 
$var_total = $pregunta['resp_opcion1']+ $pregunta['resp_opcion2']+ $pregunta['resp_opcion3']+ $pregunta['resp_opcion4']+ $pregunta['resp_opcion5'];
$por_opcion1 = ($pregunta['resp_opcion1']/$var_total)*100;
$por_opcion2 = ($pregunta['resp_opcion2']/$var_total)*100;
$por_opcion3 = ($pregunta['resp_opcion3']/$var_total)*100;
$por_opcion4 = ($pregunta['resp_opcion4']/$var_total)*100;
$por_opcion5 = ($pregunta['resp_opcion5']/$var_total)*100;
?>

	<tr>
		<td height="40" align="left" valign="middle">
        <?php echo $pregunta['Pregunta']; ?></td>
         ...
         <td width="10%" align="center"><?php echo $pregunta['Opcion3'].'<br />('.porcentaje_cd($por_opcion3).')'; ?></td>
         <td width="10%" align="center"><?php echo $pregunta['Opcion4'].'<br />('.porcentaje_cd($por_opcion4).')'; ?></td>
		          <td width="10%" align="center"><?php echo $pregunta['Opcion5'].'<br />('.porcentaje_cd($por_opcion5).')'; ?></td>
         ...
         <td width="19%">
            <a class="btn_list btn-app" target="new" href="view.php?view=<?php echo $pregunta['idPregunta'] ?>"><i class="fap fap-eye"></i> Ver</a>
