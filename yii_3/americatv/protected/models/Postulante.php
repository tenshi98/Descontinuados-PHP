...
class Postulante extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_atv, PostCod, PostRut, PostNombres, PostApellPapa, PostApellMama, PostFecNac, idPais, PostDireccion, PostEmail', 'required'),
			...
			array('PostFoto2, PostFoto3, alias', 'length', 'max'=>120),
			...
			//IMPORTANTE
			array('vid_prof1, vid_prof2, vid_prof3', 'file', 'types'=>'mp4', 'allowEmpty' => true, 'maxSize'=>314572800, 'tooLarge'=>'El tamaño maximo del archivo es de 500MB'),
			//array('PostObjetivo', 'safe', 'on'=>'edit'),
			array('PostObjetivo','safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'PostProfesion1' => 'Talento 1',
			'PostProfesion2' => 'Talento 2',
			'PostProfesion3' => 'Talento 3',
			'PostProduccion1' => 'Produccion 1',
			'PostProduccion2' => 'Produccion 2',
			'PostProduccion3' => 'Produccion 3',
			'PostWeb' => 'Post Web',
