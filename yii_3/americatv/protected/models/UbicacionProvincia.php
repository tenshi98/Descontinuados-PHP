...
/**
 * This is the model class for table "ubicacion_provincia".
 *
 * The followings are the available columns in table 'ubicacion_provincia':
 * @property string $idProvincia
 * @property string $idDepartamento
 * @property string $Nombre
 */
class UbicacionProvincia extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idDepartamento', 'length', 'max'=>11),
			array('Nombre', 'length', 'max'=>80),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idProvincia, idDepartamento, Nombre', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return UbicacionProvincia the static model class
	 */
