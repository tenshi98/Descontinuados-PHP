			...
			<div class="sort_semana">
				...
				if (!Yii::app()->user->isGuest){
					$this->widget('zii.widgets.CMenu',array(
							'items'=>array(
								array('label'=>'COMBINADOS', 'url'=>array('/saludosVirtuales/index')),
								array('label'=>'TARJETAS', 'url'=>array('/saludosVirtuales/tarjetas'),'itemOptions' => array('class'=>'active'))
							),
				...
				<div class="list_sorteo">
					...
					<ul class="bloq_sorteo">
						...
						<?php 
						foreach($tarjetaSaludoCat as $data): ?>
						<li class="img_saludos fleft">
							<figcaption>
								<a href="<?php echo 'tarjetas2?codigo='.$data->idTarjetaCat; ?>">
									<img src="<?php echo Yii::getPathOfAlias('img').'/'.$data->img;?>">
								</a>
							</figcaption>
							<h2><?php echo CHtml::link(CHtml::encode($data->Nombre), array('saludosVirtuales/tarjetas2', 'codigo' =>$data->idTarjetaCat)); ?></h2>
