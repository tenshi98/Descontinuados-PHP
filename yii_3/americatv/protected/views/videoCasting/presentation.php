			...
			<div class="video_talento" style="margin-top:30px;">
				...
				<div class="cont_video_talento ">
					<section class="tabs noti_hover noti_checked ">
						...
						<label for="tab-1" class="tab-label-1 "><i class="fa fa-inbox">
						<?php 
						...
						<label for="tab-2" class="tab-label-2 "><i class="fa fa-share-square-o">
						<?php 
						...
						<label for="tab-3" class="tab-label-3 "><i class="fa fa-taxi">
						<?php 
						...
						<div class="content ">
							...
							<div class="content-1"> 
								...
								<?php if(isset($datosPers['profesion1'])&&$datosPers['profesion1']!=''){ ?>
								<div class="cont_btn" style="margin-top:15px;"><?php echo CHtml::link('EDITAR VIDEO', array('videoCasting/presentationMod1')); ?></div>
								<?php } ?>
							</div>
							...
							<div class="content-2">
								...
								<?php if(isset($datosPers['profesion2'])&&$datosPers['profesion2']!=''){ ?>
								<div class="cont_btn" style="margin-top:15px;"><?php echo CHtml::link('EDITAR VIDEO', array('videoCasting/presentationMod2')); ?></div>
								<?php } ?>
							</div>
							...
							<div class="content-3">		
								...
								<?php if(isset($datosPers['profesion3'])&&$datosPers['profesion3']!=''){ ?>
								<div class="cont_btn" style="margin-top:15px;"><?php echo CHtml::link('EDITAR VIDEO', array('videoCasting/presentationMod3')); ?></div>
								<?php } ?>
							</div>
