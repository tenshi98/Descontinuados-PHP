			...
			<h3>Subir Videos de Presentacion</h3>
				...
				<?php if($datosPers['vid_prof2']==''){?>
					...
					<?php echo $form->errorSummary($model); ?>
						...
						<div class="row" style="margin-bottom: 15px;" id="fileinput">
							<?php echo $form->labelEx($model,'vid_prof2', array('label' => 'Video Talento : '.$datosPers['profesion2'])); ?>
							<?php echo $form->FileField($model,'vid_prof2',array('class'=>'formvid','id'=>'myfile')); ?>
							<?php echo $form->error($model,'vid_prof2'); ?>
						</div>
				...
				<?php } else{?>
					<div class="row" style="margin-bottom: 15px;">
						<p><?php echo $datosPers['profesion2'].' ';?>
						<?php echo CHtml::link('Borrar Video', array('videoCasting/borrarVideo2')); ?></p>
					</div>
					<div class="row buttons">
						<div class="cont_btn">
							<?php echo CHtml::link('VOLVER', array('videoCasting/presentation')); ?>
