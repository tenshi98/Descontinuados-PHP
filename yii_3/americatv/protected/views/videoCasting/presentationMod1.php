			...
			<h3>Subir Videos de Presentacion</h3>
				...
				<?php if($datosPers['vid_prof1']==''){?>
					...
					<?php echo $form->errorSummary($model); ?>
						...
						<div class="row" style="margin-bottom: 15px;" id="fileinput">
							<?php echo $form->labelEx($model,'vid_prof1', array('label' => 'Video Talento : '.$datosPers['profesion1'])); ?>
							<?php echo $form->FileField($model,'vid_prof1',array('class'=>'formvid','id'=>'myfile')); ?>
							<?php echo $form->error($model,'vid_prof1'); ?>
						</div>
				...
				<?php } else{?>
					<div class="row" style="margin-bottom: 15px;">
						<p><?php echo $datosPers['profesion1'].' ';?>
						<?php echo CHtml::link('Borrar Video', array('videoCasting/borrarVideo1')); ?></p>
					</div>
					<div class="row buttons">
						<div class="cont_btn">
							<?php echo CHtml::link('VOLVER', array('videoCasting/presentation')); ?>
