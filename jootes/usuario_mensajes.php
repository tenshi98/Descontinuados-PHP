...
$fecha=$diadis."/".$mesdis."/".$Anio."  ".$hora_muestra;
	...
	if(isset($_POST['login']))  		$quien = $_POST['login'];
...
if ($messageText<>''){
$sql = "insert into mensajes (mensaje,grupo,fecha_hora,estado,enviador) values ('".$messageText."','".$grupo."','".$fecha."','0','".$quien."')";
...
<table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" id="table4">
<FORM  name="formulario" id="formulario"  action="notificaciones.php" method="post" target="_self">  
<input type=hidden name=correo value="<?=$_POST["correo"]?>">
<input type=hidden name=login value="<?=$_POST["login"]?>">

	<tr>
    <td width="56" align="center" valign="middle" height=250>
	<input type=submit value=volver  class=bot_red_med></td>
	</TR>
</form>
