    ...
    <td align="center" valign="middle"><table width="990" align="center" border="0" cellpadding="0" cellspacing="0">
      <tr>
		...
		<table border="0" cellpadding="0" cellspacing="0" class="logo_flot">
          <tr>
            <td><img src="../images/logoSOSClick.png" height="200" /></td>
          </tr>
        </table>
          Visualizaci&oacute;n de los Datos</td>
        <td width="42%" height="50" align="center" valign="middle"><form method="post" id="geocoding_form" action="http://<?=$nombreurl?>">
          <input name="button1" type="submit" class="bot_sombra" id="button1" value="Volver al Home" /></form></td>
      </tr>
    </table></td>
    </tr>
</table>
