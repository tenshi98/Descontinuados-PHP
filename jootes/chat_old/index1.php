...
echo "http://www.jootes/chat/index1.php?room=".$_GET["room"];
?>
<head>
...
if (document.layers)
  ...
  document.onkeydown =
    function (evt) { 
      ...
      if (keyCode == 13)
       {
         send_message('output_div','text_content','1','<?=$_GET["room"]?>');
       }
    }
//-->
</script>
...
<body onload="get_message('output_div','1','<?=$_GET["room"]?>')">
<center>
    ...
    <div class="window">
     ...
     <div class="main_container">
		...
		<div class="input-div">
		   ...
		   <input type="submit" value="enviar" onclick="send_message('output_div','text_content','1','<?=$_GET["room"]?>')">
		</div>
	</div>
	</div>
 </center>
