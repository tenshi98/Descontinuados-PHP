...
<table width="900" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <span class="arial_24_blue">ADMINISTRACIÓN PAGOS</span><table height="" width="900" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <table height="" width="900" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="left" class="arial_24_99" rowspan="2">
                      <p align="center"><a href="index.asp" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('simular','','../images/volver_up.png',1)"><img src="../images/volver.png" name="simular" id="simular"  border=0 /></a>        </td>
                    </tr>
                    <tr>
...
$contador=0;
$letrab="";
$sql="Select * from ejecutivos where login like '%" . $_POST['busqueda'] . "%' order by login asc";
...
while($fila02=mysql_fetch_array($res02))
{
	$contador=$contador+1;
	$login=$fila02["login"];
	$id=$fila02["id_ejecutiv"];
	$letra=strtoupper(substr($fila02["login"],0,1));
	if ($letra<>$letrab) {
		$letrab=$letra;
		?>
		<tr><td align=left><br><span class="arial_24_red"><?=$letra?></span><br></td></tr>
	<?}
	if ($contador==1) {?>
		<tr >
	<?}?>
	<td align=left><a href="mantener_usuario.php?usuario=<?=$id?>" class=fondo_blanco><span class="arial_12_blue"><?=$login?></span></a></td>
	<?if ($contador==3) {
	$contador=0; ?>
	</tr>
	<? }
			...
			<p align="center"><a href="index.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('simular','','../images/volver_up.png',1)"><img src="../images/volver.png" name="simular" id="simular"  border=0 /></a>        
