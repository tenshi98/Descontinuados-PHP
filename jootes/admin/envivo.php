...
<!-- contenido -->
		<table border="0" width="100%" cellspacing="0" cellpadding="0" id="table2" height="265">
			...
			<tr>
				<td valign="middle" class="arial_tit_calip_gde" align=center>Selecciona el tipo de transmision<br><br><br>
<FORM language=javascript name="mainFrame" id="mainFrame" action="graba_envivo.php" method="post" target="_self"> 
