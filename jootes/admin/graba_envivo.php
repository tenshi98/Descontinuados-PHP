...
$sql="update parametros set envivo=".$_POST["R1"];
...
<table border="0" width="86%" cellspacing="0" cellpadding="0" id="table2" height="265">
			...
			<tr>
				<td valign="middle" class="arial_tit_calip_gde" align=center>Seleccion de tipo de transmision<br><br><br>

						<blockquote><p><span class="arial_tit_calip_gde">Fue actualizada con &eacute;xito.</span></p> </blockquote>
				</td>
			</tr>
			</table>
