...
$contador=0;
$letrab="";
$sql="Select * from ejecutivos where login like '%" . $_POST['busqueda2'] . "%' order by login asc";
...
while($fila02=mysql_fetch_array($res02))
{
	...
	if ($contador==1) {?>
		<tr >
	<?}?>
	<td align=left><a href="activar_monitoreo.php?usuario=<?=$id?>" class=fondo_blanco><span class="arial_12_blue"><?=$login?></span></a></td>
	<?if ($contador==3) {
	$contador=0; ?>
	</tr>
	<? }
