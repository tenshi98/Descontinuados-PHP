...
<table width="900" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <span class="arial_24_blue">ADMINISTRACIÓN <a href="limpia_usuarios.php">.</a></span><table height="" width="900" border="0" cellspacing="0" cellpadding="0">
                <tr>
    ...
    <table height="237" width="888" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <!-- contenido -->
              ...
              <table border="0" cellspacing="0" cellpadding="0" align=center width=450 class=celda_blanca>
			                <tr>
                <td  valign=middle><span  class="arial_24_titulo">ACTIVAR PAGOS
                </td>
              </tr>

              <tr>
                <td  valign=middle>
				<FORM language=javascript name="pagos" id="pagos"  action="resultado.php" method="post" target="_self">
                 <span class="arial_12_bco">
                  <input type="text" class="clearField" value="Buscar Usuario" name=busqueda id=busqueda size="16" />
                </span></td>
                <td valign=top><input  type="image" src="../images/play_icon.png" width="20" height="20" border="0" />
               </FORM> 
                </td>
              </tr>
            </table> 
                 ...
                 <table border="0" cellspacing="0" cellpadding="0" align=center width=450 class=celda_blanca>
			                <tr>
                <td  valign=middle><span  class="arial_24_titulo">ACTIVAR MONITOREO
                </td>
              </tr>

              <tr>
                <td  valign=middle>
				<FORM language=javascript name="monitoreo" id="monitoreo"  action="monitoreo.php" method="post" target="_self">
                 <span class="arial_12_bco">
                  <input type="text" class="clearField" value="Buscar Usuario" name=busqueda2 id=busqueda2 size="16" />
                </span></td>
                <td valign=top><input  type="image" src="../images/play_icon.png" width="20" height="20" border="0" />
               </FORM> 
                </td>
