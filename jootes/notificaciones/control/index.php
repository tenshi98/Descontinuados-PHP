...
<body onload="MM_preloadImages('../images/logo_footer_up2_blue.png')">
<div id="nonFooter" >
  ...
  <table bgcolor="#999999" width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <td align="center" valign="middle"><table width="990" align="center" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="58%" align="right" valign="middle" class="google_fjalla_bco">
		<table border="0" cellpadding="0" cellspacing="0" class="logo_flot">
          <tr>
            <td><img src="../images/logo_blue.png" height="200" /></td>
          </tr>
        </table>
          Visualizaci&oacute;n de Visitas por Mensaje Emitido</td>
        <td width="42%" height="50" align="center" valign="middle"><form method="post" id="geocoding_form" action="http://<?=$nombreurl?>">
          <input name="button1" type="submit" class="bot_sombra" id="button1" value="&nbsp; Salir &nbsp;" /></form></td>
      </tr>
    </table></td>
    </tr>
</table>
                    ...
                    <td align="center"><table width="50%" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
						...
						<!--table width="100%" border="0" cellpadding="0" cellspacing="0" class="celda_borde">
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="celda_borde">
                            <tr>
                              <td height="40" align="left" valign="middle"><span class="arial_tit_gris">&Uacute;ltima Posici&oacute;n Registrada</span><br />
                                <span class="arial_cuerpo_gris">Visualiza, la ubicaci&oacute;n de la &uacute;ltima Posici&oacute;n Rastreada</span></td>
                         ...
                         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="celda_borde">
                            <tr>
                              <td height="40" align="left" valign="middle"><span class="arial_tit_gris">&Uacute;ltima Alarma</span><br />
                                <span class="arial_cuerpo_gris">Visualiza, el lugar de la activaci&oacute;n de la &uacute;ltima Alarma emitida</span></td>
                              <td width="19%"><form method="post" id="menu_form" action="ultalam.php">
							  <input name="button5" type="submit" class="bot_sombra" id="button5" value="Ingresar" /></form></td>
                            </tr>
                          </table-->						  
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="celda_borde">
                            ...
                            <tr>
                              <td width="50%" height="40" align="left"><span class="arial_tit_gris">Históricos mensaje por Fecha</span><br />
                                <span class="arial_cuerpo_gris">Vizualiza en el Mapa las Visitas de una fecha determinada</span></td>
                              <td width="31%">
						...
						<?
						$SQL_lee4="select LEFT( fecha_hora, 10 ) as fecha  from mensajes group by LEFT( fecha_hora, 10 )  order by LEFT( fecha_hora, 10 ) desc";
						...
						<? }?>
                          ...
                          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="celda_borde">
                            <form method="post" id="menu_form" action="historico_mensaje.php">
							<input type="hidden" name="dedonde" value="menuppal">
						    <tr>
                              <td width="50%" height="40" align="left"><span class="arial_tit_gris">Históricos por Mensaje</span><br />
                                <span class="arial_cuerpo_gris">Vizualiza en el Mapa sus Visitas</span></td>
                              <td width="31%"><span class="arial_gris_med">
                                <select name="mensaje" class="arial_light_combo" id="mensaje">
								<option value="0" SELECTED>Selecciona el Mensaje</option>

				<?
				$SQL_lee4="select id ,mensaje  from mensajes  order by id desc";
				$res=mysql_query($SQL_lee4,$base); 
